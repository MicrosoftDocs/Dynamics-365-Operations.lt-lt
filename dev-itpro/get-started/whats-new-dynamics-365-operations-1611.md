...
| Sužinokite daugiau apie konsignacijos palaikymą „Dynamics 365 for Operations“                                                                                                         | Norėdami gauti daugiau informacijos apie konsignacijos procesų palaikymą, žr. [Konsignacija](/dynamics365/unified-operations/supply-chain/inventory/consignment), [Konsignacijos nustatymas](/dynamics365/unified-operations/supply-chain/inventory/set-up-consignment), [Sukurti konsignacijos papildymo užsakymą (užduočių vedlys)](http://ax.help.dynamics.com/en/wiki/create-a-consignment-replenishment-order/) ir [Pakeisti konsignacijos atsargų savininką pagal produkcijos paklausą (užduočių vedlys)](http://ax.help.dynamics.com/en/wiki/change-the-ownership-of-consignment-inventory-based-on-production-demand/).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
