...
## <a name="pos--microsoft-dynamics-ax-retail"></a>POS – Microsoft Dynamics AX mažmeninės prekybos
|                                |                                                                                                                                                                                         |
|--------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Ką galite daryti?**           | **Kodėl tai svarbu?**                                                                                                                                                              |
...
|---------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Ką galite daryti?**                                                | **Kodėl tai svarbu?**                                                                                                                                                                                                                                                                                         |
| Atstatykite finansinių ataskaitų duomenų sritį.                          | Kai perkeliate Dynamics AX duomenų bazių aplinkoje ar kitos invazinės keisti aplinką, finansinės atskaitomybės duomenų bazę gali tekti būti atstatytas. "Windows PowerShell" scenarijų dabar pateikta jums atkurti duomenų bazę.                                                                |
| Daugiau nebegalite pasirinkti ataskaitų dizaino įrankio parinkčių, kurios negalioja. | Kelios ataskaitų kūrimo parinktys, kurios buvo naudojamos rinkoje esančiose „Management reporter“ versijose, šioje „Dynamics AX“ versijoje netaikomos. Šie variantai buvo susiję su finansinės ataskaitos dizaino, produkcijos ir susiejimas. Šie variantai buvo pašalintas iš finansinių ataskaitų konstruktorius užkirsti kelią vartotojų paklaidos. |
