...
-   Stulpelio aprašo antraščių srityje yra antraštės tekstas ir ataskaitoje rodomas formatavimas. Antraštę galite taikyti vieną duomenų stulpelį, gali apimti kelis stulpelius, arba galite pritaikyti stulpelius remiantis sąlyginumo principu. Skiltyje apibrėžimas gali apimti kuo daugiau stulpelių antraštės eilučių, kiek jums reikia. **Pastaba:** stulpelio antraštės taikomos kiekvienam ataskaitos duomenų stulpeliui. Ataskaitos antraštės taikomos visai ataskaitai. Ataskaitos antraštes galite nurodyti ataskaitos aprašo skirtuke **Antraštės ir poraštės**.
...
|-------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SU                      | Slopinti pabraukimo stulpeliui, kai arba pabraukimo komandą (**---**) arba dvigubo pabraukimo komandą (**===**) yra įtrauktas į eilutės apibrėžimą. Pavyzdžiui, galbūt nenorite pabraukti sumų, kurios gaunamos apskaičiuojant procentinę dalį.                                                                        |
...
Ataskaitų dizaino įrankis gali automatiškai sugeneruoti stulpelių antraštes pagal automatinio teksto kodus. Automatinio teksto kodai yra kintamieji, kurie atnaujinami kiekvieną kartą, kai sugeneruojama ataskaita. Šie kodai gali būti bet kurio stulpelio antraštėje ir juose nurodoma ataskaitos informacija, kuri gali kisti, pvz., datos ar laikotarpio numeriai. Todėl galite naudoti vieną stulpelio aprašą keliems ataskaitos aprašams, laikotarpiams ir ataskaitų medžiams. Kadangi automatinio teksto kodai paremti stulpelio aprašo informacijos eilutėse pateikta kalendoriaus informacija, juos palaiko tik stulpeliai **CALC**, **FD** ir **WKS**. Nuo to, kaip automatinio teksto kodas rodomas stulpelio antraštės langelyje priklauso tai, kaip ta informacija rodoma ataskaitoje. Dialogo lange **Stulpelio antraštė** automatinio teksto kodai rodomi didžiosiomis ir mažosiomis raidėmis. Todėl ataskaitoje tekstas rodomas didžiosiomis ir mažosiomis raidėmis. Pavyzdžiui, standartinis kalendoriniais metais, **@CalMonthLong**praeina mėnuo **7** į **liepos**. Jei mėnesio pavadinimas turi būti didžiosiomis raidėmis (pvz. **liepos**), automatinio teksto kodą įvesti didžiosiomis raidėmis – į **stulpelio antraštės tekstas** srityje. Pavyzdžiui, įveskite**@CALMONTHLONG**. Galite maišyti kodus ir tekstą. Pavyzdžiui, įveskite antraštės tekstas: **laikotarpį @FiscalPeriod-@FiscalYearnuo @StartDateį@EndDate**. Sugeneruotos ataskaitos antraštės tekstas panašus į šį tekstą: **Laikotarpis 1-02 nuo 01/01/02 iki 01/31/02**. **Pastaba:** dalis teksto, pvz., ilgas datos formatas priklauso nuo jūsų regiono parametruose "Dynamics 365" operacijų serveris. Norėdami pakeisti šiuos parametrus, spustelėkite mygtuką **Pradžia**, spustelėkite **Valdymo skydas**, tada spustelėkite **Regionas ir kalba**. Toliau pateikiamoje lentelėje išvardijamos galimos stulpelio antraščių automatinio teksto pasirinktys.
...
| Sutrumpintai mėnesio pavadinimas (@CalMonthShort) | Spausdinti pasirinkto ataskaitinio laikotarpio mėnesio sutrumpintą pavadinimą.                                                                                                                                                                                                                          |
...
| Laikotarpiu aprašymas (@FiscalPeriodName)  | Spausdinti finansiniuose duomenyse identifikuojamo ataskaitinio laikotarpio aprašą.                                                                                                                                                                                                                    |
| Finansinių metų (@FiscalYear)               | Spausdinti stulpelio finansinių metų skaitinę formą.                                                                                                                                                                                                                                            |
| Kalendorinius metus (@CalYear)                | Spausdinti stulpelio kalendorinių metų skaitinę formą.                                                                                                                                                                                                                                          |
| Pradžios data (@StartDate)                 | Spausdinti stulpelio pradžios datą.                                                                                                                                                                                                                                                             |
| Pabaigos data (@EndDate)                     | Spausdinti stulpelio pabaigos datą.                                                                                                                                                                                                                                                               |
| Vienetas pavadinimas iš medžio (@UnitName)         | Jei nustatysite apribojimą, kad stulpelyje būtų rodomas tik tam tikras ataskaitų medžio vienetas, išspausdinkite to vieneto pavadinimą stulpelio antraštėje.                                                                                                                                                                                     |
| Vieneto aprašymas (@UnitDesc)            | Jei nustatysite apribojimą, kad stulpelyje būtų rodomas tik tam tikras ataskaitų medžio vienetas, išspausdinkite to vieneto aprašą stulpelio antraštėje.                                                                                                                                                                              |
| Užsisakykite kodekso (@BookCode)                   | Spausdinti stulpelyje nurodytą knygos kodą.                                                                                                                                                                                                                                             |
...
-   Jei nurodote persidengiančias stulpelių antraštes, jos persidengia, kai yra spausdinamos ataskaitoje. Ataskaita yra suformuojama, tačiau toks įspėjimas pasirodo į **ataskaita eilės būsena** srityje: "stulpelių antraštės pagrindas kertasi su kitų stulpelių antraščių ir gali sukelti persidengiančių tekstą." Pvz., antraštės apibrėžimas ant stulpelio B, B bazinis + 1 ir D stulpelio antraštės apibrėžimas yra bazinis + 1-F. Tokiu atveju antraštes spausdinamos viena ant kitos ir yra neįskaitomas. Kiekvieną kartą, kai apraše **Paskirstyti nuo / Paskirstyti iki** naudojamas BASE, būtinai peržiūrėkite generuojamą ataskaitą, kad pamatytumėte, ar antraštės persidengia.
...
-   Sąlyginis spausdinimo stulpelių (**P&lt;B**, **P&gt;= B**), sąlyginis apimanti antraštes elgiasi kaip bet reguliariai stulpelio antraštės apibrėžimas. Pvz., jei sąlyga klaidinga, bet kuriame kitame stulpelyje, kuris atitinka paskirstymo sąlygą, pradedama spausdinti antraštė.
...
3.  Sąraše pasirinkite stulpelio tipą. Toliau pateikiamoje lentelėje aprašomi įvairūs stulpelių tipai.
    ...
    <tr class="odd">
    <td>ATTR</td>
    <td>Jei jūsų apskaitos sistema palaiko atributus, stulpelyje rodyti sąskaitos arba operacijos atributą. Atributas, kuris turi būti taikomas visai vienai sąskaitai, iš finansinių duomenų išrenka pagrindinės sąskaitos arba operacijos informaciją. Sąskaitos lygio atributus Rodyti duomenis iš sąskaitos, ir operacijos-lygio atributus, Rodyti duomenis, įvyko tuo metu, kad operacija buvo užregistruota. Jei pasirinksite <strong>ATTR</strong> stulpelio tipą, nustatyti atributą kategoriją, į <strong>knygos kodas/atributas kategorija</strong> detalių eilučių skiltyje apibrėžimas.</td>
    </tr>
    </tbody>
    </table>
...
| BAZINIS +\# | Naudoti metų, kad \#metai po metų. Pavyzdžiui, norėdami naudoti trečiuosius metus po pagrindinių metų, įveskite **PAGRINDINIS+3**. |
| BAZĖ-\# | Naudoti metų, kad \#metus iki bazinių metų. Pavyzdžiui, norėdami naudoti praėjusius metus, įveskite **PAGRINDINIS-1**.                 |
...
| BAZINIS +\#         | Laikotarpį, kuris yra \#po pagrindinio laikotarpio. Pavyzdžiui, norėdami naudoti trečiąjį laikotarpį po pagrindinio laikotarpio, įveskite **PAGRINDINIS+3**.                                                                                               |
| BAZĖ-\#         | Laikotarpį, kuris yra \#laikotarpius iki kito pagrindinio laikotarpio. Pavyzdžiui, norėdami naudoti praėjusį laikotarpį, įveskite **PAGRINDINIS-1**.                                                                                                                 |
| BASE -\#: bazė    | Naudoti kelis laikotarpius nuo kelių laikotarpių prieš pagrindinį laikotarpį iki pagrindinio laikotarpio. Pavyzdžiui, norėdami naudoti tris praėjusius laikotarpius ir pagrindinį laikotarpį, įveskite **PAGRINDINIS-3:PAGRINDINIS**.                                                |
| PAGRINDAS: PAGRINDAS +\#    | Naudoti kelis laikotarpius nuo pagrindinio laikotarpio iki kelių laikotarpių po pagrindinio laikotarpio. Pavyzdžiui, norėdami naudoti pagrindinį laikotarpį ir du po jo einančius laikotarpius, įveskite **PAGRINDINIS:PAGRINDINIS+2**.                                                  |
| BASE -\#: bazė +\# | Naudoti kelis laikotarpius nuo kelių laikotarpių prieš pagrindinį laikotarpį iki kelių laikotarpių po pagrindinio laikotarpio. Pavyzdžiui, norėdami naudoti tris praėjusius laikotarpius, pagrindinį laikotarpį ir po jo einančius du laikotarpius, įveskite **PAGRINDINIS-3:PAGRINDINIS+2**. |
...
Nurodydami bet kurį laikotarpį galite peržengti finansinių metų ribas ir galite maišyti laikotarpių intervalo metus. Pvz., galite nurodyti laikotarpiai kaip **BASE-5** (atstovauti pastaruosius šešis laikotarpius) ir paleiskite ataskaitą, kurioje yra bazinis laikotarpis 2. Šiuo atveju ataskaita rodo duomenų pirmųjų dviejų laikotarpių, nustatytų finansinių metų ir praėjusių finansinių metų paskutiniai keturi laikotarpiai.
...
3.  Virš naršymo srities esančioje formulės juostoje arba langelyje **Laikotarpis** užpildykite formulę. Pakeisti bet numerio ženklas (\#) su atitinkamos vertės.
...
Dimensijos filtras naudojamas norint apriboti, kad stulpelyje **FD** būtų rodomos tik tam tikros dimensijos reikšmės. Filtras gali apimti vieną dimensiją, dimensijų intervalą arba dimensijų grupę. Filtras taip pat gali apimti dimensijos reikšmių rinkinius. Dimensijų verčių gali skirtis, a... \financial-dimensions\dimension-based sistema nebūtinai turi atitikti tikslaus ilgio. Filtras taikomas nepaisant to, ar į ataskaitą įtraukiamas ataskaitų medis. Galite naudoti pakaitos simbolį (\* arba?) bet kokioje padėtyje. Kai nurodote kelias paskyras, įdėti kablelis tarp sąskaitų, kaip parodyta pavyzdyje: + į =\[1200\], + į =\[1100\], departamentas =\[01?\] Norėdami gauti visus konkrečios sąskaitos padalinius, galite neįtraukti dimensijos filtre nurodomos dimensijos Padalinys. Pavyzdžiui, abu toliau pateikiami dimensijos filtrai tvarkomi taip pat.

-   + Į =\[1100\], departamentas
-   + Į =\[1100\]

Taip pat, jeigu norite tikslaus atitikimo, galite naudoti bet kokią raidinių-skaitinių simbolių kombinaciją ir galite nurodyti dalines dimensijas. Pvz., **vieta = \[10\*\]** apima visus vietos dimensijų vertes, kurios pradeda su 10.
...
-   **Valiutos rodymo** – Piniginis vienetas (fizinis, funkcinis ar ataskaitų) tipas rodoma operacijos. Ši funkcija kartais vadinama valiutų perskaičiavimo. Valiutos konvertavimas yra galimybė pateikti didžiosios knygos sumas tokia valiuta, kuri gali būti ne funkcinė įmonės valiuta arba ne ta valiuta, kuria buvo įvesta operacija.
...
**Pastaba:** čia aprašomos pasirinktys gali skirtis priklausomai nuo ERP sistemos. Daugiau informacijos ieškokite savo ["Microsoft" ERP sistemos dokumentų](https://www.microsoft.com/en-us/download/details.aspx?id=5916).
...
| Funkcinė valiuta iš įmonės informacijos | Tuščia                | **$2,310\*\*** – rezultatas parodo visus duomenis funkcine valiuta, nurodyta formoje įmonės informacija. **Pastaba:** ši suma yra visų funkcine valiuta nurodomų operacijų suma. |
