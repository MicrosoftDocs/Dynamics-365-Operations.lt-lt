...
-   Etiketė turi prasidėti abėcėlės raide (nuo a iki ž arba nuo A iki Ž) ir tai gali būti bet kokia iki 16 simbolių ilgio skaičių ir raidžių kombinacija. **Pastaba:** ant etiketės gali būti pabraukimo simbolis (\_), tačiau nėra kitų specialių simbolių leidžiama.
...
Langelyje **Formato kodas** pateikiamos kelios iš anksto suformatuotos pasirinktys, skirtos tos eilutės turiniui. Jei langelis **Formato kodas** tuščias, eilutė interpretuojama kaip finansinių duomenų informacijos eilutė. **Pastaba:** Jei ataskaitoje yra ne sumą formatuojančių eilučių, susijusių su sumos eilutėmis, kurios buvo sulaikytos (pvz., dėl nulinio balanso), norėdami, kad nebūtų spausdinamos pavadinimo ir formato eilutės, galite naudoti stulpelį **Susijusios formulės / eilutės / vienetai**.
...
3.  Sąraše pasirinkite formato kodą. Šioje lentelėje aprašomi formato kodai ir jų veiksmai.
    ...
    | IŠ VISO                           | Bendroji suma                              | Nurodoma eilutė, kuri stulpelyje **Susijusios formulės / eilutės / vienetai** naudoja matematinius ženklus. Sumos yra paprastas operatorių, pvz., **+**ar**-**.                                                      |
    | KPL                           | Skaičiavimas                        | Nurodoma eilutė, kuri stulpelyje **Susijusios formulės / eilutės / vienetai** naudoja matematinius ženklus. Skaičiavimai yra sudėtingas ūkio subjektų, tokių kaip **+**, **-**, **\***, **/**, ir **jei/to/ELSE** pareiškimus. |
...
– Į **formato kodą** stulpelio eilutės apibrėžimą, į **DES**, **LFT**, **PAKG**, **CEN**, **---**, ir **===**formato kodų formatuoti ne sumos eilutes. Norėdami, kad šis formatavimas nebūtų spausdinamas, kai sulaikomos susijusios eilutės (pavyzdžiui, todėl, kad sumos eilutėse yra nulinių reikšmių arba nėra laikotarpio aktyvumo), turite susieti formato eilutes su atitinkamomis sumų eilutėmis. Ši funkcija naudinga, kai norite neleisti spausdinti antraščių arba formatavimo, kuris yra susijęs su tarpinėmis sumomis, kai nėra jokios spausdintinos laikotarpio informacijos. **Pastaba:** išvalydami pasirinktį rodyti eilutes be sumų taip pat galite neleisti spausdinti išsamių sumos eilučių. Ši pasirinktis yra ataskaitos aprašo skirtuke **Parametrai**. Pagal numatytuosius nustatymus, išsamios sąskaitos, kurių balansas lygus nuliui arba kurios neturi jokios laikotarpio veiklos, ataskaitose sulaikomos. Norėdami rodyti šias operacijos informacijos sąskaitas, pažymėkite ataskaitos aprašo skirtuko **Parametrai** žymės langelį **Rodyti eilutes be sumų**.
...
Šiame pavyzdyje Phyllis nori neleisti spausdinti savo ataskaitos eilutės **Bendroji grynųjų suma** antraštės ir pabraukimų, nes nė vienoje iš grynųjų pinigų sąskaitų nebuvo jokios veiklos. Todėl eilutėje 220 (, kaip į **---**formato kodas nurodo, yra formatavimo eilutės), į **susijusių formulių/eilutes/vienetų** ląstelių, ji patenka **250**, kuris yra eilutė kodas, suma eilutėje, kad ji nori nuslėpti. [![RelatedRowsRowDefinition](./media/relatedrowsrowdefinition-1024x144.png)](./media/relatedrowsrowdefinition.png)
...
6.  Norėdami įrašyti stulpelio apibrėžimą nauju pavadinimu, meniu **Failas** spustelėkite **Įrašyti kaip**. Pridėti **CBR** į esamą failo vardą (pavyzdžiui, **DAB\_nuo metų pradžios\_CBR**). Šis stulpelio apibrėžimas yra jūsų pagrindinės eilutės stulpelio apibrėžimas.
...
Toliau pateikiamame eilutės apibrėžimo pavyzdyje eilutėje 100 rodoma, kad pagrindinė skaičiavimų eilutė yra eilutė 280. [![Pagrindinis eilės apskaičiavimo pavyzdys.](./media/cbrrowdefinition.png)](./media/cbrrowdefinition.png) Toliau pateikiamame stulpelio aprašo pavyzdyje skaičiavimams naudojamas **CBR** formato kodas. Stulpelio C skaičiavimas padalina ataskaitos stulpelio B reikšmę iš stulpelio B eilutės 280 reikšmės. Stulpelio B formato nepaisymas atspausdina skaičiavimo rezultatą procentais. Taip pat kiekviena stulpelio E suma yra stulpelio D suma grynojo pardavimo procentais. [![Stulpelio apibrėžimas pavyzdys.](./media/cbrcolumndefinition2.png)](./media/cbrcolumndefinition2.png) Toliau pateikiamame pavyzdyje rodoma ataskaita, kuri gali būti sugeneruota pagal ankstesnius skaičiavimus. [![Pavyzdys ataskaitą pagal ankstesnį pavyzdį skaičiavimai.](./media/cbrreport-1024x272.png)](./media/cbrreport.png)
...
4.  Langelyje **Stulpelio apribojimas** įveskite rūšiavimui naudojamą ataskaitos stulpelio raidę. **Pastaba:** rūšiavimo skaičiavimui naudokite tik sumos eilutes.

### <a name="examples-of-ascending-and-descending-column-values"></a>Didėjančių ir mažėjančių stulpelių reikšmių pavyzdžiai

Šiame pavyzdyje, ataskaita D skiltyje nurodytas vertes bus surūšiuoti didėjimo tvarka eilučių 160 per 490. Be to, absoliučių verčių ataskaitos G stulpelyje bus Rūšiuoti mažėjimo tvarka, eilutės 610 per 940.
...
**Surūšiuota pagal absoliutųjį nuokrypį nuo metų pradžios, mažėjančia tvarka**
...
-   **Nulinės vertės nepaisymo tekstas** – tekstas, kuris įtraukiamas į ataskaitą, kai suma lygi 0 (nuliui). Šis tekstas rodomas kaip paskutinė srities **Pavyzdys** eilutė. **Pastaba:** jei sulaikomas nulinių reikšmių spausdinimas arba nėra laikotarpio veiklos, šis tekstas panaikinamas.
...
5.  Norėdami įtraukti įrašą, skirtą kiekvienam atributui, kuris turi būti įtrauktas su eilutės kodu, dalyje **Atributai** atlikite šiuos veiksmus:
    1.  Dukart spustelėkite langelį **Atributas** ir pasirinkite atributo pavadinimą. **Įspėjimas:** pakeisti ženklą (\#) su skaitine verte.
...
Kai pasirenkate konkrečią sąskaitą, ataskaitų dizaino įrankis paprastai sujungia sąskaitą su finansiniais metais, laikotarpiais ir kita informacija, kurią nurodote stulpelio apraše. Kiekvienoje eilutėje galite naudoti skirtingą informaciją, pvz., skirtingus ataskaitinius laikotarpius. Toliau pateiktoje lentelėje rodomi galimi sąskaitos modifikatoriai. Pakeisti ženklą (\#), kuris yra lygus ar mažesnis nei laikotarpių skaičius per finansinius metus.

| Sąskaitos modifikatorius | Kas spausdinama                                                                           |
|------------------|-------------------------------------------------------------------------------------------|
| /BB              | Sąskaitos pradžios balansas.                                                     |
| /\#              | Nurodyto laikotarpio balansas.                                                     |
| /-\#             | Likutis už laikotarpį, kuris yra \#laikotarpius iki ataskaitinio laikotarpio.                  |
| /+\#             | Likutis už laikotarpį, kuris yra \#po ataskaitinio laikotarpio.                   |
| /C               | Dabartinio laikotarpio balansas.                                                       |
| /C-\#            | Likutis už laikotarpį, kuris yra \#laikotarpius iki ataskaitinio laikotarpio.                  |
| /C+\#            | Likutis už laikotarpį, kuris yra \#po ataskaitinio laikotarpio.                   |
| /Y               | Dabartinio laikotarpio metų balansas iki nurodytos datos.                                      |
| /Y-\#            | Metų iki datos likutis per laikotarpį, kuris yra \#laikotarpius iki ataskaitinio laikotarpio. |
| /Y+\#            | Metų iki datos likutis per laikotarpį, kuris yra \#po ataskaitinio laikotarpio.  |

### <a name="book-code-modifiers"></a>Knygos kodo modifikatoriai

Galite apriboti eilutę esamu knygos kodu. Stulpelio apraše turi būti bent vienas stulpelis **FD**, kuriame yra knygos kodas. **Pastaba:** knygos kodo eilutės apribojimas panaikina tos eilutės stulpelio aprašo knygos kodo apribojimus.
...
Langelyje **Saitas su finansinėmis dimensijomis** pateikiamos nuorodos į finansinius duomenis, kurie turėtų būti įtraukti į kiekvieną ataskaitos eilutę. Šiame langelyje pateikiamos dimensijų reikšmės, bet vietoj segmento reikšmių arba dimensijų reikšmių arba papildomai prie jų galite nurodyti „Microsoft Excel“ darbalapio langelius. Norėdami atidaryti dialogo langą **Dimensijos**, dukart spustelėkite langelį **Saitas su finansinėmis dimensijomis**. **Pastaba:** ataskaitos dizainerio negalite pasirinkti sąskaitas, matmenys, ar laukus iš Microsoft Dynamics ERP sistemos, kuriose yra bet kuri iš šių saugomos simbolių: &, \*, \[, \], {, arba}. Norėdami nurodyti informaciją, kuri jau yra eilutės apibrėžime, įtraukite informaciją į langelį **Saitas su finansinėmis dimensijomis**. Norėdami įtraukti naujas eilutes, kurios susijusios su finansiniais duomenimis, naudokite dialogo langą **Įterpti eilutes iš**, kad ataskaitos apraše galėtumėte sukurti naujas eilutes. Stulpelio pavadinimas keičiasi, priklausomai nuo to, kaip stulpelis konfigūruojamas, kaip parodyta toliau pateikiamoje lentelėje.
...
5.  – Su **nuo** lauke, įveskite pradžios dimensiją, arba spustelėkite ![Peržiūrėti](https://i-technet.sec.s-msft.com/dynimg/IC679490.gif "naršyti") ieškoti laisvų matmenų. Norėdami įvesti dimensijų intervalą, lauke **Iki** įveskite pabaigos dimensiją.
...
Kai įvedate gamtos segmento reikšmę į **matmenys** dialogo lange, galite įdėti į pakaitos simbolį (? Arba \*) bet kokioje padėtyje segmentą. Ataskaitos dizainerio ištraukia visus nustatytų pozicijų vertės neatsižvelgiant į pakaitos simbolius. Pvz., eilutės apraše yra tik fizinio segmento riekšmės, o fiziniai segmentai yra keturių simbolių. Įvesdami **6???** Iš eilės, galite nurodyti ataskaitos dizainerio įtraukti visų sąskaitų, kurių natūrali segmento reikšmę, kuri prasideda nuo 6. Jei įvesite **6\***, grąžins tuos pačius rezultatus, bet rezultatai taip pat apima kintamo pločio reikšmes, pvz., **60** ir **600000**. Ataskaitų dizaino įrankis pakeičia kiekvieną pakaitos simbolį (?) visomis galimomis reikšmėmis, įskaitant raides ir specialiuosius simbolius. Pvz., kai intervalas nuo **12?0** iki **12?4**, reikšmės **12?0** pakaitos simbolis pakeičiamas mažiausia simbolių rinkinio reikšme, o reikšmės **12?4** pakaitos simbolis pakeičiamas didžiausia simbolių rinkinio reikšme. **Pastaba:** turėtumėte vengti naudoti pakaitos simbolius į intervalą patenkančiose pradžios ir pabaigos sąskaitose. Jei naudojate pakaitos simbolius pradžios arba pabaigos sąskaitoje, galite gauti nenumatytų rezultatų.

### <a name="single-segment-or-single-dimension-ranges"></a>Vieno segmento arba vienos dimensijos intervalai

Galite nurodyti segmentų reikšmių arba dimensijų reikšmių intervalą. Nurodyti intervalą naudinga todėl, kad jums nereikės atnaujinti eilutės aprašo kiekvieną kartą, kai į finansinius duomenis įtraukiama nauja segmento reikšmė arba dimensijos reikšmė. Pvz., nuo **+ į =\[6100:6900\]** traukia sąskaitų 6100 per 6900 reikšmes į eilutę suma. Kai intervale yra pakaitos simbolis (?), ataskaitų dizaino įrankis neįvertina intervalo pagal kiekvieną simbolį. Vietoj to nustatomos mažiausia ir didžiausia intervalo reikšmės, tada įtraukiamos pabaigos reikšmės ir tarp jų esančios reikšmės. **Pastaba:** ataskaitos dizainerio negalite pasirinkti sąskaitas, matmenys, ar laukus iš Microsoft Dynamics ERP sistemos, kuriose yra bet kuri iš šių saugomos simbolių: &, \*, \[, \], {, arba}. Ampersendą (&) įtraukti galite tik tada, kai naudodami dialogo langą **Įterpti eilutes iš dimensijų** automatiškai kuriate eilučių aprašus.

### <a name="multiple-segment-or-multiple-dimension-ranges"></a>Kelių segmentų arba kelių dimensijų intervalai

Įvedus diapazoną naudojant kelių dimensijų verčių deriniams, serijos palyginimas būtų daroma per... \financial-dimensions\dimension-by-dimension pagrindu. Intervalo palyginimo negalima atlikti pagal kiekvieną simbolį arba pagal segmento dalį. Pvz., nuo **+ į =\[5000:6000\], departamentas =\[1000:2000\], išlaidų centras =\[00\]** tik į finansinę atskaitomybę, kad atitiktų kiekvieno segmento. Tokiu atveju pirmoji dimensija turi būti intervale nuo 5000 per 6000, antroji matmuo turi būti intervale nuo 1000 per 2000 m. ir Paskutinė dimensija turi būti 00. Pvz., **+ į =\[5100\], departamentas =\[1100\], išlaidų centras =\[01\]** neįtrauktas dėl pranešimo, nes pastarasis segmentas yra už ribos. Jei segmento vertė yra tarpų, Paimkite reikšmės laužtiniuose skliaustuose (\[\]). Keturių simbolių segmentui, galioja šių verčių: **\[234\], \[123 \], \[1 34\]**. Dimensijų vertės turi būti uždara laužtiniuose skliaustuose (\[\]), ir dizaineris prideda šiuos skliausteliuose jums pranešime. Kai kelių segmentų arba kelių dimensijų asortimentas apima pakaitos simbolius (? Arba \*), nustatomi mažo ir didelio galai visai kelių segmentų arba kelių dimensijų diapazoną, ir tada pabaigos reikšmės ir visų reikšmių tarp jų yra įtraukti. Jei intervalas ilgas, pvz., visos sąskaitos nuo 40000 iki 99999, jei įmanoma, turite nurodyti tinkamą pradžios sąskaitą ir pabaigos sąskaitą. **Pastaba:** ataskaitos dizainerio negalite pasirinkti sąskaitas, matmenys, ar laukus iš Microsoft Dynamics ERP sistemos, kuriose yra bet kuri iš šių saugomos simbolių: &, \*, \[, \], {, arba}. Ampersendą (&) įtraukti galite tik tada, kai naudodami dialogo langą **Įterpti eilutes iš dimensijų** automatiškai kuriate eilučių aprašus.
...
|-----------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------|
| Pridėkite dvi visiškai paruoštas sąskaitas.                                                       | + Skyriaus =\[000\], sąskaitos =\[1205\], departamentas =\[00\]+ padalinys =\[100\], sąskaitos =\[1205\], departamentas =\[00\] |
| Pridėkite dvi segmentų reikšmes.                                                                 | + Į =\[1205\]+ į =\[1210\]                                                                           |
| Pridėkite segmentų reikšmes, kuriose yra pakaitos simbolių.                                    | + Į =\[120? + į =\[11??\]                                                                             |
| Pridėkite visiškai paruoštų sąskaitų intervalą.                                                | + Padalinys =\[000:100\], sąskaita =\[1205\], departamentas =\[00\]                                                   |
| Pridėkite segmentų reikšmių intervalą.                                                          | + Į =\[1200:1205\]                                                                                       |
| Pridėkite segmentų reikšmių, kuriose yra pakaitos simbolių, intervalą.                         | + Į =\[120?: 130?\]                                                                                       |
| Atimkite vieną visiškai paruoštą sąskaitą ir kitos visiškai paruoštos sąskaitos.              | + Skyriaus =\[000\], sąskaitos =\[1205\], departamentas =\[00\]-padalinys =\[100\], sąskaita =\[1205\], departamentas =\[00\] |
| Atimkite vieną segmento reikšmę iš kitos segmento reikšmės.                                  | + Į =\[1205\]-sąskaitos =\[1210\]                                                                           |
| Atimkite segmento reikšmę, kurioje yra pakaitos simbolis iš kitos segmento reikšmės. | + Į =\[1200\]-sąskaitos =\[11??\]                                                                           |
| Atimkite visiškai paruoštų sąskaitų intervalą.                                           | -Kvadratas =\[000:100\], sąskaita =\[1200:1205\], departamentas =\[00:01\]                                           |
| Atimkite segmentų reikšmių intervalą.                                                     | -Sąskaitos =\[1200:1205\]                                                                                       |
| Atimkite segmentų reikšmių, kuriose yra pakaitos simbolių, intervalą.                    | -Sąskaitos =\[120?: 130?\]                                                                                       |

Nors galite keisti sąskaitas tiesiogiai, norėdami taikyti tinkamą formatavimą savo finansinių duomenų saitams, taip pat galite naudoti dialogo langą **Dimensijos**. Bet kokia vertė galite įtraukti pakaitos simbolių (? Or \*). Tačiau ataskaitos dizainerio negali pasirinkti sąskaitas, matmenys, ar laukus iš Microsoft Dynamics ERP sistemos, kuriose yra bet kuri iš šių saugomos simbolių: &, \*, \[, \], {, arba}. **Pastaba:** norėdami atimti reikšmes, turite tas reikšmes rašyti skliausteliuose. Pavyzdžiui, jei įvedate **450?-(4509)**, jis rodomas kaip **+ į =\[4509\]-sąskaitos =\[450? \]**, ir jūs esate pateikdamas ataskaitą dizaineris atimti sumą į segmento 4509 nuo sumos, bet į segmentui, kuris prasideda nuo 450.
...
3.  Pirmoje dialogo lango **Dimensijos** eilutėje atlikite šiuos veiksmus:
    ...
    2.  Dukart spustelėkite, **operatorius /-** ląstelių, tada pasirinkite pliuso (**+**) arba minuso (**-**) subjektas, taikoma viena ar daugiau dimensijų vertėms arba nustato eilutę.
...
**Pastaba:** operatorius taikomas visoms eilutės dimensijoms.
...
|---------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Atskira reikšmė arba intervalas | Į, **nuo** lauke, įveskite abonemento pavadinimą arba spustelėkite į **naršyti** mygtuką ![naršyti](https://i-technet.sec.s-msft.com/dynimg/IC679490.gif "naršyti") Peržiūrėti abonemento. Norėdami pasirinkti intervalą, įveskite reikšmę arba ieškokite jos lauke **Iki**.                                             |
| Dimensijų reikšmių rinkinys | Lauke **Pavadinimas** įveskite dimensijų reikšmių rinkinio pavadinimą. Norėdami kurti, modifikuoti, kopijuoti arba panaikinti rinkinį, spustelėkite **Dimensijų reikšmių rinkinių tvarkymas**. Į **formulės** srityje yra apgyvendintos su formule, **nuorodą į finansinės dimensijos** ląstelių šios dimensijos vertei nustatyti eilutės apibrėžimo. |
...
5.  Dialogo lange **Modifikuoti** modifikuokite į rinkinį įtraukiamas formulės reikšmes. **Pastaba:** jei pridedate naujų sąskaitų arba dimensijų, būtinai pakeiskite esamus dimensijos reikšmių rinkinius, kad būtų įtraukti pakeitimai.
