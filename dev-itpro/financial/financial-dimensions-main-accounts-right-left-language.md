...
-   Pasirinkus diagramų sąskaitų skyriklį, pasirinkite parinktį dvivietis skyriklis: dvigubai brūkšnelį (-), dvigubos juostos (|) arba dvivietis taškas (.) arba dvigubo pabraukimo (\_\_).
