...
Kompensavimo apdorojimas suteikia galimybę apskaičiuoti naujos bazinės kompensacijos sumas darbuotojams pagal kapitalo koregavimus, nuopelnų padidinimo tikslus ir našumą. Šiame tinklaraščio įraše bus apžvelgiamas Pastoviųjų atlyginimo dalių planų bazinio kompensacijos srauto apdorojimas neatsižvelgiant į našumą.
...
Spustelėkite mygtuką **Pridėti** viršutiniame skirtuke, kad prie apdorojimo įvykio pridėtumėte kompensavimo planą. Stulpeliai **Naudoti kitą svertą**, **Sverto faktorius** ir **Sverto aprašymas** naudojami tik kintamosios atlyginimo dalies planuose ir šioje temoje neaptariami.

Įrašykite įrašą, tada spustelėkite mygtuką **Pridėti** apatiniame skirtuke, kad pridėtumėte pastoviosios atlyginimo dalies veiksmus į pasirinktą planą. Naudokite parinktį Įgalinti rekomendaciją, jei norite, kad būtų galima įvesti kitą sumą, nei apskaičiuotas veiksmo siūlomas padidinimas. Jei norite, kad veiksmas būtų skaičiuojamas pagal ankstesnio veiksmo rezultatus siekiant susieti keletą kompensavimo veiksmų, pažymėkite parinktį Naudoti ankstesnius rezultatus; pastoviosios atlyginimo dalies veiksmai yra kompensavimo logikos tipai, kuriems galite suteikti aprašomuosius pavadinimus. Kategorijų ir intervalų planų atveju, galite įtraukti tik pastoviosios atlyginimo dalies veiksmus, kurie iš šių tipų:
...
| Bendra                       | Bendrieji veiksmai padidinimą apskaičiuos pagal procentą arba paskirs darbuotojams standartinę sumą. Tai nustatoma remiantis skirtuko Bendra parametrais Pastovioji atlyginimo dalis.                                                                                                                                                                                                                        |
...
Darbuotojo rezultatai rodo informaciją apie patį procesą, taip pat proceso metu atliktus kompensacijos veiksmus; skyriuje Pastovioji atlyginimo dalis bus pateiktas kiekvieno veiksmo, įtraukto į kompensavimo plano apdorojimo įvykį, įrašas. Stulpeliuose Dabartinis siūlymas ir Rekomendacija bus rodoma daugiau informacijos apie veiksmą, pasirinktą skyriuje Pastovioji atlyginimo dalis. Jei veiksme buvo pažymėta Įgalinti rekomendacijas, laukus Rekomendacijos bus galima redaguoti. Tai leis jums rankiniu būdu koreguoti darbuotojo sumas. Pastaba: jei pažymėjote Naudoti ankstesnius rezultatus apdorojimo įvykio veiksmui, turite rankiniu būdu atnaujinti bet kokių priklausomųjų veiksmų sumas.
