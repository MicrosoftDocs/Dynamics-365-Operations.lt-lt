...
Skirtuke **Identifikacija** turite pasirinkti identifikavimo tipus, kurie atitinka identifikavimo numerius, išvardytus puslapyje. Turite nustatyti identifikavimo tipus prieš įvesdami darbuotojų identifikavimo informaciją. Informacija apie socialinio draudimo numerį, asmens kodą ir pašalinio vartotojo ID numerį yra saugoma puslapyje **Identifikavimo tipas**. Apibrėžti naują identifikavimo arba peržiūrėti esamas tipų sąrašą, spustelėkite **žmogiškųjų išteklių**&gt;**parametrai**&gt;**identifikavimo rūšys**. Galite įvesti paprastą kodą ir aprašymą. 
...
-   **Visada** – galite priskirti darbuotojams naujas pozicijas sukūrus pozicijas. Sukūrus pozicijas, į **galima priskirti** data ir laikas ant į **bendrojo** skirtuke į **pozicijos** puslapis automatiškai nustatomos sukūrimo datą ir laiką.
...
[Konkrečios įmonės žmogiškųjų išteklių parametrų nustatymas](set-up-company-specific-hr-parameters.md)
