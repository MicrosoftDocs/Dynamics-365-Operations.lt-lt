...
Norėdami koreguoti laisvos formos SF, kurios jau buvo užregistruotos, atidarykite užregistruotas laisvos formos SF. Dėl į **SF** puslapyje, pasirinkite **atšaukti**, ir tada pasirinkite **teisingą sąskaitą-faktūrą**. Pasirinkite priežasties kodą, pridėkite komentarų ir pasirinkite naujos pataisytos SF datą. Pataisytą SF galite modifikuoti ir užregistruoti. 
...
-   Laisvos formos SF antraštėje rodoma būsena **Cancelling SF '\[sąskaitos faktūros numeris\]'** ar **Corrected SF '\[sąskaitos faktūros numeris\]"**.

> [!NOTE]
> Ši funkcija galima tik tada, kai į **be teksto sąskaitos-faktūros taisymas** konfigūracijos raktą.
