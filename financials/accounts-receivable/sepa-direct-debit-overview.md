...
<a name="what-is-the-goal-of-sepa-direct-debits"></a>Kas yra SEPA tiesioginio debeto operacijų tikslas?
---------------------------------------

SEPA tiesioginio debeto būdu leidžia kreditoriui surinkti lėšų nuo kliento banko sąskaitos, kad pasirašytą įgaliojimą suteikė klientui kreditoriui. Klientas pasirašo įgaliojimą, kuris įgalioja kreditorių surinkti mokėjimą ir nurodo kliento bankui jį išmokėti. 
...
Tarptautinis banko sąskaitos numeris (IBAN) ir banko identifikavimo kodas (BIC) yra naudojami norint nustatyti bet kurią sąskaitą 32 SEPA šalyse / regionuose. Įveskite BIC SWIFT kodas bei IBAN lauke IBAN. Abu laukai yra Papildomos identifikacijos „FastTab‟, esančiame puslapio Banko sąskaitos skirtuke Banko sąskaita. Tai taikoma kreditoriaus banko sąskaitai ir kliento banko sąskaitai.
...
SEPA duomenų formatai pagrįsti ISO 20022 pranešimų standartais. Galite patikrinti generinių vaistų elektroninių pranešimų žymės langelį ir pasirinkite SEPA tiesioginio debeto formą kaip eksporto formatą konfigūracija, kai konfigūruojate gautinų sąskaitų mokėjimo būdai. Šį mokėjimo būdą naudojate, kai generuojate mokėjimo failą kliento mokėjimų žurnale.
