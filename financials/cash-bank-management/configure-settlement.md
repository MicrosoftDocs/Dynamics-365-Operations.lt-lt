...
Šių parametrų įtakos kaip gyvenviečių tvarkomi Microsoft Dynamics 365 operacijoms. Sudengimas yra procesas, kurio metu SF sudengiama su mokėjimu arba kredito pažyma. Šie parametrai yra srityje **Sudengimas** puslapiuose **Gautinų sumų parametrai** ir **Mokėtinų sumų parametrai**.
...
-   **Mokėjimo grynaisiais nuolaidos administravimas** – nurodykite kaip su [mokėjimo nuolaida yra tvarkomi, kai sąskaitos faktūros yra permokėta](cash-discount-handling-overpayments.md). Permoka, mokėjimo nuolaida gali būti sumažintas, jis galėtų būti laikomas skirtumas ar jis gali likti tiekėjo arba kliento sąskaita.
...
-   **Skaičiuoti kredito pažymų mokėjimo nuolaidas** – nustatykite šiai parinkčiai reikšmę **Taip**, kad automatiškai apskaičiuotumėte kredito pažymų mokėjimo nuolaidą. Naudojant modulį „Gautinos sumos“, kredito pažymos operacija yra neigiama operacija, kurios reikšmė nurodyta lauke **SF** puslapyje **Laisvos formos SF** arba grąžinimą puslapyje **Pardavimo užsakymas**.
    -   Šios parinkties poveikis priklauso nuo lauko **Naudoti mokėjimo nuolaidą** reikšmės puslapyje **Sudengti operacijas**. Jei ši pasirinktis bus nustatyta **taip**, nuolaida yra žengtas, *** naudoti mokėjimo grynaisiais nuolaidos *** laukas yra nustatytas **normalaus**. Kai į *** naudoti mokėjimo grynaisiais nuolaidos *** laukas yra nustatytas **visada**, mokėjimo nuolaida visuomet, nepriklausomai nuo kiekio nustatymu šioje srityje. Kai į *** naudoti mokėjimo grynaisiais nuolaidos *** laukas yra nustatytas **niekada**, mokėjimo nuolaida niekada nebuvo imtasi, nepriklausomai nuo kiekio nustatymu šioje srityje.
...
-   **Nustatyti sudengimo prioritetą (tik AR)** – nustatykite šiai parinkčiai reikšmę **Taip**, kad įgalintumėte mygtuką **Žymėti pagal prioritetą** puslapiuose **Įvesti kliento mokėjimus** ir **Sudengti operacijas**. Šis mygtukas leidžia vartotojams operacijoms priskirti iš anksto nustatytą atsiskaitymo tvarka.  Po atsiskaitymo tvarka buvo sugretinta operacija, užsakymo ir mokėjimų paskirstymo galima keisti prieš publikavimą.
-   **Naudoti prioriteto Automatinis atsiskaitymų** – nustatykite šią parinktį **taip** naudoti apibrėžtą pirmenybės tvarka, kai yra automatiškai sudengtos. Šis laukas galimas tik tada, kai į **prioritetus atsiskaitymo** ir **automatinio atsiskaitymo** parinktys nustatytos į **taip**.
