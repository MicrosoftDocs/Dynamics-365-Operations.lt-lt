---
title: "Nustatyti ir tvarkyti vaizdus mažmeninės prekybos šiuolaikinės EKA"
description: "Šiame straipsnyje paaiškinami veiksmai, dalyvauja kuriant ir valdant įvairūs subjektai – mažmeninės prekybos šiuolaikinės POS (MPOS) pasirodančios vaizdus."
author: MargoC
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="set-up-and-manage-images-for-retail-modern-pos"></a>Nustatyti ir tvarkyti vaizdus mažmeninės prekybos šiuolaikinės EKA

Šiame straipsnyje paaiškinami veiksmai, dalyvauja kuriant ir valdant įvairūs subjektai – mažmeninės prekybos šiuolaikinės POS (MPOS) pasirodančios vaizdus.
...
9.  Atnaujinti žiniasklaidos šablono katalogo vaizdų kanalo pusėje, įsitikinkite, kad paleisti **katalogas darbas 1150** nuo **mažmeninės prekybos ji**&gt;**pasiskirstymo grafikas**. [![catalog1](./media/catalog1.png)](./media/catalog1.png)

## <a name="previewing-an-image-from-the-entity-level"></a>Vaizdo peržiūra objekto lygyje
1.  Objekto prekės HQ puslapyje galite peržiūrėti vaizdą, kuris naudoja vaizdo URL, gautą iš medijos šablono. Pavyzdžiui, eiti į atitinkamą katalogą, ir tada į veiksmų sritį, spustelėkite **Media**&gt;**nuotraukos**. Naudokite išplečiamąjį sąrašą norėdami pasirinkti įvairias parduotuves, kurios gali turėti skirtingus kanalų šablonus.
...
Visi penki palaikomas objektų (darbuotojas, klientas, katalogas, kategorijos ir produktai), kiekvieną kartą, kai jūs atnaujinti, **nustatyti žiniasklaidos šabloną** dialogo lange nustatyti atvaizdą, įsitikinkite, kad vykdote užduotį katalogas (1150) iš **mažmeninės prekybos ji**&gt;**pasiskirstymo grafikas**. Atlikus šią užduotį, atnaujintą medijos šabloną bus galima sinchronizuojami su kanalu ir MPOS galės jį naudoti. Paleisti užduotį Katalogas (1150), atlikę toliau pateiktus keitimus.

-   Atnaujinti katalogo vaizdą žiniasklaidos šabloną iš **katalogas vaizdus**&gt;**nustatykite medijos šabloną**.
-   Atnaujinti darbuotojų vaizdo žiniasklaidos šabloną iš **darbuotojo nuotraukos**&gt;**nustatyti žiniasklaidos šabloną**.
-   Galite atnaujinti kliento vaizdo žiniasklaidos šabloną iš **klientų įvaizdį**&gt;**nustatykite medijos šabloną**.
-   Galite atnaujinti produkto vaizdo žiniasklaidos šabloną iš **gaminių nuotraukos**&gt;**nustatykite medijos šabloną**.
-   Galite atnaujinti kategoriją vaizdo žiniasklaidos šabloną iš **vaizdai Category**&gt;**nustatykite medijos šabloną**. Taip pat turite publikuoti kanalą.
...
4.  „FastTab“ **Generuoti vaizdų URL. skirtus „Excel“** spustelėkite **Generuoti**. **Svarbu:** kai pakeičiamas medijos šablonas, turite spustelėti **Generuoti** prieš norėdami naudodami funkciją Redaguoti programoje „Excel“. [![excel1](./media/excel1.jpg)](./media/excel1.jpg) jums dabar peržiūrėti vaizdo URL, sugeneruotus pagal paskutinę įrašytą žiniasklaidos šabloną. [![excel2](./media/excel2.png)](./media/excel2.png)**Pastaba:** The URL, kurie sugeneruojami "Excel" naudoja kelias ir konvencijas, žiniasklaidos šabloną, kuris yra nurodytas. Šios nuostatos apima failų vardų kūrimo nuostatas. Tikimasi, kad faktinius vaizdus nustatysite ne „Dynamics AX“, o vaizdus bus galima nuskaityti iš URL, kurie yra išvesti iš anksčiau nurodyto medijos šablono. Šiuos išvestus URL galite perrašyti, naudodami funkciją Redaguoti programoje „Excel“.
...
7.  Kai paraginama, spustelėkite **Pasitikėti šiuo priedu** dešiniojoje srityje ir laukite, kol priedas bus įdiegtas. [![Pasitikėti Šis papildinys](./media/excel4.jpg)](./media/excel4.jpg)
8.  Jei būsite paraginti prisijungti, įveskite kredencialus, kuriuos naudojate prisijungdami prie HQ. [![Prisijungimo eilutę](./media/excel5.png)](./media/excel5.png)
...
11. Galite perrašyti visų, išskyrus objekto Produktai, vaizdų URL. Modifikuokite esamą vaizdo URL, kad jis naudotų naują vaizdo paskirties URL, ir atnaujinkite failo vardą, įvesdami naują vaizdo failo vardą. Failo vardas turi būti unikalus, siekiant užtikrinti, kad įrašas yra unikalus. [![Programoje "Excel" image URL perrašyti](./media/excel6.jpg)](./media/excel6.jpg)**Pastaba:** kai perrašote image URL produktų objektų redagavimas naudojant "Excel" funkciją arba objekto elemento puslapyje, MPOS visada rodo visų žiniasklaidos šabloną vaizdo URL kartu su URL perrašyti vaizdas.
...
1.  Spustelėkite **katalogai**&gt;**Media**&gt;**nuotraukos**, ir pasirinkite atnaujinti katalogo vaizdą.
...
**[![cat3](./media/cat3.png)](./media/cat3.png)Pastaba:** po kategorijos vaizdą, asociacijos, turite publikuoti kanalas ir kanalo užduotį, kad būtų užtikrinta, kad pakeitimai būtų paskelbti kanalo duomenų bazei.
...
1.  Spustelėkite **produkto informacijos valdymo**&gt;**gaminiai**&gt;**produktai**.
...
7.  Perjunkite MPOS į atjungties režimą. Turėtumėte matyti nusiųstą konkretaus produkto vaizdą HQ. [![offline1](./media/offline1.png)](./media/offline1.png)
...
1.  Eiti į katalogą, ir tada spustelėkite Naujintiveiksmų srityje, **Media**&gt;**nuotraukos**.
