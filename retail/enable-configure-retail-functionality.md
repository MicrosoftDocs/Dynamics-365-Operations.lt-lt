---
title: "Inicijuoti sėklų duomenų naujas mažmeninės prekybos aplinkoje"
description: "Šiame straipsnyje aprašoma, inicijuoti proceso dalis skirta Microsoft Dynamics 365 operacijų - mažmeninės prekybos duomenys."
author: josaw1
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="initialize-seed-data-in-a-new-retail-environment"></a>Inicijuoti sėklų duomenų naujas mažmeninės prekybos aplinkoje

Šiame straipsnyje aprašoma, inicijuoti proceso dalis skirta Microsoft Dynamics 365 operacijų - mažmeninės prekybos duomenys.
...
1.  Paleisti Dynamics 365 kliento operacijas.
2.  Spustelėkite **mažmeninės prekybos ir komercijos**&gt;**būstinės sąrankos**&gt;**parametrai**&gt;**mažmeninė prekyba parametrai**.
