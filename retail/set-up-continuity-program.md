...
2.  Sukurkite tęstinumo programą, kurioje būtų nurodyta išsami informacija, pvz., mokėjimo grafikas, siuntimo laikas ir tai, ar apmokama iš anksto. Taip pat turite įtraukti produktų, kurie įtraukti į tęstinę programą, sąrašą. Kiekvieno produkto gauna įvykio ID numeris, kuris priskiriamas nuosekliai, pradedant nuo 1. Įvykio ID nustatyti tvarką, pagal kurią produktai, siunčiami.
...
3.  Sukurti pirminis produktas, kuris yra tęstinumo programą, kurią sukūrėte atlikdami 2 užduotį. Jei pridėsite šį produktą į pardavimo užsakymą, dėl **tęstinumą** puslapis atsidaro. Tada galėsite naudoti tą puslapį, kad sukurtumėte faktinį tęstinumo užsakymą. Pirminis produktas nenurodo atskirų produktų, kuriuos klientas gauna kiekvienoje siuntoje.
