...
[![konfigūruoti-ir-filtras-darbo](./media/configure-and-filter-workspaces.png)](./media/configure-and-filter-workspaces.png)   
...
[![konfigūruoti-mano-darbo](./media/configure-my-workspace.png)](./media/configure-my-workspace.png)
...
[![darbo srities filtras](./media/workspace-filter.png)](./media/workspace-filter.png) 

Kai, norėdami atidaryti filtrą, jį spustelėsite, jums bus pateiktos kelios pasirinktys. 

[![darbo srities filtras išsiplėtė](./media/workspace-filter-expanded.png)](./media/workspace-filter-expanded.png) 
...
[![darbo srities skyriuje filtrai](./media/workspace-section-filters.png)](./media/workspace-section-filters.png) 
