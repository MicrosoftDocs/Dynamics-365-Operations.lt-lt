...
Šiame skyriuje aprašyti pakeitimai taikomi 8.1.2347 komponavimo versijai.

### <a name="confirmation-of-course-participants-causes-an-error"></a>Kursų dalyvių patvirtinimas sukelia klaidą

Ataskaitos apie kursų dalyvius spausdinimo dialogo langas panaikintas. „Talent“ nepalaiko šios ataskaitos.

### <a name="the-compensation-section-of-the-transfer-worker-page-isnt-available-in-some-scenarios"></a>Naudojant kai kuriuos scenarijus puslapyje Darbininko perkėlimas skyriaus Kompensavimas nėra.

Šis pakeitimas leidžia vartotojams įvesti kompensacijų duomenis pildant puslapį **Darbininko perkėlimas**.
...
Pasirinktinus laukus palaikys šie objektai: Algalapio pajamų kodas ir Kompensavimo atskaitos taškas. 
