...
Šiame leidime šie „Common Data Service“ objektai dabar palaiko pasirinktinius laukus: išmokų skaičiavimo tarifo informacija, darbo kalendoriaus švenčių eilutė ir užimtumas.

### <a name="copy-position-now-includes-payroll-details"></a>Pareigų kopijavimas dabar apima algalapių informaciją
Kai naudojate **Kopijuoti pareigas** ir pasirenkate visas pasirinktis, algalapio informacija įtraukiama į kopijavimo informaciją. 

## <a name="in-preview-in-core-hr"></a>Peržiūra „Core HR“

### <a name="restrict-the-leave-types-in-time-off-requests"></a>Atostogų tipų apribojimas prašymuose išleisti iš darbo

Organizacijos darbuotojams gali pasiūlyti įvairių tipų atostogų. Kai kurie iš šių atostogų tipų gali būti netinkami darbuotojams, kad jie galėtų nurodyti nedarbo laiką, ir juos valdo personalo skyrius (HR). Pasirodžius šiam leidimui galite konfigūruoti, kuriems atostogų tipams darbuotojai gali pateikti nedarbo laiko užklausas. 

### <a name="new-page-to-validate-position-hierarchy-data"></a>Naujas puslapis, skirtas tikrinti pareigų hierarchijos duomenis

Personalo (HR) skyrius ir administratoriai dabar gali tikrinti, ar valdybos hierarchijoje nėra netyčia importuotų ciklinių nuorodų. Galite pasiekti naują puslapį dalyje **Organizacijos administravimas > Saitai > Pareigos > Pareigų hierarchijos tikrinimas**.
