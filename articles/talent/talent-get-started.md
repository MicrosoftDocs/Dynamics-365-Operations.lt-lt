...
-   [Darbo sričių konfigūravimas ir filtravimas](../fin-and-ops/get-started/configure-filter-workspaces.md) – šioje temoje rodoma, kaip galite keisti darbo sričių išvaizdą ir veikimą.

-   [Vieno šalia kito puslapių rodymas naudojant piktogramą Atidaryti naujame lange](../fin-and-ops/get-started/display-pages-side-by-side.md) – kai kuriais atvejais keletą puslapių efektyviau peržiūrėti patalpintus vieną šalia kito, nes taip užduotis galima atlikti greičiau. Šioje temoje aiškinama, kaip puslapius rodyti vieną šalia kito. 
