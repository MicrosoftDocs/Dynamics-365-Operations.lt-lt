...
ms.locfileid: "3081823"
---
# <a name="whats-new-or-changed-in-dynamics-365-talent-january-14-2020"></a>Kas nauja ar pasikeitė sistemoje „Dynamics 365 Talent“ (2020 m. sausio 14 d.)
...
Šiame skyriuje aprašyti pakeitimai taikomi 8.1.2709 komponavimo versijai. Kai kurių antraščių skaičiai skliausteliuose nurodo palaikymo numerius „Microsoft Dynamics Lifecycle Services“ (LCS).

### <a name="system-unable-to-generate-calendar-days-when-importing-through-data-management-framework-381195"></a>Sistemoje nepavyksta generuoti kalendorinių dienų importuojant per duomenų valdymo sistemą (381195)

Šiuo keitimu išsprendžiama problema, kylanti importuojant kalendorines dienas sugeneravus klaidą **Netinkamas datos formatas**. Dėl šios klaidos negalima kurti darbo kalendoriaus datos eilučių.
