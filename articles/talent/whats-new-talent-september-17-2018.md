...
## <a name="leave-and-absence--accrue-time-based-on-hours-worked"></a>Atostogos ir neatvykimai – laiko kaupimas pagal pradirbtas valandas
...
-   „Finance and Operations” platformos 18 naujinime „Talent” žiniatinklio kliento vaizdai dabar suderinti su „Microsoft Fluent Design“.
    ...
    -   Pasikeitė laukų rodymas skaitymo režimu.

    -   Darbo sričių ir puslapių antraštės yra paryškintos.

-   Patobulintas nekeitimo peržvalgų veikimas. Daugiau informacijos žr. [Patobulintas nekeitimo peržvalgų veikimas](https://docs.microsoft.com/business-applications-release-notes/October18/dynamics365-finance-operations/non-replacing-lookups).
