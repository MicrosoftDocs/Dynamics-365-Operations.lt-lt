...
description: Šiame straipsnyje aprašoma, kaip nustatyti produkto numerių klasifikaciją, pakeičiančią fiksuotą [bendrojo produkto numeris – konfigūracija – dydis – spalva – stilius] formatą.
author: t-benebo
ms.date: 11/03/2017
ms.topic: article
ms.prod: ''
