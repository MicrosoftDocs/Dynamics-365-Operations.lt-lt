...
1. Veiksmų srityje **Inžinerija** veiksmų juostoje rinkitės **Prižiūrėti konfigūracijas**.
1. Pasirinkite **Konfigūravimas**.
1. Sąraše pažymėkite pasirinktą eilutę.
...
1. Pasirinkite **Gerai**.
1. Sąraše pažymėkite pasirinktą eilutę.
1. Lauke **Konfigūracija** įveskite reikšmę.
