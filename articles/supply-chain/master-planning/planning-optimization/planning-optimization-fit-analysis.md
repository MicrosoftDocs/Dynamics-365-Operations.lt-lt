...
| --- | --- | --- | --- |
| Veiksmai | Padengimo grupės su įjungtu veiksmų skaičiavimu: _\#_ | Dabar ši funkcija yra palaikoma. | Palaikoma |
| Pagrindiniai kalendoriai | Kalendoriai, naudojantys pagrindinį kalendorių: _\#_ | Dabar ši funkcija yra palaikoma. | Palaikoma | 
| Paketo perdavimo kodai | Neaktyvaus pagrindinio paketo perdavimas: _\#_ | Ši funkcija laukia patvirtinimo. Šiuo metu paketo perdavimo kodai nepaisomi, kai įjungtas planavimo optimizavimas. | Spalio 2022 d. |
| Galimos pateikti atsargos (CTP) | Numatytieji užsakymo parametrai su pristatymo datos valdymu, nustatytu į CTP: _\#_ | Tiekimo grandinės valdymo 10.0.28 ir naujesnio proceso, kuris vadinamas CTP *planavimo optimizavimui,* leidžia patvirtinti siuntimo ir gavimo datas po dinaminio plano vykdymo. Senesnių tiekimo grandinės valdymo versijų senesnio CTP parametro nepaisoma, kai įgalintas planavimo optimizavimas. | Palaikoma |
...
| Blokavimo laiko ribos | Padengimo grupės su nustatyta blokavimo laiko riba: _\#_ | Ši funkcija laukia patvirtinimo. Šiuo metu blokavimo laiko ribos nustatymo nepaisoma, kai įjungtas planavimo optimizavimas, neatsižvelgiant į šį parametrą. | Spalio 2022 d. |
| Blokavimo laiko ribos | Prekių aprėpties įrašai su nustatyta blokavimo laiko riba: _\#_ | Ši funkcija laukia patvirtinimo. Šiuo metu blokavimo laiko ribos nustatymo nepaisoma, kai įjungtas planavimo optimizavimas, neatsižvelgiant į šį parametrą. | Spalio 2022 d. |
| Blokavimo laiko ribos | Bendrieji planai su nustatyta blokavimo laiko riba: _\#_ | Ši funkcija laukia patvirtinimo. Šiuo metu blokavimo laiko ribos nustatymo nepaisoma, kai įjungtas planavimo optimizavimas, neatsižvelgiant į šį parametrą. | Spalio 2022 d. |
...
| Produkto ciklo būsena | Produkto ciklo būsenos nesuaktyvintos planavimui: _\#_ | Dabar ši funkcija yra palaikoma. Papildomos informacijos rasite [Neįtraukti produktų, turinčių konkrečias produkto ciklo būsenas](product-lifecycle-state.md) | Palaikoma |
...
| Gamyba | KS / formulės eilutės su prekės pakeitimu (planavimo grupės): _\#_ | Ši funkcija laukia patvirtinimo. Šiuo metu KS ir formulės eilutėse esančio prekės pakeitimo (planavimo grupių) nepaisoma, kai įjungtas planavimo optimizavimas, neatsižvelgiant į šį parametrą. | 2022 m. gruodžio mėn. |
...
| Gamyba | Poreikis su apibrėžtomis konkrečiomis KS ar maršruto reikalavimais: _\#_ | Ši funkcija laukia patvirtinimo. Šiuo metu konkrečių KS ar maršruto reikalavimų, apibrėžtų pagal poreikį (pvz., KS arba maršrutas pardavimo užsakyme), nepaisoma, kai įjungtas planavimo optimizavimas. Bus naudojama standartinė KS arba maršrutas, neatsižvelgiant į šį nustatymą. | 2022 m. gruodžio mėn. |
| Gamyba | Formulės versijos su sudėtiniais / šalutiniais produktais: _\#_ | Ši funkcija laukia patvirtinimo. Šiuo metu sudėtinių ir šalutinių produktų, susietų su formulės versija, nepaisoma, kai įjungtas planavimo optimizavimas. | 2022 m. gruodžio mėn. |
| Gamyba | Formulės versijos su išeiga: _\#_ | Ši funkcija laukia patvirtinimo. Šiuo metu išeigos, susietos su formulės versija, nepaisoma, kai įjungtas planavimo optimizavimas. | 2022 m. gruodžio mėn. |
| Gamyba | Planai su seka: _\#_ | Ši funkcija laukia patvirtinimo. Šiuo metu sekos nepaisoma, kai įjungtas planavimo optimizavimas, neatsižvelgiant į šį parametrą. | 2022 m. gruodžio mėn. |
| Gamyba | Paleisti gamybos užsakymai, kurie nepradėti, buvo suplanuoti pradėti anksčiau nei šiandien: _\#_ | Ši funkcija laukia patvirtinimo. Šiuo metu, jei gamybos užsakymas vėluoja, bendrojo planavimo metu bus laikoma, kad jis bus baigtas šiandien. Tai aktualu išleistiems gamybos užsakymais, kurių pristatymo data yra praėjusi, tačiau užsakymai dar nėra baigti. | 2023 arba naujesnė versija |
...
| Gamyba | Maršrutai, naudojami planuojant: _\#_ | Ši funkcija palaikoma. | Palaikoma |
| Gamyba | Pardavimo eilutės rezervavimas, naudojantis išskleidimą: _\#_ | Pardavimo eilutės rezervavimas, naudojantis išskleidimą, nepalaikomas, kai įjungtas planavimo optimizavimas. | 2023 arba naujesnė versija |
| Gamyba | Planavimas išskleidžiant gamybos užsakymus: _\#_ | Planavimas, naudojantis gamybos užsakymų išskleidimą, nepalaikomas, kai įjungtas planavimo optimizavimas. Gamybos užsakymai gali būti suplanuoti atskirai. | 2023 arba naujesnė versija |
| Pasiūlymo patvirtinimai | Bendrieji planai su įgalintu pasiūlymo patvirtinimu: _\#_ | Ši funkcija laukia patvirtinimo. Šiuo metu pasiūlymo patvirtinimai (RFQ) nėra laikomi poreikiu, kai įjungtas planavimo optimizavimas. Jų bus nepaisoma, neatsižvelgiant į šį nustatymą. | 2022 m. gruodžio mėn. |
...
| Laiko rezervai | Padengimo grupės su laiko rezervu: _\#_ | Dabar ši funkcija yra palaikoma. Papildomą informaciją rasite [Laiko rezervai](safety-margins.md) | Palaikoma |
| Laiko rezervai | Bendrieji planai su laiko rezervu: _\#_ | Dabar ši funkcija yra palaikoma. Papildomą informaciją rasite [Laiko rezervai](safety-margins.md) |  Palaikoma |
...
| Laikymo trukmė | Bendrieji planai su įgalinta laikymo trukme: _\#_ | Ši funkcija laukia patvirtinimo. Šiuo metu į laikymo trukmę neatsižvelgiama, kai įjungtas planavimo optimizavimas, neatsižvelgiant į šį parametrą. | 2022 m. birželio mėn. |
