...
| Gamyba | KS be svetainės: _\#_ | Ši funkcija laukia patvirtinimo. Šiuo metu KS be svetainės nepaisoma, kai įjungtas planavimo optimizavimas. | 2020 m. spalio mėn. |
...
| Laiko rezervai | Padengimo grupės su laiko rezervu: _\#_ | Ši funkcija laukia patvirtinimo. Šiuo metu laiko rezervo nepaisoma, kai įjungtas planavimo optimizavimas. Norėdami kompensuoti šią problemą, galite padidinti gamybos laiką, kad būtų įtrauktas laiko rezervas. | 2020 m. spalio mėn. |
| Laiko rezervai | Bendrieji planai su laiko rezervu: _\#_ | Ši funkcija laukia patvirtinimo. Šiuo metu laiko rezervo nepaisoma, kai įjungtas planavimo optimizavimas, neatsižvelgiant į šį parametrą. Norėdami kompensuoti šią problemą, galite padidinti gamybos laiką, kad būtų įtrauktas laiko rezervas. | 2020 m. spalio mėn. |
