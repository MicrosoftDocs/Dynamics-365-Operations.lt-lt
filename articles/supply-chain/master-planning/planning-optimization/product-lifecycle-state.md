...
description: Šiame straipsnyje paaiškinama, kaip neįtraukti produktų pagal jų ciklo būseną, kai naudojamas planavimo optimizavimo funkcionalumas.
author: t-benebo
ms.date: 11/13/2020
ms.topic: article
ms.prod: ''
