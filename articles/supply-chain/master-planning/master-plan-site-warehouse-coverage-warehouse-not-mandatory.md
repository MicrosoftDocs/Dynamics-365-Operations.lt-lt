...
description: Šiame straipsnyje aprašoma, kaip suplanuotos prekės, kurių padengimo dimensijos yra svetainė ir sandėlis. Sandėlio dimensija nėra privaloma.
author: t-benebo
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
Šiame straipsnyje aprašoma, kaip suplanuotos prekės, kurių padengimo dimensijos yra svetainė ir sandėlis. Sandėlio dimensija nėra privaloma.
