...
ms.locfileid: "6713691"
---
# <a name="master-planning-and-multisite-functionality-overview"></a>Bendrojo planavimo ir funkcionalumo daugelyje vietų apžvalga

[!include [banner](../includes/banner.md)]

Atliekant bendrąjį planavimą, atsižvelgiama į teritorijos ir sandėlio atsargų dimensijas. 

Teritorijos dimensija yra privaloma, ir galite nustatyti, kad sandėlio dimensija būtų privaloma.

Kai dimensija yra privaloma, dimensijos vertė turi būti įvesta visoms atsargų operacijoms. Todėl bendrojo planavimo metu yra žinoma pradinė poreikio teritorija ir sandėlis. Teritorijos dimensija taip pat yra nuosekli, kad išskleidimo pagal žemesnį poreikį metu teritorijos vertė nepasikeistų.
...
[Bendrasis vietos padengimo planavimas, sandėlis neprivalomas](master-plan-site-coverage-warehouse-not-mandatory.md)
