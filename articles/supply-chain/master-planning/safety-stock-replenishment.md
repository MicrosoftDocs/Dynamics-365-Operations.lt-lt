...
[![MinMaks. Šiandienos data.](./media/TodayMinMax.png)](./media/TodayMinMax.png)
...
[![Poreikis. Laikotarpis. Šiandienos data ir gamybos laikas.](./media/TodayPLTReq.png)](./media/TodayPLTReq.png)
Tolesnėje iliustracijoje parodytas plano rezultatus, jei padengimo kodas yra **Min / Max**.  
[![MinMaks. Šiandienos data ir gamybos laikas.](./media/TodayPLTMinMax.png)](./media/TodayPLTMinMax.png)
