...
1. Eikite į **Bendrojo planavimo nustatymą \>, \> kad būtų galima atlikti šio žurnalo pavadinimus**.
...
1. Naujoje eilutėje nustatykite šiuos laukus:
    ...
    Laukas **Žurnalo tipas** skirtas tik skaityti, jis iš anksto nustatytas kaip Krito *atsargos*.
