...
description: Išlaidų susumavimas ir pardavimo kainos apskaičiavimas vadinamas komplektavimo specifikacijų (KS) skaičiavimais, kuriuos galite inicijuoti skaičiavimų puslapyje. Šiame straipsnyje pateikiama informacija apie KS skaičiavimus.
author: JennySong-SH
ms.date: 05/01/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8902808"
---
# <a name="bom-calculations"></a>BOM skaičiavimai

[!include [banner](../includes/banner.md)]

Išlaidų susumavimas ir pardavimo kainos apskaičiavimas vadinamas komplektavimo specifikacijų (KS) skaičiavimais, kuriuos galite inicijuoti skaičiavimų puslapyje. Šiame straipsnyje pateikiama informacija apie KS skaičiavimus.
