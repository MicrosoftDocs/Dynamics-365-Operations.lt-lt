...
description: Šiame straipsnyje aptariamos užduotys, kurias reikia atlikti prieš atliekant standartinių išlaidų konvertavimą.
author: JennySong-SH
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8887564"
---
# <a name="prerequisites-for-a-standard-cost-conversion"></a>Būtinos standartinių išlaidų konvertavimo sąlygos

[!include [banner](../includes/banner.md)]

Šiame straipsnyje aptariamos užduotys, kurias reikia atlikti prieš atliekant standartinių išlaidų konvertavimą. 
