...
description: Šiame straipsnyje paaiškinama, kaip pridėti kainos ir tiekėjo informaciją prie pirkimo paraiškos per RFQ procesą.
...
ms.locfileid: "8846017"
---
# <a name="create-a-requisition-that-uses-an-rfq"></a>Paraiškos, kurioje naudojamas RFQ, kūrimas

[!include [banner](../../includes/banner.md)]

Šiame straipsnyje paaiškinama, kaip pridėti kainos ir tiekėjo informaciją prie pirkimo paraiškos per RFQ procesą. Šiame vedlyje pateiktą pavyzdį galite naudoti demonstracinių duomenų įmonėje USMF, o norėdami atlikti visus veiksmus turite būti prisijungęs kaip Administratorius. Paprastai šio vedlio užduotis atlieka įsigijimo specialistai.
