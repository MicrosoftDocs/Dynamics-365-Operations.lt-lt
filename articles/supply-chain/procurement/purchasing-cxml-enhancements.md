...
- **VARTOTOJOAGENTAS** – Įveskite reikšmę, kad nustatytumėte sistemą, kurią naudojate. Pvz., įveskite _"Dynamics 365" tiekimo grandinės valdymą_.
...
- **PUKOMENTARAI** – Nustatykite šią ypatybę kaip _TEISINGĄ_, jei norite, kad į cXML dokumentą būtų įtrauktos pastabos, pridėtos prie pirkimo užsakymo „Supply Chain Management“. Priedo tekstas yra įtrauktas į antraštės komentarus pirkimo užsakymo pranešime. Daugiau informacijos apie tai, kaip sistema pasirenka ir apdoroja šiuos priedus, [ieškokite](#attach-po-notes) toliau šiame straipsnyje skyriuje Pridėkite pastabas prie pirkimo užsakymo skyriaus.
