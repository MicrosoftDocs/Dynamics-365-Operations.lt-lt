...
description: Šioje temoje pateikiama informacija apie tiekėjo SF objektus, kurie įgalina konfigūruoti vidinių ar išorinių išlaidų tipų kodus.
author: yufeihuang
ms.date: 05/27/2022
ms.topic: article
ms.search.form: ''
