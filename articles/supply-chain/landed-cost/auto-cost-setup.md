...
description: Šiame straipsnyje aprašoma, kaip nustatyti įvairių gaunamų reisų lygių išlaidų taisykles. Pagal šias taisykles sistema apskaičiuoja savikainą ir automatiškai ją prideda. Todėl naudotojams nereikia rankiniu būdu pridėti savikainos.
author: Weijiesa
ms.date: 01/21/2021
ms.topic: article
ms.prod: ''
...
Norėdami dirbti su automatine savikaina pereikite į **Iškrauto produkto savikaina\> Įkainojimo nustatymas \> Automatinė savikaina**. Tada nustatykite savo automatinių išlaidų taisykles, kaip aprašyta likusioje šio straipsnio dalyje.
