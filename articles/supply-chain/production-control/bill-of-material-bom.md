...
description: Šiame straipsnyje pateikiama informacija apie komplektavimo specifikacijas (KS) ir formules, kurios yra pagrindinė produktų ir produkto variantų apibrėžimo dalis.
...
Šiame straipsnyje pateikiama informacija apie komplektavimo specifikacijas (KS) ir formules, kurios yra pagrindinė produktų ir produkto variantų apibrėžimo dalis. KS ir formulės nurodo reikiamas konkretaus produkto medžiagas arba sudedamąsias dalis. Formulės taip pat nurodo sudėtinius produktus arba šalutinius produktus, kurie gauname konkrečiame gamybos kontekste. 
