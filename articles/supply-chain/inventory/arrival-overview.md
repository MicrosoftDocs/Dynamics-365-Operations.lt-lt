...
description: Šiame straipsnyje pateikiama informacija apie atvykimo apžvalgos funkciją. Gavimų apžvalgos puslapyje, kuris yra šios funkcijos dalis, pateikiama visų numatomų pristatyti prekių, kaip gaunamų prekių, peržiūra.
author: yufeihuang
ms.date: 11/02/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8874078"
---
# <a name="arrival-overview"></a>Gavimų apžvalga

[!include [banner](../includes/banner.md)]

Šiame straipsnyje pateikiama informacija apie atvykimo apžvalgos funkciją. Gavimų apžvalgos puslapyje, kuris yra šios funkcijos dalis, pateikiama visų numatomų pristatyti prekių, kaip gaunamų prekių, peržiūra.

Puslapyje **Gavimų apžvalga** pateikiama visų numatomų gaunamų prekių peržiūra. Jame taip pat rodomi gavimai, kuriuos galima inicijuoti remiantis peržiūra. Šis straipsnis susitelkia apie gavimo procesą.
