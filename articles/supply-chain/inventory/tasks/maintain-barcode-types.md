...
---
# <a name="maintain-bar-code-types"></a>Tvarkyti brūkšninių kodų tipus
...
1. Eiti į brūkšninius kodus.
2. Spustelėkite Naujas.
3. Lauke Brūkšninio kodo sąranka įveskite vertę.
4. Lauke Aprašas įveskite reikšmę.
5. Lauke Brūkšninio kodo tipas pasirinkite pasirinktį.
    * Jei naudojate USMF, galite pasirinkti „Kodas 39“.  
6. Lauke Dydis įveskite skaičių.
7. Lauke Didžiausias ilgis įveskite skaičių.
8. Spustelėkite Įrašyti.
9. Uždarykite puslapį.
10. Eikite į Atsargų ir sandėlio valdymo parametrus.
11. Lauke Brūkšninio kodo nustatymas įveskite arba pasirinkite vertę.
    * Pasirinkite anksčiau sukurtą brūkšninio kodo nustatymą, bet turėkite omenyje, kad brūkšninio kodo formatas turi atitikti procese naudojamo įrašo tipo unikalaus identifikatoriaus formatą. Pavyzdžiui, išrinkimo maršrutų brūkšninio kodo formatas turi atitikti išrinkimo maršruto nuorodos formatą, kuris paprastai yra numerių seka.  
