...
description: Šiame straipsnyje pateikiama informacija apie sandėlio atsargų koregavimo žurnalą ir apdorojimą, kai naudojate skalės vienetus.
author: perlynne
ms.date: 04/22/2021
ms.topic: article
ms.prod: ''
