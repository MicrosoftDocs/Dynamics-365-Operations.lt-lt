...
description: Šiame straipsnyje aprašoma, kaip nustatyti prekės tikrinimą kartu su klasterio paėmimu.
author: Mirzaab
ms.date: 05/26/2017
ms.topic: article
ms.prod: ''
...
Prekių patikrinimas atliekant klasterio parinkimą atliekamas tuo pačiu būdu kaip ir tikrinant prekes nevykstant klasterių parinkimo procesams. Sąranka pagrįsta produkto brūkšninio kodo sąranka.
...
1. Mobiliojo įrenginio meniu elemente atidarykite **Darbo patvirtinimo sąranka**.
