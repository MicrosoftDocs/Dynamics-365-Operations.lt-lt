...
ms.locfileid: "859764"
---
# <a name="warehouse-mobile-device-display-settings"></a>Sandėlio mobiliųjų įrenginių rodymo parametrai

[!include [banner](../includes/banner.md)]

> [!NOTE]
> Ši funkcija nerekomenduojama. Norėdami gauti daugiau informacijos, žr. [Pašalintos arba nerekomenduojamos funkcijos](../../dev-itpro/migration-upgrade/deprecated-features.md#warehouse-mobile-devices-portal).
