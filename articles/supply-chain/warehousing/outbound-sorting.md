...
### <a name="set-up-a-wave-template"></a><span data-ttu-id="a14b5-123">Bangos šablono nustatymas</span><span class="sxs-lookup"><span data-stu-id="a14b5-123">Set up a wave template</span></span>
...
1. <span data-ttu-id="a14b5-139">**Vartotojų** gretajame skirtuke pasirinkite **Naujas** tam, kad sukurtumėte mobilaus prietaiso paskyrą ir nustatykite jai šias vertes:</span><span class="sxs-lookup"><span data-stu-id="a14b5-139">On the **Users** FastTab, select **New** to create a mobile device account, and set the following values for it:</span></span>
    ...
    - <span data-ttu-id="a14b5-140">**Vartotojo identifikavimo numeris** Įveskite unikalų identifikavimo numerį.</span><span class="sxs-lookup"><span data-stu-id="a14b5-140">**User ID:** Enter a unique ID.</span></span>
...
### <a name="set-up-warehouse-management-parameters"></a><span data-ttu-id="a14b5-157">Nustatykite Sandėlio tvarkymo parametrus</span><span class="sxs-lookup"><span data-stu-id="a14b5-157">Set up Warehouse management parameters</span></span>
...
### <a name="set-up-a-location"></a><span data-ttu-id="a14b5-173">Nustatykite vietą</span><span class="sxs-lookup"><span data-stu-id="a14b5-173">Set up a location</span></span>
...
1. <span data-ttu-id="a14b5-192">„FastTab“ skirtuke **Bendra** nustatykite šias reikšmes:</span><span class="sxs-lookup"><span data-stu-id="a14b5-192">On the **General** FastTab, set the following values:</span></span>
...
1. <span data-ttu-id="a14b5-210">Pasirinkite **Gerai**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-210">Select **OK**.</span></span>
...
1. <span data-ttu-id="a14b5-226">**Peržiūros** „FastTab“, nustatykite šias vertes:</span><span class="sxs-lookup"><span data-stu-id="a14b5-226">On the **Overview** FastTab, set the following values:</span></span>
    ...
    - <span data-ttu-id="a14b5-227">**Sandėlis:** *62*</span><span class="sxs-lookup"><span data-stu-id="a14b5-227">**Warehouse:** *62*</span></span>
...
<span data-ttu-id="a14b5-245">Nustatykite darbo klasę, kuri bus naudojama kartu su rūšiavimu.</span><span class="sxs-lookup"><span data-stu-id="a14b5-245">Set up a work class that will be used together with sorting.</span></span>
...
1. <span data-ttu-id="a14b5-262">„FastTab“ skirtuke **Bendra** nustatykite šias reikšmes:</span><span class="sxs-lookup"><span data-stu-id="a14b5-262">On the **General** FastTab, set the following values:</span></span>
...
1. <span data-ttu-id="a14b5-279">**Darbo klasių** „FastTab“, pasirinkite **Naujas** ir tuomet nustatykite tolesnes vertes:</span><span class="sxs-lookup"><span data-stu-id="a14b5-279">On the **Work classes** FastTab, select **New**, and then set the following values:</span></span>
    ...
    - <span data-ttu-id="a14b5-280">**Darbo klasės identifikavimo numeris:** *SORT*</span><span class="sxs-lookup"><span data-stu-id="a14b5-280">**Work class ID:** *SORT*</span></span>
...
#### <a name="set-up-a-single-sku-directive"></a><span data-ttu-id="a14b5-296">Nustatykite vieną SKU direktyvą</span><span class="sxs-lookup"><span data-stu-id="a14b5-296">Set up a single-SKU directive</span></span>
...
1. <span data-ttu-id="a14b5-315">**Vietos direktyvos veiksmai** „FastTab“, pasirinkite **Naujas** ir tuomet nustatykite tolesnes vertes naujoje linijoje.</span><span class="sxs-lookup"><span data-stu-id="a14b5-315">On the **Location Directive Actions** FastTab, select **New**, and then set the following values on the new line.</span></span> <span data-ttu-id="a14b5-316">Priimkite nustatytąsias vertes visiems kitiems laukeliams.</span><span class="sxs-lookup"><span data-stu-id="a14b5-316">Accept the default values for all the other fields.</span></span>
    ...
    - <span data-ttu-id="a14b5-317">**Seka:** *1*</span><span class="sxs-lookup"><span data-stu-id="a14b5-317">**Sequence:** *1*</span></span>
...
1. <span data-ttu-id="a14b5-336">Pasirinkite **Įrašyti** įrankių juostai padėti į **Linijos** „FastTab“.</span><span class="sxs-lookup"><span data-stu-id="a14b5-336">Select **Save** to make the toolbar on the **Lines** FastTab available.</span></span>
...
1. <span data-ttu-id="a14b5-356">**Peržiūros** skirtuke, nustatykite šias vertes:</span><span class="sxs-lookup"><span data-stu-id="a14b5-356">On the **Overview** tab, set the following values:</span></span>
    ...
    - <span data-ttu-id="a14b5-357">**Seka:** *1*</span><span class="sxs-lookup"><span data-stu-id="a14b5-357">**Sequence:** *1*</span></span>
...
1. <span data-ttu-id="a14b5-373">Pasirinkite **Pardavimas ir rinkodara \> Pardavimo užsakymai \> Visi pardavimo užsakymai**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-373">Go to **Sales and marketing \> Sales orders \> All sales orders**.</span></span>
...
1. <span data-ttu-id="a14b5-411">**Linijos informacijoje** „FastTab“, **Pristatymo** skirtuke, pakeiskite **Pristatymo būdo** laukelio vertę į *Air C-Air*.</span><span class="sxs-lookup"><span data-stu-id="a14b5-411">On the **Line details** FastTab, on the **Delivery** tab, change the value of the **Mode of delivery** field to *Air C-Air*.</span></span>
...
1. <span data-ttu-id="a14b5-457">**Prekybos užsakymai - Paėmimas** puslapyje įveskite paskirties LP.</span><span class="sxs-lookup"><span data-stu-id="a14b5-457">On the **Sales orders - Pick** page, enter a target LP.</span></span> <span data-ttu-id="a14b5-458">Atkreipkite dėmesį, kad yra rodoma paėmimo vieta (*bulk-002*), elementas (*A0001*) ir kokybė (*1 vnt.*).</span><span class="sxs-lookup"><span data-stu-id="a14b5-458">Notice that the picking location (*bulk-002*), item (*A0001*), and quantity (*1 pcs*) are shown.</span></span>
1. <span data-ttu-id="a14b5-459">Pasirinkite **Gerai**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-459">Select **OK**.</span></span>
1. <span data-ttu-id="a14b5-460">Peržiūrėkite informaciją **Prekybos užsakymai - Paėmimas** puslapyje.</span><span class="sxs-lookup"><span data-stu-id="a14b5-460">Review the information on the **Sales orders - Put** page.</span></span> <span data-ttu-id="a14b5-461">**Loc** laukelis turi rodyti, kad paimti elementai bus *Pakavimo* vietoje.</span><span class="sxs-lookup"><span data-stu-id="a14b5-461">The **Loc** field should indicate that the picked items are going to the *Pack* location.</span></span>
1. <span data-ttu-id="a14b5-462">Pasirinkite **Gerai**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-462">Select **OK**.</span></span>

    <span data-ttu-id="a14b5-463">**Darbo / licencijos numerio identifikavimo kodo nuskaitymo** puslapyje jums bus parodytas pranešimas „Darbas baigtas“.</span><span class="sxs-lookup"><span data-stu-id="a14b5-463">On the **Scan a work ID / license plate ID** page, you receive a "Work Completed" message.</span></span> <span data-ttu-id="a14b5-464">Šis pranešimas rodo, kad darbo identifikavimo kodas 2 prekybos užsakymo 2 linijoje buvo užbaigtas.</span><span class="sxs-lookup"><span data-stu-id="a14b5-464">This message indicates that the work ID from line 2 of sales order 2 has been completed.</span></span>

### <a name="pack-sales-orders-into-containers"></a><span data-ttu-id="a14b5-465">Prekybos užsakymų pakavimas į talpyklas</span><span class="sxs-lookup"><span data-stu-id="a14b5-465">Pack sales orders into containers</span></span>

#### <a name="pack-sales-order-1-into-containers"></a><span data-ttu-id="a14b5-466">Prekybos užsakymo 1 pakavimas į talpyklas</span><span class="sxs-lookup"><span data-stu-id="a14b5-466">Pack sales order 1 into containers</span></span>

1. <span data-ttu-id="a14b5-467">Eikite į **Sandėlio tvarkymas \> Pakavimas ir dėjimas į talpyklas \> Pakavimas**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-467">Go to **Warehouse management \> Packing and containerization \> Pack**.</span></span>

    <span data-ttu-id="a14b5-468">Pasirodo**Pasirinkit pakavimo stotį** teksto laukelis.</span><span class="sxs-lookup"><span data-stu-id="a14b5-468">The **Select packing station** dialog box appears.</span></span> <span data-ttu-id="a14b5-469">Pagal nutylėjimą, **Darbuotojo** laukelis turi būti nustatytas į darbuotojo vardą, kurį nustatėte anksčiau.</span><span class="sxs-lookup"><span data-stu-id="a14b5-469">By default, the **Worker** field should be set to the name of the worker that you set up earlier.</span></span>

1. <span data-ttu-id="a14b5-470">Nustatykite tolesnes vertes tam, kad peržiūrėtumėte ir dirbtumėte su siuntimais ir talpyklomis, kuriuos yra planuojamos konkrečioje pakavimo vietoje:</span><span class="sxs-lookup"><span data-stu-id="a14b5-470">Set the following values to view and work on shipments and containers that are planned at the specific packing location:</span></span>

    - <span data-ttu-id="a14b5-471">**Vieta:** *6*</span><span class="sxs-lookup"><span data-stu-id="a14b5-471">**Site:** *6*</span></span>
    - <span data-ttu-id="a14b5-472">**Sandėlis:** *62*</span><span class="sxs-lookup"><span data-stu-id="a14b5-472">**Warehouse:** *62*</span></span>
    - <span data-ttu-id="a14b5-473">**Vieta:** *Pakavimas*</span><span class="sxs-lookup"><span data-stu-id="a14b5-473">**Location:** *Pack*</span></span>
    - <span data-ttu-id="a14b5-474">**Pakavimo profilio identifikavimo numeris:** *Rūšiuoti*</span><span class="sxs-lookup"><span data-stu-id="a14b5-474">**Packing profile ID:** *Sort*</span></span>

1. <span data-ttu-id="a14b5-475">Pasirinkite **Gerai**, kad uždarytumėte dialogo langą.</span><span class="sxs-lookup"><span data-stu-id="a14b5-475">Select **OK** to close the dialog box.</span></span>
1. <span data-ttu-id="a14b5-476">**Pakavimo** puslapyje, **Licencijos numeris ar siuntimas** laukelyje įveskite paskirties LP prekybos užsakymui 1.</span><span class="sxs-lookup"><span data-stu-id="a14b5-476">On the **Pack** page, in the **License plate or shipment** field, enter the target LP for sales order 1.</span></span> <span data-ttu-id="a14b5-477">Tuomet pasirinkite **Skirtuką** ar **Įvesties** raktą savo klaviatūroje, kad išeitumėte iš laukelio.</span><span class="sxs-lookup"><span data-stu-id="a14b5-477">Then select the **Tab** or **Enter** key on your keyboard to move out of the field.</span></span>
1. <span data-ttu-id="a14b5-478">Veiksmų juostoje pasirinkite**Naujas talpykla**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-478">On the Action Pane, select **New container**.</span></span>
1. <span data-ttu-id="a14b5-479">Priimkite visus nustatytuosius nustatymus ir pasirinkite **OK**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-479">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="a14b5-480">Užsirašykite talpyklos identifikavimo kodą.</span><span class="sxs-lookup"><span data-stu-id="a14b5-480">Make a note of the container ID.</span></span>
1. <span data-ttu-id="a14b5-481">**Elemento pakavimo** „FastTab“, nustatykite šias vertes:</span><span class="sxs-lookup"><span data-stu-id="a14b5-481">On the **Item packing** FastTab, set the following values:</span></span>

    - <span data-ttu-id="a14b5-482">**Kiekis:** *1*</span><span class="sxs-lookup"><span data-stu-id="a14b5-482">**Quantity:** *1*</span></span>
    - <span data-ttu-id="a14b5-483">**Identifikavimo kodo:** Elementas *A0001*</span><span class="sxs-lookup"><span data-stu-id="a14b5-483">**Identifier:** Item *A0001*</span></span>

1. <span data-ttu-id="a14b5-484">Veiksmų juostoje pasirinkite**Uždaryti talpyklą**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-484">On the Action Pane, select **Close container**.</span></span>
1. <span data-ttu-id="a14b5-485">**Talpyklos uždarymo** teksto laukelyje, pasirinkite **Gauti sistemos svorį**tam, kad sistema atnaujintų **Bendro svorio** laukelį.</span><span class="sxs-lookup"><span data-stu-id="a14b5-485">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="a14b5-486">Pasirinkite **Gerai**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-486">Select **OK**.</span></span> <span data-ttu-id="a14b5-487">Talpykla turi būti perkelta į *SORT* vietą ir parengta rūšiavimui.</span><span class="sxs-lookup"><span data-stu-id="a14b5-487">The container is moved to the *SORT* location and is ready for sorting.</span></span>
1. <span data-ttu-id="a14b5-488">Sukurkite antrą talpyklą tam, kad įtrauktumėte antrą elementą iš LP prekybos užsakymo 1 į naują talpyklą.</span><span class="sxs-lookup"><span data-stu-id="a14b5-488">Create a second container to add the second item from the LP for sales order 1 to a new container.</span></span>
1. <span data-ttu-id="a14b5-489">Veiksmų juostoje pasirinkite**Naujas talpykla**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-489">On the Action Pane, select **New container**.</span></span>
1. <span data-ttu-id="a14b5-490">Priimkite visus nustatytuosius nustatymus ir pasirinkite **OK**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-490">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="a14b5-491">Užsirašykite talpyklos identifikavimo kodą.</span><span class="sxs-lookup"><span data-stu-id="a14b5-491">Make a note of the container ID.</span></span>
1. <span data-ttu-id="a14b5-492">**Elemento pakavimo** „FastTab“, nustatykite šias vertes:</span><span class="sxs-lookup"><span data-stu-id="a14b5-492">On the **Item packing** FastTab, set the following values:</span></span>

    - <span data-ttu-id="a14b5-493">**Kiekis:** *1*</span><span class="sxs-lookup"><span data-stu-id="a14b5-493">**Quantity:** *1*</span></span>
    - <span data-ttu-id="a14b5-494">**Identifikavimo kodo:** Elementas *A0001*</span><span class="sxs-lookup"><span data-stu-id="a14b5-494">**Identifier:** Item *A0001*</span></span>

1. <span data-ttu-id="a14b5-495">Veiksmų juostoje pasirinkite**Uždaryti talpyklą**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-495">On the Action Pane, select **Close container**.</span></span>
1. <span data-ttu-id="a14b5-496">**Talpyklos uždarymo** teksto laukelyje, pasirinkite **Gauti sistemos svorį**tam, kad sistema atnaujintų **Bendro svorio** laukelį.</span><span class="sxs-lookup"><span data-stu-id="a14b5-496">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="a14b5-497">Pasirinkite **Gerai**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-497">Select **OK**.</span></span> <span data-ttu-id="a14b5-498">Talpykla turi būti perkelta į *SORT* vietą ir parengta rūšiavimui.</span><span class="sxs-lookup"><span data-stu-id="a14b5-498">The container is moved to the *SORT* location and is ready for sorting.</span></span>

#### <a name="pack-sales-order-2-into-containers"></a><span data-ttu-id="a14b5-499">Prekybos užsakymo 2 pakavimas į talpyklas</span><span class="sxs-lookup"><span data-stu-id="a14b5-499">Pack sales order 2 into containers</span></span>

1. <span data-ttu-id="a14b5-500">**Pakavimo** puslapyje, **Licencijos numeris ar siuntimas** laukelyje įveskite paskirties LP prekybos užsakymui 2.</span><span class="sxs-lookup"><span data-stu-id="a14b5-500">On the **Pack** page, in the **License plate or shipment** field, enter the target LP for line 1 of sales order 2.</span></span> <span data-ttu-id="a14b5-501">Tuomet pasirinkite **Skirtuką** ar **Įvesties** raktą savo klaviatūroje, kad išeitumėte iš laukelio.</span><span class="sxs-lookup"><span data-stu-id="a14b5-501">Then select the **Tab** or **Enter** key on your keyboard to move out of the field.</span></span>
1. <span data-ttu-id="a14b5-502">Veiksmų juostoje pasirinkite**Naujas talpykla**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-502">On the Action Pane, select **New container**.</span></span>
1. <span data-ttu-id="a14b5-503">Priimkite visus nustatytuosius nustatymus ir pasirinkite **OK**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-503">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="a14b5-504">Užsirašykite talpyklos identifikavimo kodą.</span><span class="sxs-lookup"><span data-stu-id="a14b5-504">Make a note of the container ID.</span></span>
1. <span data-ttu-id="a14b5-505">**Elemento pakavimo** „FastTab“, nustatykite šias vertes:</span><span class="sxs-lookup"><span data-stu-id="a14b5-505">On the **Item packing** FastTab, set the following values:</span></span>

    - <span data-ttu-id="a14b5-506">**Kiekis:** *1*</span><span class="sxs-lookup"><span data-stu-id="a14b5-506">**Quantity:** *1*</span></span>
    - <span data-ttu-id="a14b5-507">**Identifikavimo kodo:** Elementas *A0001*</span><span class="sxs-lookup"><span data-stu-id="a14b5-507">**Identifier:** Item *A0001*</span></span>

1. <span data-ttu-id="a14b5-508">Veiksmų juostoje pasirinkite**Uždaryti talpyklą**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-508">On the Action Pane, select **Close container**.</span></span>
1. <span data-ttu-id="a14b5-509">**Talpyklos uždarymo** teksto laukelyje, pasirinkite **Gauti sistemos svorį**tam, kad sistema atnaujintų **Bendro svorio** laukelį.</span><span class="sxs-lookup"><span data-stu-id="a14b5-509">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="a14b5-510">Pasirinkite **Gerai**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-510">Select **OK**.</span></span> <span data-ttu-id="a14b5-511">Talpykla turi būti perkelta į *SORT* vietą ir parengta rūšiavimui.</span><span class="sxs-lookup"><span data-stu-id="a14b5-511">The container is moved to the *SORT* location and is ready for sorting.</span></span>
1. <span data-ttu-id="a14b5-512">**Licencijos numeris ar siuntimas** laukelyje įveskite paskirties LP prekybos užsakymui 2.</span><span class="sxs-lookup"><span data-stu-id="a14b5-512">In the **License plate or shipment** field, enter the target LP for line 2 of the sales order 2.</span></span> <span data-ttu-id="a14b5-513">Tuomet pasirinkite **Skirtuką** ar **Įvesties** raktą savo klaviatūroje, kad išeitumėte iš laukelio.</span><span class="sxs-lookup"><span data-stu-id="a14b5-513">Then select the **Tab** or **Enter** key on your keyboard to move out of the field.</span></span>
1. <span data-ttu-id="a14b5-514">Veiksmų juostoje pasirinkite**Naujas talpykla**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-514">On the Action Pane, select **New container**.</span></span>
1. <span data-ttu-id="a14b5-515">Priimkite visus nustatytuosius nustatymus ir pasirinkite **OK**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-515">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="a14b5-516">Užsirašykite talpyklos identifikavimo kodą.</span><span class="sxs-lookup"><span data-stu-id="a14b5-516">Make a note of the container ID.</span></span>
1. <span data-ttu-id="a14b5-517">**Elemento pakavimo** „FastTab“, nustatykite šias vertes:</span><span class="sxs-lookup"><span data-stu-id="a14b5-517">On the **Item packing** FastTab, set the following values:</span></span>

    - <span data-ttu-id="a14b5-518">**Kiekis:** *1*</span><span class="sxs-lookup"><span data-stu-id="a14b5-518">**Quantity:** *1*</span></span>
    - <span data-ttu-id="a14b5-519">**Identifikavimo laukelis:** Elementas *A0002*</span><span class="sxs-lookup"><span data-stu-id="a14b5-519">**Identifier field:** Item *A0002*</span></span>

1. <span data-ttu-id="a14b5-520">Veiksmų juostoje pasirinkite**Uždaryti talpyklą**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-520">On the Action Pane, select **Close container**.</span></span>
1. <span data-ttu-id="a14b5-521">**Talpyklos uždarymo** teksto laukelyje, pasirinkite **Gauti sistemos svorį**tam, kad sistema atnaujintų **Bendro svorio** laukelį.</span><span class="sxs-lookup"><span data-stu-id="a14b5-521">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="a14b5-522">Pasirinkite **Gerai**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-522">Select **OK**.</span></span> <span data-ttu-id="a14b5-523">Talpykla turi būti perkelta į *SORT* vietą ir parengta rūšiavimui.</span><span class="sxs-lookup"><span data-stu-id="a14b5-523">The container is moved to the *SORT* location and is ready for sorting.</span></span>

<span data-ttu-id="a14b5-524">Talpyklos informacijso peržiūrai, eikite į **Sandėlio valdymas \> Pakavimas ir dėjimas į talpyklas \> Talpyklos** ir ieškokite talpyklos identifikavimo kodo, kuris buvo sukurtas pakavimo metu.</span><span class="sxs-lookup"><span data-stu-id="a14b5-524">To view the container details, go to **Warehouse management \> Packing and containerization \> Containers**, and search for the container IDs that were created during packing.</span></span>

### <a name="sort-the-containers"></a><span data-ttu-id="a14b5-525">Rūšiuokite talpyklas</span><span class="sxs-lookup"><span data-stu-id="a14b5-525">Sort the containers</span></span>

> [!IMPORTANT]
> <span data-ttu-id="a14b5-526">Patekę į **Padėklo kūrimo** meniu elementą mobiliame prietaise rūšiavimo siuntimui, matysite mygtuką pavadinimu **Pilnas**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-526">When you access the **Pallet build** menu item on the mobile app to do outbound sorting, you will see a button that is labeled **Full**.</span></span> <span data-ttu-id="a14b5-527">*Nenaudokite **Pilnas** mygtuko padėties rūšiavimui ir uždarymui.*</span><span class="sxs-lookup"><span data-stu-id="a14b5-527">*Don't use the **Full** button to sort or close the position.*</span></span>
>
> <span data-ttu-id="a14b5-528">**Pilnas** mygtukas yra pateikiamas pagal nutylėjimą ir negali būti išjungtas ar pašalinas iš puslapio.</span><span class="sxs-lookup"><span data-stu-id="a14b5-528">The **Full** button is provided by default and can't be disabled or removed from the page.</span></span> <span data-ttu-id="a14b5-529">Jis nėrra naudojamas *Siunčiamo rūšiavimo* funkcijai.</span><span class="sxs-lookup"><span data-stu-id="a14b5-529">It isn't used for the *Outbound sorting* feature.</span></span>

#### <a name="sort-the-first-container"></a><span data-ttu-id="a14b5-530">Rūšiuokite pirmą talpyklą</span><span class="sxs-lookup"><span data-stu-id="a14b5-530">Sort the first container</span></span>

1. <span data-ttu-id="a14b5-531">Mobiliame prietaise prisijunkite prie *62* sandėlio naudodami vartotojo identifikavimo kodą, kurį sukūrėte šiam scenarijui (arba esančių demo duomenų vartotojo identifikavimo kodą).</span><span class="sxs-lookup"><span data-stu-id="a14b5-531">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="a14b5-532">Pagrindiniame meniu pasirinkite **Siunčiama**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-532">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="a14b5-533">**Siunčiama** meniu pasirinkite **Padėklo sukūrimas**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-533">On the **Outbound** menu, select **Pallet build**.</span></span>
1. <span data-ttu-id="a14b5-534">**LP/Con** laukelyje įveskite pirmosios talpyklos identifikavimo kodą, kuris yra susietas su prekybos užsakymu 1.</span><span class="sxs-lookup"><span data-stu-id="a14b5-534">In the **LP/Con** field, enter the first container ID that is associated with sales order 1.</span></span>
1. <span data-ttu-id="a14b5-535">Pasirinkite **Gerai**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-535">Select **OK**.</span></span>
1. <span data-ttu-id="a14b5-536">Kadangi šiuo metu nėra jokių rūšiavimo padėčių, turite bent vieną nurodyti.</span><span class="sxs-lookup"><span data-stu-id="a14b5-536">Because no sort positions currently exist, you must specify one.</span></span> <span data-ttu-id="a14b5-537">**Rūšiavimo padėties identififikavimo kodo** laukelyje įveskite *SP01*.</span><span class="sxs-lookup"><span data-stu-id="a14b5-537">In the **Sort position ID** field, enter *SP01*.</span></span>
1. <span data-ttu-id="a14b5-538">Kadangi šiuo metu nėra susieto jokio LP su esama padėtimi *SP01*, turite bent vieną nurodyti.</span><span class="sxs-lookup"><span data-stu-id="a14b5-538">Because no LP is currently associated with sort position *SP01*, you must specify one.</span></span> <span data-ttu-id="a14b5-539">**LP** laukelyje įveskite *PLP01*.</span><span class="sxs-lookup"><span data-stu-id="a14b5-539">In the **LP** field, enter *PLP01*.</span></span>
1. <span data-ttu-id="a14b5-540">Pasirinkite **Gerai**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-540">Select **OK**.</span></span>
1. <span data-ttu-id="a14b5-541">Kadangi rūšiavimo padėties patvirtinimas yra įjungtas, privalo įvesti rūšiavimo padėties identifikavimo kodą dar kartą.</span><span class="sxs-lookup"><span data-stu-id="a14b5-541">Because sort position validation is turned on, you must enter the sort position ID again.</span></span> <span data-ttu-id="a14b5-542">**Rūšiavimo padėties identififikavimo kodo** laukelyje įveskite *SP01*.</span><span class="sxs-lookup"><span data-stu-id="a14b5-542">In the **Sort Position ID** field, enter *SP01*.</span></span>
1. <span data-ttu-id="a14b5-543">Pasirinkite **Gerai**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-543">Select **OK**.</span></span>

    <span data-ttu-id="a14b5-544">Matysite „Darbas baigtas“ pranešimą.</span><span class="sxs-lookup"><span data-stu-id="a14b5-544">You receive a "Work completed" message.</span></span>

> [!TIP]
> <span data-ttu-id="a14b5-545">Rūšiuotos padėties peržiūrai ir LP joje peržiūrai, eikite į**Sandėlio valdymas \> Pakavimas ir dėjimas į konteinerius \> Siunčiamo rūšiavimo padėties priskyrimai**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-545">To view the sort position and the LP in it, go to **Warehouse management \> Packing and containerization \> Outbound sorting position assignments**.</span></span>
>
> <span data-ttu-id="a14b5-546">**Siunčiamo rūšiavimo padėties priskyrimai** langas rodo visas rūšiavimo padėtis, kurios šiuo metu yra įjungtos.</span><span class="sxs-lookup"><span data-stu-id="a14b5-546">The **Outbound sorting position assignments** page shows all the sort positions that are currently active.</span></span> <span data-ttu-id="a14b5-547">**Rūšiavimo padėties pervedimai** laukelis rodo LP, kuris yra susietas su kiekviena rūšiavimo padėtimi ir rūšiavimo padėtyje nesančiomis talpyklomis.</span><span class="sxs-lookup"><span data-stu-id="a14b5-547">The **Sort position transactions** field shows the LP that is associated with each sort position, and the containers that are in the sort position.</span></span> <span data-ttu-id="a14b5-548">Atkreipkite dėmesį, kad viena rūšiavimo padėtis šiuo metu egzistuoja ir **Padėties rūšiavimo kriterijų** „FastTab“ rodo **Siuntimo – Vežėjo paslaugų - Oro** kriterijų.</span><span class="sxs-lookup"><span data-stu-id="a14b5-548">Notice that one sort position currently exists, and that the **Sort position criteria** FastTab shows a criterion of **Shipment – Carrier service - Air**.</span></span>

#### <a name="sort-the-remaining-containers"></a><span data-ttu-id="a14b5-549">Rūšiuokite likusias talpyklas</span><span class="sxs-lookup"><span data-stu-id="a14b5-549">Sort the remaining containers</span></span>

1. <span data-ttu-id="a14b5-550">Mobiliame prietaise prisijunkite prie *62* sandėlio naudodami vartotojo identifikavimo kodą, kurį sukūrėte šiam scenarijui (arba esančių demo duomenų vartotojo identifikavimo kodą).</span><span class="sxs-lookup"><span data-stu-id="a14b5-550">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="a14b5-551">Pagrindiniame meniu pasirinkite **Siunčiama**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-551">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="a14b5-552">**Siunčiama** meniu pasirinkite **Padėklo sukūrimas**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-552">On the **Outbound** menu, select **Pallet build**.</span></span>
1. <span data-ttu-id="a14b5-553">**LP/Con** laukelyje įveskite antrosios talpyklos identifikavimo kodą, kuris yra susietas su prekybos užsakymu 1.</span><span class="sxs-lookup"><span data-stu-id="a14b5-553">In the **LP/Con** field, enter the second container ID that is associated with sales order 1.</span></span>
1. <span data-ttu-id="a14b5-554">Pasirinkite **Gerai**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-554">Select **OK**.</span></span> <span data-ttu-id="a14b5-555">Kadangi rūšiavimo šablonas yra nustatytas automatiniam rūšiavimui ir kriterijus atitinkantis padėties rūšiavimas jau egzistuoja, esate automatiškai nukreipiami į tinkamą rūšiavimo padėtį.</span><span class="sxs-lookup"><span data-stu-id="a14b5-555">Because the sorting template is set up to sort automatically, and a sort position that has matching criteria already exists, you're automatically directed to the correct sort position.</span></span>
1. <span data-ttu-id="a14b5-556">Pasirinkite **Gerai**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-556">Select **OK**.</span></span>
1. <span data-ttu-id="a14b5-557">Patvirtinkite rūšiavimo padėties identifikavimo kodą tam, kad nurodytumėte, jog inventorius yra tinkamoje vietoje.</span><span class="sxs-lookup"><span data-stu-id="a14b5-557">Confirm the sort position ID to indicate that the inventory is in the correct place.</span></span> <span data-ttu-id="a14b5-558">**Rūšiavimo padėties identififikavimo kodo** laukelyje įveskite *SP01*.</span><span class="sxs-lookup"><span data-stu-id="a14b5-558">In the **Sort Position ID** field, enter *SP01*.</span></span>
1. <span data-ttu-id="a14b5-559">Pasirinkite **Gerai**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-559">Select **OK**.</span></span>

    <span data-ttu-id="a14b5-560">Darbas yra baigtas antrojoje talpykloje iš prekybos užsakymo 1.</span><span class="sxs-lookup"><span data-stu-id="a14b5-560">Work is completed on the second container from sales order 1.</span></span> <span data-ttu-id="a14b5-561">Dabar rūšiuosite likusias talpyklas iš prekybos užsakymo 2.</span><span class="sxs-lookup"><span data-stu-id="a14b5-561">You will now sort the remaining containers from sales order 2.</span></span>

1. <span data-ttu-id="a14b5-562">**LP/Con** laukelyje įveskite antrosios talpyklos identifikavimo kodą, kuris yra susietas su prekybos užsakymu 2 *A0001*.</span><span class="sxs-lookup"><span data-stu-id="a14b5-562">In the **LP/Con** field, enter the container ID of the container from sales order 2 that holds item *A0001*.</span></span> <span data-ttu-id="a14b5-563">Kadangi vežėjo paslaugos skiriasi, jums siūloma įvesti naują rūšiavimo padėtį ir priskirti LP tai padėčiai.</span><span class="sxs-lookup"><span data-stu-id="a14b5-563">Because the carrier service differs, you're prompted to enter a new sort position and assign an LP to that position.</span></span> <span data-ttu-id="a14b5-564">Naudokite padėties rūšiavimą *SP02* ir LP *PLP02*.</span><span class="sxs-lookup"><span data-stu-id="a14b5-564">Use sort position *SP02* and LP *PLP02*.</span></span>
1. <span data-ttu-id="a14b5-565">Pasirinkite **Gerai**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-565">Select **OK**.</span></span>
1. <span data-ttu-id="a14b5-566">Patikrinkite rūšiavimo padėtį įvesdami *SP02* **Padėties rūšiavimo identifikavimo kodo** laukelyje.</span><span class="sxs-lookup"><span data-stu-id="a14b5-566">Confirm the sort position by entering *SP02* in the **Sort Position ID** field.</span></span>
1. <span data-ttu-id="a14b5-567">Pasirinkite **Gerai**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-567">Select **OK**.</span></span>

    <span data-ttu-id="a14b5-568">Darbas talpykloje baigtas.</span><span class="sxs-lookup"><span data-stu-id="a14b5-568">Work is completed on the container.</span></span>

1. <span data-ttu-id="a14b5-569">**LP/Con** laukelyje įveskite likusios talpyklos identifikavimo kodą, kuris yra susietas su prekybos užsakymu 2 *A0002*.</span><span class="sxs-lookup"><span data-stu-id="a14b5-569">In the **LP/Con** field, enter the container ID for the remaining container from sales order 2 that holds item *A0002*.</span></span> <span data-ttu-id="a14b5-570">Kadangi vežėjo paslaugos sutampa su prekybos užsakymo 1 vežėjo paslaugomis, sistema rodo esančią rūšiavimo padėtį, kuri atitinka kriterijus.</span><span class="sxs-lookup"><span data-stu-id="a14b5-570">Because the carrier service is the same as the carrier service for sales order 1, the system shows the existing sort position that has matching criteria.</span></span>
1. <span data-ttu-id="a14b5-571">Pasirinkite **Gerai**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-571">Select **OK**.</span></span>
1. <span data-ttu-id="a14b5-572">Patikrinkite rūšiavimo padėtį įvesdami *SP02* **Padėties rūšiavimo identifikavimo kodo** laukelyje.</span><span class="sxs-lookup"><span data-stu-id="a14b5-572">Confirm the sort position by entering *SP01* in the **Sort Position ID** field.</span></span>
1. <span data-ttu-id="a14b5-573">Pasirinkite **Gerai**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-573">Select **OK**.</span></span>

    <span data-ttu-id="a14b5-574">Darbas talpykloje baigtas.</span><span class="sxs-lookup"><span data-stu-id="a14b5-574">Work is completed on the container.</span></span>

### <a name="close-the-outbound-sorting-positions"></a><span data-ttu-id="a14b5-575">Uždarykite siunčiamo rūšiavimo padėtis</span><span class="sxs-lookup"><span data-stu-id="a14b5-575">Close the outbound sorting positions</span></span>

<span data-ttu-id="a14b5-576">Kai inventorius yra rūšiuotas, padėtis turi būti uždaryti prieš darbo sukūrimą.</span><span class="sxs-lookup"><span data-stu-id="a14b5-576">When all inventory has been sorted, the position must be closed before work can be created.</span></span> <span data-ttu-id="a14b5-577">Rūšiuoto inventoriaus paėmimo darbas bus sukuriamas tam, kad inventorius būtų paimtas į „bay door“.</span><span class="sxs-lookup"><span data-stu-id="a14b5-577">Sorted inventory picking work will be created to take the inventory to the bay door.</span></span>

#### <a name="close-a-position-from-the-mobile-device"></a><span data-ttu-id="a14b5-578">Uždarykite padėtį mobiliame prietaise</span><span class="sxs-lookup"><span data-stu-id="a14b5-578">Close a position from the mobile device</span></span>

1. <span data-ttu-id="a14b5-579">Mobiliame prietaise prisijunkite prie *62* sandėlio naudodami vartotojo identifikavimo kodą, kurį sukūrėte šiam scenarijui (arba esančių demo duomenų vartotojo identifikavimo kodą).</span><span class="sxs-lookup"><span data-stu-id="a14b5-579">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="a14b5-580">Pagrindiniame meniu pasirinkite **Siunčiama**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-580">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="a14b5-581">**Siunčiama** meniu pasirinkite **Padėklo sukūrimas**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-581">On the **Outbound** menu, select **Pallet build**.</span></span>
1. <span data-ttu-id="a14b5-582">**LP/Con** laukelyje įveskite talpyklos identifikavimo numerį, kuris buvo rūšiuotas padėties *SP01* rūšiavimui.</span><span class="sxs-lookup"><span data-stu-id="a14b5-582">In the **LP/Con** field, enter a container ID that was sorted to sort position *SP01*.</span></span>
1. <span data-ttu-id="a14b5-583">Pasirinkite **Gerai**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-583">Select **OK**.</span></span>
1. <span data-ttu-id="a14b5-584">Matysite šį pranešimą: „Talpykla jau rūšiuota padėčiai SP01.</span><span class="sxs-lookup"><span data-stu-id="a14b5-584">You receive the following message: "The container is already sorted to position SP01.</span></span> <span data-ttu-id="a14b5-585">Uždaryti padėtį?“</span><span class="sxs-lookup"><span data-stu-id="a14b5-585">Close the position?"</span></span> <span data-ttu-id="a14b5-586">Pasirinkite **Uždaryti**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-586">Select **Close**.</span></span>

    <span data-ttu-id="a14b5-587">Darbas užbaigtas.</span><span class="sxs-lookup"><span data-stu-id="a14b5-587">Work is completed.</span></span>

#### <a name="close-a-position-from-outbound-sorting-position-assignments"></a><span data-ttu-id="a14b5-588">Uždaryti padėtį iš siunčiamo rūšiavimo padėties priskyrimo</span><span class="sxs-lookup"><span data-stu-id="a14b5-588">Close a position from outbound sorting position assignments</span></span>

1. <span data-ttu-id="a14b5-589">Eikite į **Sandėlio valdymas \> Pakavimas ir dėjimas į konteinerius \> Siunčiamo rūšiavimo padėties priskyrimai**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-589">Go to **Warehouse management \> Packing and containerization \> Outbound sorting position assignments**.</span></span>
1. <span data-ttu-id="a14b5-590">Kairiame stulpelyje pasirinkite **SP02**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-590">In the left column, select **SP02**.</span></span> <span data-ttu-id="a14b5-591">Ši siunčiamo rūšiavimo padėties eilutė yra ta, kurią uždarėte.</span><span class="sxs-lookup"><span data-stu-id="a14b5-591">This outbound sorting position row is the one that you will close.</span></span>
1. <span data-ttu-id="a14b5-592">Veiksmų juostoje pasirinkite**Uždaryti padėtį**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-592">On the Action Pane, select **Close position**.</span></span> <span data-ttu-id="a14b5-593">Rūšiavimo padėties įrašas yra uždarytas ir neberodomas.</span><span class="sxs-lookup"><span data-stu-id="a14b5-593">The sorting position record is closed and is no longer shown.</span></span>

    > [!TIP]
    > <span data-ttu-id="a14b5-594">Visų uždarytų padėčių įrašų rodymui, pasirinkite **Rodyti uždarytus** žymimą laukelį.</span><span class="sxs-lookup"><span data-stu-id="a14b5-594">To show all closed position records, select the **Show closed** check box.</span></span>

### <a name="sorted-inventory-picking"></a><span data-ttu-id="a14b5-595">Surūšiuotų atsargų paėmimas</span><span class="sxs-lookup"><span data-stu-id="a14b5-595">Sorted inventory picking</span></span>

<span data-ttu-id="a14b5-596">Privalote pabaigti rūšiuoto inventoriaus paėmimo darbą.</span><span class="sxs-lookup"><span data-stu-id="a14b5-596">You must complete the sorted inventory picking work.</span></span> <span data-ttu-id="a14b5-597">Kai jis pabaigtas, inventorius bus paimamas į prekybos užsakymą.</span><span class="sxs-lookup"><span data-stu-id="a14b5-597">When it's completed, the inventory will be picked to the sales order.</span></span> <span data-ttu-id="a14b5-598">Dabar, visi kiti sandėlio procesai yra pritaikyti.</span><span class="sxs-lookup"><span data-stu-id="a14b5-598">At that point, all other warehouse processes apply.</span></span>

1. <span data-ttu-id="a14b5-599">Mobiliame prietaise prisijunkite prie *62* sandėlio naudodami vartotojo identifikavimo kodą, kurį sukūrėte šiam scenarijui (arba esančių demo duomenų vartotojo identifikavimo kodą).</span><span class="sxs-lookup"><span data-stu-id="a14b5-599">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="a14b5-600">Pagrindiniame meniu pasirinkite **Siunčiama**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-600">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="a14b5-601">**Siunčiama** meniu pasirinkite **Pakrovimas iš rūšiavimo**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-601">On the **Outbound** menu, select **Load from Sorting**.</span></span>
1. <span data-ttu-id="a14b5-602">Įveskite paskirties LP identifikavimo kodą iš pirmosios rūšiavimo padėties, *SP01*.</span><span class="sxs-lookup"><span data-stu-id="a14b5-602">Enter the target LP ID from the first sort position, *SP01*.</span></span> <span data-ttu-id="a14b5-603">Nustatykite **identifikavimo kodo** lauką į *PLP01*.</span><span class="sxs-lookup"><span data-stu-id="a14b5-603">Set the **ID** field to *PLP01*.</span></span>
1. <span data-ttu-id="a14b5-604">Pasirinkite **Gerai**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-604">Select **OK**.</span></span>
1. <span data-ttu-id="a14b5-605">**Rūšiuoto inventoriaus paėmimas: Paimti** puslapis rodo būtiną atlikti paėmimo darbą.</span><span class="sxs-lookup"><span data-stu-id="a14b5-605">The **Sorted inventory picking: Pick** page shows the pick work that must be done.</span></span> <span data-ttu-id="a14b5-606">Paimkite iš *SORT* vietos ir paskirties LP *PLP01* turės daugelį elementų ir *3* kiekį.</span><span class="sxs-lookup"><span data-stu-id="a14b5-606">Pick from the *SORT* location and target LP *PLP01*, which has multiple items and a quantity of *3*.</span></span>
1. <span data-ttu-id="a14b5-607">Pasirinkite **Gerai**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-607">Select **OK**.</span></span>
1. <span data-ttu-id="a14b5-608">**Rūšiuoto inventoriaus paėmimas: Padėti** puslapis rodo būtiną atlikti padėjimo darbą.</span><span class="sxs-lookup"><span data-stu-id="a14b5-608">The **Sorted inventory picking: Put** page shows the put work that must be done.</span></span> <span data-ttu-id="a14b5-609">Padėkite į *Baydoor* vietą ir paskirties LP *PLP01* turės daugelį elementų ir *3* kiekį.</span><span class="sxs-lookup"><span data-stu-id="a14b5-609">Put to the *Baydoor* location and target LP *PLP01*, which has multiple items and a quantity of *3*.</span></span>
1. <span data-ttu-id="a14b5-610">Pasirinkite **Gerai**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-610">Select **OK**.</span></span>

    <span data-ttu-id="a14b5-611">Darbas užbaigtas.</span><span class="sxs-lookup"><span data-stu-id="a14b5-611">Work is completed.</span></span>

1. <span data-ttu-id="a14b5-612">Įveskite paskirties licencijos numerio identifikavimo kodą iš antrosios rūšiavimo padėties, *SP02*.</span><span class="sxs-lookup"><span data-stu-id="a14b5-612">Enter the target license plate ID from the second sort position, *SP02*.</span></span> <span data-ttu-id="a14b5-613">Nustatykite **identifikavimo kodo** lauką į *PLP02*.</span><span class="sxs-lookup"><span data-stu-id="a14b5-613">Set the **ID** field to *PLP02*.</span></span>
1. <span data-ttu-id="a14b5-614">Pasirinkite **Gerai**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-614">Select **OK**.</span></span>
1. <span data-ttu-id="a14b5-615">**Rūšiuoto inventoriaus paėmimas: Paimti** puslapis rodo būtiną atlikti paėmimo darbą.</span><span class="sxs-lookup"><span data-stu-id="a14b5-615">The **Sorted inventory picking: Pick** page shows the pick work that must be done.</span></span> <span data-ttu-id="a14b5-616">Paimkite iš *SORT* vietos ir paskirties LP *PLP02* turės daugelį elementų ir *1* kiekį.</span><span class="sxs-lookup"><span data-stu-id="a14b5-616">Pick from the *SORT* location and target LP *PLP02*, which has multiple items and a quantity of *1*.</span></span>
1. <span data-ttu-id="a14b5-617">Pasirinkite **Gerai**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-617">Select **OK**.</span></span>
1. <span data-ttu-id="a14b5-618">**Rūšiuoto inventoriaus paėmimas: Padėti** puslapis rodo būtiną atlikti padėjimo darbą.</span><span class="sxs-lookup"><span data-stu-id="a14b5-618">The **Sorted inventory picking: Put** page shows the put work that must be done.</span></span> <span data-ttu-id="a14b5-619">Padėkite į *Baydoor* vietą ir paskirties LP *PLP02* turės daugelį elementų ir *1* kiekį.</span><span class="sxs-lookup"><span data-stu-id="a14b5-619">Put to the *Baydoor* location and target LP *PLP02*, which has multiple items and a quantity of *1*.</span></span>
1. <span data-ttu-id="a14b5-620">Pasirinkite **Gerai**.</span><span class="sxs-lookup"><span data-stu-id="a14b5-620">Select **OK**.</span></span>

    <span data-ttu-id="a14b5-621">Darbas užbaigtas.</span><span class="sxs-lookup"><span data-stu-id="a14b5-621">Work is completed.</span></span>

<span data-ttu-id="a14b5-622">Nuo dabar, visi kiti sandėlio procesai yra pritaikyti.</span><span class="sxs-lookup"><span data-stu-id="a14b5-622">From this point forward, all other warehouse processes apply.</span></span>
