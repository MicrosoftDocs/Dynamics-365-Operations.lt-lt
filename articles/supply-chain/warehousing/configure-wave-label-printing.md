...
1. <span data-ttu-id="a62d9-166">Įtraukite eilutę, kuri turi šiuos nustatymus:</span><span class="sxs-lookup"><span data-stu-id="a62d9-166">Add a row that has the following settings:</span></span>
    ...
    - <span data-ttu-id="a62d9-171">**Eilutės aukštis:** *0*</span><span class="sxs-lookup"><span data-stu-id="a62d9-171">**Row height:** *0*</span></span>
...
1. <span data-ttu-id="a62d9-207">Eikite į **Sandėlio tvarkymas \> Sąranka \> Sandėlis \> Padalinio sekos grupės**.</span><span class="sxs-lookup"><span data-stu-id="a62d9-207">Go to **Warehouse management \> Setup \> Warehouse \> Unit sequence groups**.</span></span>
...
1. <span data-ttu-id="a62d9-224">Pasirenkamas: Jei nustatote klientui konkretų žymos maketą, privalote sukurti užklausą tam, kad rastumėte kliento paskyrą.</span><span class="sxs-lookup"><span data-stu-id="a62d9-224">Optional: If you're setting up a customer-specific label design, you must create a query to find the customer's account.</span></span> <span data-ttu-id="a62d9-225">**bangos žymos šablono informacijoje** „FastTab“, pasirinkite **Redaguoti užklausą**.</span><span class="sxs-lookup"><span data-stu-id="a62d9-225">On the **Wave label template details** FastTab, select **Edit query**.</span></span> <span data-ttu-id="a62d9-226">Tuomet, užklausos tvarkyklės teksto laukelyje, **Intervalas** skirtuke įtraukite eilutę su šiais nustatymais:</span><span class="sxs-lookup"><span data-stu-id="a62d9-226">Then, in the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>
    ...
    - <span data-ttu-id="a62d9-227">**Lentelė:** *Siuntos*</span><span class="sxs-lookup"><span data-stu-id="a62d9-227">**Table:** *Shipments*</span></span>
...
### <a name="configure-number-sequence-extensions"></a><span data-ttu-id="a62d9-245">Konfigūruokite numerio sekos plėtinius</span><span class="sxs-lookup"><span data-stu-id="a62d9-245">Configure number sequence extensions</span></span>
...
1. <span data-ttu-id="a62d9-320">Įtraukite eilutę, kuri turi šiuos nustatymus:</span><span class="sxs-lookup"><span data-stu-id="a62d9-320">Add a row that has the following settings:</span></span>
    ...
    - <span data-ttu-id="a62d9-328">**Eilutės puslapyje:** *5*</span><span class="sxs-lookup"><span data-stu-id="a62d9-328">**Rows per page:** *5*</span></span>
...
1. <span data-ttu-id="a62d9-354">Eikite į **Sandėlio tvarkymas \> Sąranka \> Dokumento maršrutas \> Bangos žymos šablonai**.</span><span class="sxs-lookup"><span data-stu-id="a62d9-354">Go to **Warehouse management \> Setup \> Document routing \> Wave label templates**.</span></span>
...
### <a name="configure-number-sequence-extensions"></a><span data-ttu-id="a62d9-373">Konfigūruokite numerio sekos plėtinius</span><span class="sxs-lookup"><span data-stu-id="a62d9-373">Configure number sequence extensions</span></span>
...
1. <span data-ttu-id="a62d9-382">Įtraukite penkias prekybos užsakymo eilutes:</span><span class="sxs-lookup"><span data-stu-id="a62d9-382">Add five sales order lines:</span></span>
    ...
    - <span data-ttu-id="a62d9-389">Prekybos užsakymo linija 3:</span><span class="sxs-lookup"><span data-stu-id="a62d9-389">Sales order line 3:</span></span>
        ...
        - <span data-ttu-id="a62d9-390">**Prekės numeris:** *L0006*</span><span class="sxs-lookup"><span data-stu-id="a62d9-390">**Item number:** *L0006*</span></span>
...
<span data-ttu-id="a62d9-410">Galite atspausdinti iš naujo šias bangos žymes eidami į **Sandėlio valdymas \> Užklausos ir atsakymai \> Bangos žymos istorija**.</span><span class="sxs-lookup"><span data-stu-id="a62d9-410">You can reprint these wave labels by going to **Warehouse management \> Inquiries and reports \> Wave label history**.</span></span>
...
<span data-ttu-id="a62d9-415">Pagrindinis skirtumas tarp šio scenarijaus konfigūravimo ir scenarijus 1 konfigūravimo, kartu su tuo, kad tarpo žymės yra įjungtos, yra tas, kad daugelis bangos žymių tipų turi būti susieti su bangos žymos šablonais ir padalinio sekos grupės linijomis.</span><span class="sxs-lookup"><span data-stu-id="a62d9-415">The main difference between the configuration of this scenario and the configuration of scenario 1, besides the fact that break labels are enabled, is that multiple wave label types must be associated with wave label templates and unit sequence group lines.</span></span> <span data-ttu-id="a62d9-416">Konfigūravimo užbaigimui, nustatykite toliau apteiktus elementus šiame scenarijui:</span><span class="sxs-lookup"><span data-stu-id="a62d9-416">To accomplish this configuration, you set up the following elements for this scenario:</span></span>

- <span data-ttu-id="a62d9-417">**Bangos apdorojimo metodai:** Pažymėsite bangos žymos metodą kaip „pasikartojantį“, įtrauksite jį du (ar daugiau) laikų bangos šablone ir nustatysite skirtingus bangos žingsnio kodus.</span><span class="sxs-lookup"><span data-stu-id="a62d9-417">**Wave processing methods:** You will mark the wave label method as "repeatable," add it two (or more) times to the wave template, and set different wave step codes.</span></span>
- <span data-ttu-id="a62d9-418">**Bangos žymos šablonai:** Sukonfigūruosite bangos žymos šablonus ir susiesite juos su bangos šablonu.</span><span class="sxs-lookup"><span data-stu-id="a62d9-418">**Wave label templates:** You will configure the wave label templates and link them to the wave template.</span></span> <span data-ttu-id="a62d9-419">Kiekvienas bangos žymos šablonas turi savo bangos žymos tipą.</span><span class="sxs-lookup"><span data-stu-id="a62d9-419">Each wave label template has its own wave label type.</span></span>
- <span data-ttu-id="a62d9-420">**Bangos žymos maketai:** Sukursite keletą bangos žymos maketų.</span><span class="sxs-lookup"><span data-stu-id="a62d9-420">**Wave label layouts:** You will create multiple wave label layouts.</span></span> <span data-ttu-id="a62d9-421">Bus atskiras žymos maketas kiekvienai žymos kainai ir taip pat bus atstumo žymos maketas.</span><span class="sxs-lookup"><span data-stu-id="a62d9-421">There will be a separate label layout for each "tier" of labels, and there will also be a break label layout.</span></span>

<span data-ttu-id="a62d9-422">Šis scenarijus parodo srautą nuo pradžios iki galo.</span><span class="sxs-lookup"><span data-stu-id="a62d9-422">This scenario shows the end-to-end flow.</span></span>

### <a name="make-demo-data-available"></a><span data-ttu-id="a62d9-423">Demonstracinių duomenų įgalinimas</span><span class="sxs-lookup"><span data-stu-id="a62d9-423">Make demo data available</span></span>

<span data-ttu-id="a62d9-424">Šio scenarijaus įgyvendinimui, privalote turėti įdiegtus demo duomenis ir pasirinkti **USMF** juridinį asmenį.</span><span class="sxs-lookup"><span data-stu-id="a62d9-424">To follow this scenario, you must have demo data installed, and you must select the **USMF** legal entity.</span></span>

### <a name="set-up-a-wave-process-method"></a><span data-ttu-id="a62d9-425">Nustatykite bangos proceso metodą</span><span class="sxs-lookup"><span data-stu-id="a62d9-425">Set up a wave process method</span></span>

1. <span data-ttu-id="a62d9-426">Eikite į **Sandėlio tvarkymas \> Sąranka \> Bangos \> Bangos apdorojimo metodai**.</span><span class="sxs-lookup"><span data-stu-id="a62d9-426">Go to **Warehouse management \> Setup \> Waves \> Wave process methods**.</span></span>
1. <span data-ttu-id="a62d9-427">Patvirtinkite, kad **bangos žymos spausdinimas** yra sąraše.</span><span class="sxs-lookup"><span data-stu-id="a62d9-427">Confirm that **waveLabelPrinting** is in the list.</span></span> <span data-ttu-id="a62d9-428">Jei jo nėra, pasirinkite **Iš naujo kurti metodu** veiksmų juostoje ir juos įtraukite.</span><span class="sxs-lookup"><span data-stu-id="a62d9-428">If it isn't, select **Regenerate methods** on the Action Pane to add it.</span></span>
1. <span data-ttu-id="a62d9-429">**Bangos žymos spausdinimo** metodui pasirinkite **Padaryti metodą pasikartojantį** žymimą laukelį.</span><span class="sxs-lookup"><span data-stu-id="a62d9-429">For the **waveLabelPrinting** method, select the **Make method repeatable** check box.</span></span>

### <a name="set-up-a-wave-template"></a><span data-ttu-id="a62d9-430">Bangos šablono nustatymas</span><span class="sxs-lookup"><span data-stu-id="a62d9-430">Set up a wave template</span></span>

1. <span data-ttu-id="a62d9-431">Eikite į **Sandėlio valdymas \> Nustatymas \> Bangos \> Bangų šablonai**.</span><span class="sxs-lookup"><span data-stu-id="a62d9-431">Go to **Warehouse management \> Setup \> Waves \> Wave templates**.</span></span>
2. <span data-ttu-id="a62d9-432">Pasirinkite šabloną, tokį kaip **62 siuntimo nustatytąjį**.</span><span class="sxs-lookup"><span data-stu-id="a62d9-432">Select a template, such as **62 Shipping Default**.</span></span>
3. <span data-ttu-id="a62d9-433">„FastTab“ **Metodai** patraukite **Bangos žymos spausdinimo** metodą į **Pasirinkti metodai** stulpelį.</span><span class="sxs-lookup"><span data-stu-id="a62d9-433">On the **Methods** FastTab, move the **Wave label printing** method to the **Selected methods** column.</span></span>
4. <span data-ttu-id="a62d9-434">**Pasirinkti metodai** stulpelyje priskirkite **Bangos žingsnio kodo** vertę, tokią kaip *Dėžė* prie **Bangos žymos spausdinimo** metodo.</span><span class="sxs-lookup"><span data-stu-id="a62d9-434">In the **Selected methods** column, assign a **Wave step code** value, such as *Carton*, to the **Wave label printing** method.</span></span> <span data-ttu-id="a62d9-435">Dėl išsamesnės informacijos apie bangos žingsnio kodus, žr. [Bangos žingsnio kodai](wave-step-codes.md).</span><span class="sxs-lookup"><span data-stu-id="a62d9-435">For more information about wave step codes, see [Wave step codes](wave-step-codes.md).</span></span>
5. <span data-ttu-id="a62d9-436">Patraukite **Bangos žymos spausdinimo** metodą į **Pasirinkti metodai** stulpelį antrą kartą.</span><span class="sxs-lookup"><span data-stu-id="a62d9-436">Move the **Wave label printing** method to the **Selected methods** column a second time.</span></span>
6. <span data-ttu-id="a62d9-437">**Pasirinkti metodai** stulpelyje priskirkite kitą **Bangos žingsnio kodo** vertę, tokią kaip *Padėklas* prie antrojo **Bangos žymos spausdinimo** metodo.</span><span class="sxs-lookup"><span data-stu-id="a62d9-437">In the **Selected methods** column, assign a different **Wave step code** value, such as *Pallet*, to the second **Wave label printing** method.</span></span> <span data-ttu-id="a62d9-438">Dėl išsamesnės informacijos apie bangos žingsnio kodus, žr. [Bangos žingsnio kodai](wave-step-codes.md).</span><span class="sxs-lookup"><span data-stu-id="a62d9-438">For more information about wave step codes, see [Wave step codes](wave-step-codes.md).</span></span>

### <a name="create-three-wave-label-layouts"></a><span data-ttu-id="a62d9-439">Sukurkite tris bangos žymių maketus</span><span class="sxs-lookup"><span data-stu-id="a62d9-439">Create three wave label layouts</span></span>

1. <span data-ttu-id="a62d9-440">Eikite į **Sandėlio tvarkymas \> Sąranka \> Dokumento maršrutas \> bangos žymos maketai**.</span><span class="sxs-lookup"><span data-stu-id="a62d9-440">Go to **Warehouse management \> Setup \> Document routing \> Wave label layouts**.</span></span>
1. <span data-ttu-id="a62d9-441">Sukurkite įrašą, kuris turi šiuos nustatymus:</span><span class="sxs-lookup"><span data-stu-id="a62d9-441">Create a record that has the following settings:</span></span>

    - <span data-ttu-id="a62d9-442">**Žymos maketo identifikavimo numeris:** *Dėžė*</span><span class="sxs-lookup"><span data-stu-id="a62d9-442">**Label layout ID:** *Carton*</span></span>
    - <span data-ttu-id="a62d9-443">**Aprašas:** *Dėžė (SSCC)*</span><span class="sxs-lookup"><span data-stu-id="a62d9-443">**Description:** *Carton (SSCC)*</span></span>

1. <span data-ttu-id="a62d9-444">Veiksmų srityje pasirinkite **Įrašyti**.</span><span class="sxs-lookup"><span data-stu-id="a62d9-444">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="a62d9-445">Veiksmų juostoje pasirinkite **bangos žymos eilutės nustatymai**.</span><span class="sxs-lookup"><span data-stu-id="a62d9-445">On the Action Pane, select **Wave label row settings**.</span></span>

    <span data-ttu-id="a62d9-446">Pasirodo **Bangos žymos eilutės nustatymai** langas.</span><span class="sxs-lookup"><span data-stu-id="a62d9-446">The **Wave label row settings** page appears.</span></span> <span data-ttu-id="a62d9-447">Čia galite sukonfigūruoti dinaminę žymos dalį.</span><span class="sxs-lookup"><span data-stu-id="a62d9-447">Here, you can configure the dynamic part of the label.</span></span>

1. <span data-ttu-id="a62d9-448">Įtraukite eilutę, kuri turi šiuos nustatymus:</span><span class="sxs-lookup"><span data-stu-id="a62d9-448">Add a row that has the following settings:</span></span>

    - <span data-ttu-id="a62d9-449">**Eilutės Identifikavimo kodas:** *Bangos žymė*</span><span class="sxs-lookup"><span data-stu-id="a62d9-449">**Row Id:** *WaveLabel*</span></span>
    - <span data-ttu-id="a62d9-450">**Eilutės lentelės pavadinimas:** *WHSWaveLabel*</span><span class="sxs-lookup"><span data-stu-id="a62d9-450">**Row table name:** *WHSWaveLabel*</span></span>
    - <span data-ttu-id="a62d9-451">**Eilutės pradžios padėtis:** *0*</span><span class="sxs-lookup"><span data-stu-id="a62d9-451">**Row start position:** *0*</span></span>

        <span data-ttu-id="a62d9-452">Šis laukelis apibrėžia vertikalią padėtį, kurioje eilutė prasideda žymėje.</span><span class="sxs-lookup"><span data-stu-id="a62d9-452">This field defines the vertical position where the row will begin on the label.</span></span>

    - <span data-ttu-id="a62d9-453">**Eilutės aukštis:** *0*</span><span class="sxs-lookup"><span data-stu-id="a62d9-453">**Row height:** *0*</span></span>

        <span data-ttu-id="a62d9-454">Laukelis apibrėžia kiekvienos eilutės aukštį (taškais) pagal ZPL standartą.</span><span class="sxs-lookup"><span data-stu-id="a62d9-454">This field defines the height of each row (in points), according to the ZPL standard.</span></span> <span data-ttu-id="a62d9-455">Eilutės aukštis yra teigiamas horizontalioms žymėms ir neigiamas vertikalioms.</span><span class="sxs-lookup"><span data-stu-id="a62d9-455">The row height is positive for horizontal labels and negative for vertical labels.</span></span> <span data-ttu-id="a62d9-456">Kadangi yra tik viena eilutė šiame pavyzdyje, galite nustatyti vertę į *0* (nulį).</span><span class="sxs-lookup"><span data-stu-id="a62d9-456">Because there is just one row in this example, you can set the value to *0* (zero).</span></span>

    - <span data-ttu-id="a62d9-457">**Eilutės puslapyje:** *1*</span><span class="sxs-lookup"><span data-stu-id="a62d9-457">**Rows per page:** *1*</span></span>

        <span data-ttu-id="a62d9-458">Šis laukelis parodo eilučių skaičių, kuris gali būti atspausdintas kiekvienoje žymėje.</span><span class="sxs-lookup"><span data-stu-id="a62d9-458">This field defines the number of rows that can be printed on each label.</span></span>

        > [!NOTE]
        > <span data-ttu-id="a62d9-459">Šis nustatymas nulems, kad atskira ZPL žymė bus spausdinama kiekvienam įrašui bangos žymių lentelėje.</span><span class="sxs-lookup"><span data-stu-id="a62d9-459">This setup will cause a separate ZPL label to be printed for each record in the wave labels table.</span></span>

1. <span data-ttu-id="a62d9-460">Uždarykite puslapį.</span><span class="sxs-lookup"><span data-stu-id="a62d9-460">Close the page.</span></span>
1. <span data-ttu-id="a62d9-461">Veiksmų srityje pasirinkite **Redaguoti užklausą**.</span><span class="sxs-lookup"><span data-stu-id="a62d9-461">On the Action Pane, select **Edit query**.</span></span>
1. <span data-ttu-id="a62d9-462">Užklausos tvarkyklės teksto laukelyje, **Intervalas** skirtuke įtraukite eilutę su šiais nustatymais:</span><span class="sxs-lookup"><span data-stu-id="a62d9-462">In the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="a62d9-463">**Lentelė:** *Darbo eilutės*</span><span class="sxs-lookup"><span data-stu-id="a62d9-463">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="a62d9-464">**Išvestinė lentelė:** *Darbo eilutės*</span><span class="sxs-lookup"><span data-stu-id="a62d9-464">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="a62d9-465">**Laukas:** *Darbo tipas*</span><span class="sxs-lookup"><span data-stu-id="a62d9-465">**Field:** *Work type*</span></span>
    - <span data-ttu-id="a62d9-466">**Kriterijai:** *Paėmimas*</span><span class="sxs-lookup"><span data-stu-id="a62d9-466">**Criteria:** *Pick*</span></span>

    <span data-ttu-id="a62d9-467">Ši užklausa užtikrina, kad tik paėmimo tipo darbo linijos bus atspausdintos žymėje, o ne padėjimo tipo darbo linijos.</span><span class="sxs-lookup"><span data-stu-id="a62d9-467">This query ensures that only pick-type work lines will be printed on the label, not put-type work lines.</span></span>

1. <span data-ttu-id="a62d9-468">Jei norite galėti atspausdinti važtaraščio identifikavimo kodą **Sujungimai** skirtuke, pasirinkite **Darbo linijų** lentelę ir prijunkite prie jo **Siuntimai** lentelę.</span><span class="sxs-lookup"><span data-stu-id="a62d9-468">If you want to be able to print the bill of lading ID, on the **Joins** tab, select the **Work lines** table, and join the **Shipments** table to it.</span></span> 
1. <span data-ttu-id="a62d9-469">Uždarykite užklausos tvarkylės teksto laukelį.</span><span class="sxs-lookup"><span data-stu-id="a62d9-469">Close the query editor dialog box.</span></span>
1. <span data-ttu-id="a62d9-470">**Spausdintuvo teksto maketas** „FastTab“ turi tris skyrius, kuriuose galite rašyti spausdintuvo kodą: **Antraštės skyrius**, **Vidurinės dalies skyrius** ir **Poraštės skyrius**.</span><span class="sxs-lookup"><span data-stu-id="a62d9-470">The **Printer text Layout** FastTab has three sections where you can write printer code: **Header section**, **Body section**, and **Footer section**.</span></span> <span data-ttu-id="a62d9-471">Skyriaus **Antraštės skyrius** laukelyje **Žymos antraštė** įveskite kodą reikiamai antraštei.</span><span class="sxs-lookup"><span data-stu-id="a62d9-471">In the **Header section** section, in the **Label header** field, enter code for the required header.</span></span> <span data-ttu-id="a62d9-472">Pavyzdžiui, jei naudojate „Zebra“ spausdintuvus, galite naudoti šį kodą.</span><span class="sxs-lookup"><span data-stu-id="a62d9-472">For example, if you're using Zebra printers, you can use the following code.</span></span>
...
1. <span data-ttu-id="a62d9-473">**Vidurinės dalies skyrius** skyriuje, **Žymos vidurinė dalis** laukelyje įveskite ZPL kodą būtinai vidurinei daliai.</span><span class="sxs-lookup"><span data-stu-id="a62d9-473">In the **Body section** section, in the **Label body** field, enter ZPL code for the required body.</span></span> <span data-ttu-id="a62d9-474">Toliau pateikiamas pavyzdys.</span><span class="sxs-lookup"><span data-stu-id="a62d9-474">Here is an example.</span></span>
...
1. <span data-ttu-id="a62d9-475">**Vidurinės dalies skyrius** skyriuje, **Žymos apatinė dalis** laukelyje įveskite ZPL kodą būtinai apatinei daliai.</span><span class="sxs-lookup"><span data-stu-id="a62d9-475">In the **Body section** section, in the **Label footer** field, enter ZPL code for the required footer.</span></span> <span data-ttu-id="a62d9-476">Toliau pateikiamas pavyzdys.</span><span class="sxs-lookup"><span data-stu-id="a62d9-476">Here is an example.</span></span>
    ...
    > [!NOTE]
    > <span data-ttu-id="a62d9-477">Šie nustatymai atspausdins vieną kiekvienos žymos kopiją.</span><span class="sxs-lookup"><span data-stu-id="a62d9-477">This setup will print one copy of each label.</span></span> <span data-ttu-id="a62d9-478">Jei jums reikia daugiau kopijų (pavyzdžiui, vienos kopijos vienai padėklo pusei), nustatykite **n** vertę **\^PQn** skyriui poraštėje reikiamam kopijų skaičiui.</span><span class="sxs-lookup"><span data-stu-id="a62d9-478">If you require more copies (for example, one copy for each side of the pallet), set the **n** value for the **\^PQn** section in the footer to the required number of copies.</span></span> <span data-ttu-id="a62d9-479">Pavyzdžiui, keturių kiekvienos žymos kopijų spausdinimui, nustatykite **\^PQ4**.</span><span class="sxs-lookup"><span data-stu-id="a62d9-479">For example, to print four copies of each label, specify **\^PQ4**.</span></span>

1. <span data-ttu-id="a62d9-480">Pirmoji žymė dabar paruošta naudojimui.</span><span class="sxs-lookup"><span data-stu-id="a62d9-480">The first label is now ready to use.</span></span>
1. <span data-ttu-id="a62d9-481">Sukurkite antrą maketo įrašą, kuris turi šiuos nustatymus:</span><span class="sxs-lookup"><span data-stu-id="a62d9-481">Create a second layout record that has the following settings:</span></span>

    - <span data-ttu-id="a62d9-482">**Žymės maketo identifikavimo numeris:** *Padėklas*</span><span class="sxs-lookup"><span data-stu-id="a62d9-482">**Label layout ID:** *Pallet*</span></span>
    - <span data-ttu-id="a62d9-483">**Aprašas:** *Padėklas*</span><span class="sxs-lookup"><span data-stu-id="a62d9-483">**Description:** *Pallet*</span></span>

1. <span data-ttu-id="a62d9-484">Veiksmų srityje pasirinkite **Įrašyti**.</span><span class="sxs-lookup"><span data-stu-id="a62d9-484">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="a62d9-485">Veiksmų juostoje pasirinkite **Bangos žymos eilutės nustatymai**.</span><span class="sxs-lookup"><span data-stu-id="a62d9-485">On the Action Pane, select **Wave label row settings**.</span></span>

    <span data-ttu-id="a62d9-486">Pasirodo **Bangos žymos eilutės nustatymai** langas.</span><span class="sxs-lookup"><span data-stu-id="a62d9-486">The **Wave label row settings** page appears.</span></span> <span data-ttu-id="a62d9-487">Čia galite sukonfigūruoti dinaminę žymos dalį.</span><span class="sxs-lookup"><span data-stu-id="a62d9-487">Here, you can configure the dynamic part of the label.</span></span>

1. <span data-ttu-id="a62d9-488">Įtraukite eilutę, kuri turi šiuos nustatymus:</span><span class="sxs-lookup"><span data-stu-id="a62d9-488">Add a row that has the following settings:</span></span>

    - <span data-ttu-id="a62d9-489">**Eilutės Identifikavimo kodas:** *Bangos žymė*</span><span class="sxs-lookup"><span data-stu-id="a62d9-489">**Row Id:** *WaveLabel*</span></span>
    - <span data-ttu-id="a62d9-490">**Eilutės lentelės pavadinimas:** *WHSWaveLabel*</span><span class="sxs-lookup"><span data-stu-id="a62d9-490">**Row table name:** *WHSWaveLabel*</span></span>
    - <span data-ttu-id="a62d9-491">**Eilutės pradžios padėtis:** *0*</span><span class="sxs-lookup"><span data-stu-id="a62d9-491">**Row start position:** *0*</span></span>

        <span data-ttu-id="a62d9-492">Šis laukelis apibrėžia vertikalią padėtį, kurioje eilutė prasideda žymėje.</span><span class="sxs-lookup"><span data-stu-id="a62d9-492">This field defines the vertical position where the row will begin on the label.</span></span>

    - <span data-ttu-id="a62d9-493">**Eilutės aukštis:** *0*</span><span class="sxs-lookup"><span data-stu-id="a62d9-493">**Row height:** *0*</span></span>

        <span data-ttu-id="a62d9-494">Laukelis apibrėžia kiekvienos eilutės aukštį (taškais) pagal ZPL standartą.</span><span class="sxs-lookup"><span data-stu-id="a62d9-494">This field defines the height of each row (in points), according to the ZPL standard.</span></span> <span data-ttu-id="a62d9-495">Eilutės aukštis yra teigiamas horizontalioms žymėms ir neigiamas vertikalioms.</span><span class="sxs-lookup"><span data-stu-id="a62d9-495">The row height is positive for horizontal labels and negative for vertical labels.</span></span> <span data-ttu-id="a62d9-496">Kadangi yra tik viena eilutė šiame pavyzdyje, galite nustatyti vertę į *0* (nulį).</span><span class="sxs-lookup"><span data-stu-id="a62d9-496">Because there is just one row in this example, you can set the value to *0* (zero).</span></span>

    - <span data-ttu-id="a62d9-497">**Eilutės puslapyje:** *1*</span><span class="sxs-lookup"><span data-stu-id="a62d9-497">**Rows per page:** *1*</span></span>

        <span data-ttu-id="a62d9-498">Šis laukelis parodo eilučių skaičių, kuris gali būti atspausdintas kiekvienoje žymėje.</span><span class="sxs-lookup"><span data-stu-id="a62d9-498">This field defines the number of rows that can be printed on each label.</span></span>

        > [!NOTE]
        > <span data-ttu-id="a62d9-499">Šis nustatymas nulemia, kad atskira ZPL žymė bus spausdinama kiekvienam įrašui bangos žymių lentelėje.</span><span class="sxs-lookup"><span data-stu-id="a62d9-499">This setup causes a separate ZPL label to be printed for each record in the wave labels table.</span></span>

1. <span data-ttu-id="a62d9-500">Uždarykite puslapį.</span><span class="sxs-lookup"><span data-stu-id="a62d9-500">Close the page.</span></span>
1. <span data-ttu-id="a62d9-501">Veiksmų srityje pasirinkite **Redaguoti užklausą**.</span><span class="sxs-lookup"><span data-stu-id="a62d9-501">On the Action Pane, select **Edit query**.</span></span>
1. <span data-ttu-id="a62d9-502">Užklausos tvarkyklės teksto laukelyje, **Intervalas** skirtuke įtraukite eilutę su šiais nustatymais:</span><span class="sxs-lookup"><span data-stu-id="a62d9-502">In the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="a62d9-503">**Lentelė:** *Darbo eilutės*</span><span class="sxs-lookup"><span data-stu-id="a62d9-503">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="a62d9-504">**Išvestinė lentelė:** *Darbo eilutės*</span><span class="sxs-lookup"><span data-stu-id="a62d9-504">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="a62d9-505">**Laukas:** *Darbo tipas*</span><span class="sxs-lookup"><span data-stu-id="a62d9-505">**Field:** *Work type*</span></span>
    - <span data-ttu-id="a62d9-506">**Kriterijai:** *Paėmimas*</span><span class="sxs-lookup"><span data-stu-id="a62d9-506">**Criteria:** *Pick*</span></span>

    <span data-ttu-id="a62d9-507">Ši užklausa užtikrina, kad tik paėmimo tipo darbo linijos bus atspausdintos žymėje, o ne padėjimo tipo darbo linijos.</span><span class="sxs-lookup"><span data-stu-id="a62d9-507">This query ensures that only pick-type work lines will be printed on the label, not put-type work lines.</span></span>

1. <span data-ttu-id="a62d9-508">Jei norite galėti atspausdinti važtaraščio identifikavimo kodą **Sujungimai** skirtuke, pasirinkite **Darbo linijų** lentelę ir prijunkite prie jo **Siuntimai** lentelę.</span><span class="sxs-lookup"><span data-stu-id="a62d9-508">If you want to be able to print the bill of lading ID, on the **Joins** tab, select the **Work lines** table, and join the **Shipments** table to it.</span></span>
1. <span data-ttu-id="a62d9-509">Uždarykite užklausos tvarkylės teksto laukelį.</span><span class="sxs-lookup"><span data-stu-id="a62d9-509">Close the query editor dialog box.</span></span>
1. <span data-ttu-id="a62d9-510">**Spausdintuvo teksto maketas** „FastTab“ turi tris skyrius, kuriuose galite rašyti spausdintuvo kodą: **Antraštės skyrius**, **Vidurinės dalies skyrius** ir **Poraštės skyrius**.</span><span class="sxs-lookup"><span data-stu-id="a62d9-510">The **Printer text Layout** FastTab has three sections where you can write printer code: **Header section**, **Body section**, and **Footer section**.</span></span> <span data-ttu-id="a62d9-511">Skyriaus **Antraštės skyrius** laukelyje **Žymos antraštė** įveskite kodą reikiamai antraštei.</span><span class="sxs-lookup"><span data-stu-id="a62d9-511">In the **Header section** section, in the **Label header** field, enter code for the required header.</span></span> <span data-ttu-id="a62d9-512">Pavyzdžiui, jei naudojate „Zebra“ spausdintuvus, galite naudoti šį kodą.</span><span class="sxs-lookup"><span data-stu-id="a62d9-512">For example, if you're using Zebra printers, you can use the following code.</span></span>
...
1. <span data-ttu-id="a62d9-513">**Vidurinės dalies skyrius** skyriuje, **Žymos vidurinė dalis** laukelyje įveskite ZPL kodą būtinai vidurinei daliai.</span><span class="sxs-lookup"><span data-stu-id="a62d9-513">In the **Body section** section, in the **Label body** field, enter ZPL code for the required body.</span></span> <span data-ttu-id="a62d9-514">Toliau pateikiamas pavyzdys.</span><span class="sxs-lookup"><span data-stu-id="a62d9-514">Here is an example.</span></span>
...
1. <span data-ttu-id="a62d9-515">**Vidurinės dalies skyrius** skyriuje, **Žymos apatinė dalis** laukelyje įveskite ZPL kodą būtinai apatinei daliai.</span><span class="sxs-lookup"><span data-stu-id="a62d9-515">In the **Body section** section, in the **Label footer** field, enter ZPL code for the required footer.</span></span> <span data-ttu-id="a62d9-516">Toliau pateikiamas pavyzdys.</span><span class="sxs-lookup"><span data-stu-id="a62d9-516">Here is an example.</span></span>
    ...
    > [!NOTE]
    > <span data-ttu-id="a62d9-517">Šie nustatymai atspausdins vieną kiekvienos žymos kopiją.</span><span class="sxs-lookup"><span data-stu-id="a62d9-517">This setup will print one copy of each label.</span></span> <span data-ttu-id="a62d9-518">Jei jums reikia daugiau kopijų (pavyzdžiui, vienos kopijos vienai padėklo pusei), nustatykite **n** vertę **\^PQn** skyriui poraštėje reikiamam kopijų skaičiui.</span><span class="sxs-lookup"><span data-stu-id="a62d9-518">If you require more copies (for example, one copy for each side of the pallet), set the **n** value for the **\^PQn** section in the footer to the required number of copies.</span></span> <span data-ttu-id="a62d9-519">Pavyzdžiui, keturių kiekvienos žymos kopijų spausdinimui, nustatykite **\^PQ4**.</span><span class="sxs-lookup"><span data-stu-id="a62d9-519">For example, to print four copies of each label, specify **\^PQ4**.</span></span>

1. <span data-ttu-id="a62d9-520">Antroji žymė dabar paruošta naudojimui.</span><span class="sxs-lookup"><span data-stu-id="a62d9-520">The second label is now ready to use.</span></span>
1. <span data-ttu-id="a62d9-521">Sukurkite trečią maketo įrašą, kuris turi šiuos nustatymus:</span><span class="sxs-lookup"><span data-stu-id="a62d9-521">Create a third layout record that has the following settings:</span></span>

    - <span data-ttu-id="a62d9-522">**Žymės maketo identifikavimo numeris:** *Tarpas*</span><span class="sxs-lookup"><span data-stu-id="a62d9-522">**Label layout ID:** *Break*</span></span>
    - <span data-ttu-id="a62d9-523">**Aprašas:** *Tarpo žymė*</span><span class="sxs-lookup"><span data-stu-id="a62d9-523">**Description:** *Break label*</span></span>

1. <span data-ttu-id="a62d9-524">Veiksmų srityje pasirinkite **Įrašyti**.</span><span class="sxs-lookup"><span data-stu-id="a62d9-524">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="a62d9-525">**Spausdintuvo teksto maketas** „FastTab“ turi tris skyrius, kuriuose galite rašyti spausdintuvo kodą: **Antraštės skyrius**, **Vidurinės dalies skyrius** ir **Poraštės skyrius**.</span><span class="sxs-lookup"><span data-stu-id="a62d9-525">The **Printer text Layout** FastTab has three sections where you can write printer code: **Header section**, **Body section**, and **Footer section**.</span></span> <span data-ttu-id="a62d9-526">**Antraštės skyrius** skyriuje, **Žymos antraštė** laukelyje įveskite ZPL kodą būtinai antraštei.</span><span class="sxs-lookup"><span data-stu-id="a62d9-526">In the **Header section** section, in the **Label header** field, enter ZPL code for the required header.</span></span> <span data-ttu-id="a62d9-527">Toliau pateikiamas pavyzdys.</span><span class="sxs-lookup"><span data-stu-id="a62d9-527">Here is an example.</span></span>
...
1. <span data-ttu-id="a62d9-528">Šįkart, nereikia jokios vidurinės dalies.</span><span class="sxs-lookup"><span data-stu-id="a62d9-528">This time, no body is required.</span></span> <span data-ttu-id="a62d9-529">Dėl to, tiesiog įveskite būtiną tekstą **Poraštės skyrius** skyriuje.</span><span class="sxs-lookup"><span data-stu-id="a62d9-529">Therefore, just enter the required text in the **Footer section** section.</span></span> <span data-ttu-id="a62d9-530">Toliau pateikiamas pavyzdys.</span><span class="sxs-lookup"><span data-stu-id="a62d9-530">Here is an example.</span></span>

    ```plaintext
    ^XZ
    ```

    <span data-ttu-id="a62d9-531">Trečioji žymė dabar paruošta naudojimui.</span><span class="sxs-lookup"><span data-stu-id="a62d9-531">The third label is now ready to use.</span></span>

    > [!NOTE]
    > <span data-ttu-id="a62d9-532">Ši trečioji etiketė yra žymos tarpas, kuris bus naudojamas atskirti žymių ritinius.</span><span class="sxs-lookup"><span data-stu-id="a62d9-532">This third label is a break label that will be used as a divider between label rolls.</span></span>

### <a name="create-two-wave-label-types"></a><span data-ttu-id="a62d9-533">Sukurkite du bangos žymių tipus</span><span class="sxs-lookup"><span data-stu-id="a62d9-533">Create two wave label types</span></span>

1. <span data-ttu-id="a62d9-534">Eikite į **Sandėlio tvarkymas \> Sąranka \> Dokumento maršrutas \> Bangos žymos tipai**.</span><span class="sxs-lookup"><span data-stu-id="a62d9-534">Go to **Warehouse management \> Setup \> Document routing \> Wave label types**.</span></span>
1. <span data-ttu-id="a62d9-535">Sukurkite įrašą, kuris turi šiuos nustatymus:</span><span class="sxs-lookup"><span data-stu-id="a62d9-535">Create a record that has the following settings:</span></span>

    - <span data-ttu-id="a62d9-536">**Žymos tipas:** *Dėžė*</span><span class="sxs-lookup"><span data-stu-id="a62d9-536">**Label type:** *Carton*</span></span>
    - <span data-ttu-id="a62d9-537">**Aprašas:** *Dėžė*</span><span class="sxs-lookup"><span data-stu-id="a62d9-537">**Description:** *Carton*</span></span>

1. <span data-ttu-id="a62d9-538">Sukurkite antrą įrašą, kuris turi šiuos nustatymus:</span><span class="sxs-lookup"><span data-stu-id="a62d9-538">Create a second record that has the following settings:</span></span>

    - <span data-ttu-id="a62d9-539">**Žymos tipas:** *Padėklas*</span><span class="sxs-lookup"><span data-stu-id="a62d9-539">**Label type:** *Pallet*</span></span>
    - <span data-ttu-id="a62d9-540">**Aprašas:** *Padėklas*</span><span class="sxs-lookup"><span data-stu-id="a62d9-540">**Description:** *Pallet*</span></span>

### <a name="set-up-unit-sequence-groups"></a><span data-ttu-id="a62d9-541">Nustatyti vienetų sekų grupes</span><span class="sxs-lookup"><span data-stu-id="a62d9-541">Set up unit sequence groups</span></span>

1. <span data-ttu-id="a62d9-542">Eikite į **Sandėlio tvarkymas \> Sąranka \> Sandėlis \> Padalinio sekos grupės**.</span><span class="sxs-lookup"><span data-stu-id="a62d9-542">Go to **Warehouse management \> Setup \> Warehouse \> Unit sequence groups**.</span></span>
1. <span data-ttu-id="a62d9-543">Pasirinkite ar sukurkite **Vieneto dėžutės PL** grupę.</span><span class="sxs-lookup"><span data-stu-id="a62d9-543">Select or create an **Ea Box PL** group.</span></span>
1. <span data-ttu-id="a62d9-544">**Dėžutė** linijoje nustatykite **Bangos lygio tipas** laukelį į *Dėžė*.</span><span class="sxs-lookup"><span data-stu-id="a62d9-544">For the **Box** line, set the **Wave level type** field to *Carton*.</span></span>
1. <span data-ttu-id="a62d9-545">**PL** linijoje nustatykite **Bangos lygio tipas** laukelį į *Padėklas*.</span><span class="sxs-lookup"><span data-stu-id="a62d9-545">For the **PL** line, set the **Wave level type** field to *Pallet*.</span></span>

### <a name="create-wave-label-templates"></a><span data-ttu-id="a62d9-546">Sukurkite bangos žymos šablonus</span><span class="sxs-lookup"><span data-stu-id="a62d9-546">Create wave label templates</span></span>

1. <span data-ttu-id="a62d9-547">Eikite į **Sandėlio tvarkymas \> Sąranka \> Dokumento maršrutas \> Bangos žymos šablonai**.</span><span class="sxs-lookup"><span data-stu-id="a62d9-547">Go to **Warehouse management \> Setup \> Document routing \> Wave label templates**.</span></span>
1. <span data-ttu-id="a62d9-548">Sukurkite žymos šabloną, kuris turi šiuos nustatymus:</span><span class="sxs-lookup"><span data-stu-id="a62d9-548">Create a label template that has the following settings:</span></span>

    - <span data-ttu-id="a62d9-549">**Žymos šablono pavadinimas:** *Dėžių žymės*</span><span class="sxs-lookup"><span data-stu-id="a62d9-549">**Label template name:** *Carton labels*</span></span>
    - <span data-ttu-id="a62d9-550">**Aprašas:** *Dėžės žymės*</span><span class="sxs-lookup"><span data-stu-id="a62d9-550">**Description:** *Carton labels*</span></span>
    - <span data-ttu-id="a62d9-551">**Bangos žingsnio kodas:** *Dėžė*</span><span class="sxs-lookup"><span data-stu-id="a62d9-551">**Wave step code:** *Carton*</span></span>
    - <span data-ttu-id="a62d9-552">**Sandėlis:** *62*</span><span class="sxs-lookup"><span data-stu-id="a62d9-552">**Warehouse:** *62*</span></span>

1. <span data-ttu-id="a62d9-553">**Bendra** „FastTab“, nustatykite **Bangos žymos tipas** laukelyje pasirinkite vertę, tokią kaip *Dėžė*.</span><span class="sxs-lookup"><span data-stu-id="a62d9-553">On the **General** FastTab, in the **Wave label type** field, select a value, such as *Carton*.</span></span>
1. <span data-ttu-id="a62d9-554">**Bangos žymos šablono informacijoje** „FastTab“, įtraukite eilutę turinčią šiuos nustatymus:</span><span class="sxs-lookup"><span data-stu-id="a62d9-554">On the **Wave label template details** FastTab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="a62d9-555">**Žymos maketo identifikavimo numeris:** *Dėžė*</span><span class="sxs-lookup"><span data-stu-id="a62d9-555">**Label layout ID:** *Carton*</span></span>
    - <span data-ttu-id="a62d9-556">**Spausdintuvo pavadinimas:** Pasirinkite tinkamą ZPL spausdintuvą.</span><span class="sxs-lookup"><span data-stu-id="a62d9-556">**Printer name:** Select an appropriate ZPL printer.</span></span>
    - <span data-ttu-id="a62d9-557">**Vykdykite užklausą:** *Taip* (Šis pasirinkimas yra pasirenkamas, tačiau rekomenduojamas optimaliam veikimui.)</span><span class="sxs-lookup"><span data-stu-id="a62d9-557">**Run query:** *Yes* (This setting is optional, but it's recommended for optimal performance.)</span></span>

1. <span data-ttu-id="a62d9-558">Veiksmų srityje pasirinkite **Įrašyti**.</span><span class="sxs-lookup"><span data-stu-id="a62d9-558">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="a62d9-559">Pasirenkamas: Jei nustatote klientui konkretų žymos maketą, privalote sukurti užklausą tam, kad rastumėte kliento paskyrą.</span><span class="sxs-lookup"><span data-stu-id="a62d9-559">Optional: If you're setting up a customer-specific label design, you must create a query to find the customer's account.</span></span> <span data-ttu-id="a62d9-560">**bangos žymos šablono informacijoje** „FastTab“, pasirinkite **Redaguoti užklausą**.</span><span class="sxs-lookup"><span data-stu-id="a62d9-560">On the **Wave label template details** FastTab, select **Edit query**.</span></span> <span data-ttu-id="a62d9-561">Tuomet, užklausos tvarkyklės teksto laukelyje, **Intervalas** skirtuke įtraukite eilutę su šiais nustatymais:</span><span class="sxs-lookup"><span data-stu-id="a62d9-561">Then, in the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="a62d9-562">**Lentelė:** *Siuntos*</span><span class="sxs-lookup"><span data-stu-id="a62d9-562">**Table:** *Shipments*</span></span>
    - <span data-ttu-id="a62d9-563">**Išvestinė lentelė:** *Siuntos*</span><span class="sxs-lookup"><span data-stu-id="a62d9-563">**Derived table:** *Shipments*</span></span>
    - <span data-ttu-id="a62d9-564">**Laukelis:** *Paskyros numeris*</span><span class="sxs-lookup"><span data-stu-id="a62d9-564">**Field:** *Account number*</span></span>
    - <span data-ttu-id="a62d9-565">**Kriterijai:** Įveskite reikiamą kliento paskyros numerį.</span><span class="sxs-lookup"><span data-stu-id="a62d9-565">**Criteria:** Enter the relevant customer account number.</span></span>

    <span data-ttu-id="a62d9-566">Kai baigsite, pasirinkite **Gerai** užklausos tvarkyklės teksto langui uždaryti.</span><span class="sxs-lookup"><span data-stu-id="a62d9-566">When you've finished, select **OK** to close the query editor dialog box.</span></span>

1. <span data-ttu-id="a62d9-567">Veiksmų juostoje pasirinkite **Redaguoti užklausą** tam, kad atvertumėte užklausos tvarkyklės teksto laukelį visam žymos šablonui.</span><span class="sxs-lookup"><span data-stu-id="a62d9-567">On the Action Pane, select **Edit query** to open the query editor dialog box for the whole label template.</span></span>
1. <span data-ttu-id="a62d9-568">Užklausos tvarkyklės teksto laukelyje, **Rūšiavimas** skirtuke įtraukite eilutę su šiais nustatymais:</span><span class="sxs-lookup"><span data-stu-id="a62d9-568">In the query editor dialog box, on the **Sorting** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="a62d9-569">**Lentelė:** *Darbo eilutės*</span><span class="sxs-lookup"><span data-stu-id="a62d9-569">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="a62d9-570">**Išvestinė lentelė:** *Darbo eilutės*</span><span class="sxs-lookup"><span data-stu-id="a62d9-570">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="a62d9-571">**Laukelis:** *Nuorodos krovimo linijos identifikavimo numeris (Record-ID)*</span><span class="sxs-lookup"><span data-stu-id="a62d9-571">**Field:** *Reference load line id (Record-ID)*</span></span>
    - <span data-ttu-id="a62d9-572">**Paieškos kryptis:** *Didėjanti*</span><span class="sxs-lookup"><span data-stu-id="a62d9-572">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="a62d9-573">Įtraukite antrą eilutę, kuri turi šiuos nustatymus:</span><span class="sxs-lookup"><span data-stu-id="a62d9-573">Add a second row that has the following settings:</span></span>

    - <span data-ttu-id="a62d9-574">**Lentelė:** *Darbo eilutės*</span><span class="sxs-lookup"><span data-stu-id="a62d9-574">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="a62d9-575">**Išvestinė lentelė:** *Darbo eilutės*</span><span class="sxs-lookup"><span data-stu-id="a62d9-575">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="a62d9-576">**Laukas:** *Siuntos ID*</span><span class="sxs-lookup"><span data-stu-id="a62d9-576">**Field:** *Shipment ID*</span></span>
    - <span data-ttu-id="a62d9-577">**Paieškos kryptis:** *Didėjanti*</span><span class="sxs-lookup"><span data-stu-id="a62d9-577">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="a62d9-578">Pasirinkite **Gerai** užklausos tvarkyklės teksto langui uždaryti.</span><span class="sxs-lookup"><span data-stu-id="a62d9-578">Select **OK** to close the query editor dialog box.</span></span>
1. <span data-ttu-id="a62d9-579">Pranešimo laukelis paskatins jus patvirtinti grupavimo perkrovimo veiksmą.</span><span class="sxs-lookup"><span data-stu-id="a62d9-579">A message box prompts you to confirm the grouping reset operation.</span></span> <span data-ttu-id="a62d9-580">Pasirinkite **taip** tam, kad tęstumėte.</span><span class="sxs-lookup"><span data-stu-id="a62d9-580">Select **Yes** to continue.</span></span>
1. <span data-ttu-id="a62d9-581">Veiksmų juostoje pasirinkite **bangos žymos šablono grupė**.</span><span class="sxs-lookup"><span data-stu-id="a62d9-581">On the Action Pane, select **Wave label template group**.</span></span>
1. <span data-ttu-id="a62d9-582">**Bangos žymos šablono grupės** teksto laukelyje, pasirinkite eilutę, kurioje **Nuorodos laukelio pavadinimas** laukelis nustatytas į *Siuntimo identifikavimo kodas*, nustatykite šias vertes:</span><span class="sxs-lookup"><span data-stu-id="a62d9-582">In the **Wave label template group** dialog box, for the row where the **Reference field name** field is set to *Shipment ID*, set the following values:</span></span>

    - <span data-ttu-id="a62d9-583">**Spausdinimo tarpo žymė:** Pasirinkite šį žymimą laukelį.</span><span class="sxs-lookup"><span data-stu-id="a62d9-583">**Print break label:** Select this check box.</span></span>
    - <span data-ttu-id="a62d9-584">**Žymos maketo identifikavimo kodas:** Pasirinkite tarpo žymę.</span><span class="sxs-lookup"><span data-stu-id="a62d9-584">**Label layout ID:** Select a break label.</span></span> <span data-ttu-id="a62d9-585">(Pavyzdžiui, pasirinkite *Tarpo* žymos maketą, kurį sukūrėte anksčiau šiame scenarijuje.)</span><span class="sxs-lookup"><span data-stu-id="a62d9-585">(For example, select the *Break* label layout that you created earlier in this scenario.)</span></span>
    - <span data-ttu-id="a62d9-586">**Spausdintuvo pavadinimas:** Pasirinkite spausdintuvą tarpo žymei.</span><span class="sxs-lookup"><span data-stu-id="a62d9-586">**Printer name:** Select the printer for the break label.</span></span> <span data-ttu-id="a62d9-587">(Dažniausiai, dėl žymių ritinių skaidymo tikslų, turite pasirinkti tą patį spausdintuvą, kuris pasirinktas **Bangos žymos šablono informacijos** „FastTab“.</span><span class="sxs-lookup"><span data-stu-id="a62d9-587">(Typically, for the purpose of splitting label rolls, you should select the same printer that is selected on the **Wave label template details** FastTab.</span></span> <span data-ttu-id="a62d9-588">Nepaisant to, kiti scenarijai yra galimi.)</span><span class="sxs-lookup"><span data-stu-id="a62d9-588">However, other scenarios are possible.)</span></span>

1. <span data-ttu-id="a62d9-589">Eilutėje, kurioje **Nuorodos žymos pavadinimas** laukelis nustatytas *Nuorodos krovimo linijos identifikavimo kodas*, pasirinkite **Žymos kūrėjo identifikavimo kodas** žymimą laukelį.</span><span class="sxs-lookup"><span data-stu-id="a62d9-589">For the row where the **Reference field name** field is set to *Reference load line id*, select the **Label build ID** check box.</span></span>

    > [!NOTE]
    > <span data-ttu-id="a62d9-590">Šie nustatymai sukurs vieną žymos seką („Dėžė 1 X“) vienai krovimo linijai bangoje nepriklausomai nuo darbo grupės nustatymų.</span><span class="sxs-lookup"><span data-stu-id="a62d9-590">This setup will create one label sequence ("Carton 1 of X") per load line throughout the wave, regardless of the work grouping setup.</span></span> <span data-ttu-id="a62d9-591">Ši žymos seka gali būti atspausdinta viename žymos makete.</span><span class="sxs-lookup"><span data-stu-id="a62d9-591">This label sequence can be printed on a label layout.</span></span> <span data-ttu-id="a62d9-592">Taip pat, žymos skirtingoms siuntoms bus atskirtos pasirinkta tarpo žyme.</span><span class="sxs-lookup"><span data-stu-id="a62d9-592">Additionally, labels for different shipments will be separated by the selected break label.</span></span>

1. <span data-ttu-id="a62d9-593">Pasirinkite **Gerai** tam, kad uždarytumėte **Bangos žymos šablono grupės** teksto laukelį.</span><span class="sxs-lookup"><span data-stu-id="a62d9-593">Select **OK** to close the **Wave label template group** dialog box.</span></span>
1. <span data-ttu-id="a62d9-594">Sukurkite antrą žymos šabloną, kuris turi šiuos nustatymus:</span><span class="sxs-lookup"><span data-stu-id="a62d9-594">Create a second label template that has the following settings:</span></span>

    - <span data-ttu-id="a62d9-595">**Žymos šablono pavadinimas:** *Padėklo žymės*</span><span class="sxs-lookup"><span data-stu-id="a62d9-595">**Label template name:** *Pallet labels*</span></span>
    - <span data-ttu-id="a62d9-596">**Aprašas:** *Padėklo žymos*</span><span class="sxs-lookup"><span data-stu-id="a62d9-596">**Description:** *Pallet labels*</span></span>
    - <span data-ttu-id="a62d9-597">**Bangos žingsnio kodas:** *Padėklas*</span><span class="sxs-lookup"><span data-stu-id="a62d9-597">**Wave step code:** *Pallet*</span></span>
    - <span data-ttu-id="a62d9-598">**Sandėlis:** *62*</span><span class="sxs-lookup"><span data-stu-id="a62d9-598">**Warehouse:** *62*</span></span>

1. <span data-ttu-id="a62d9-599">**Bendra** „FastTab“, nustatykite **Bangos žymos tipas** laukelyje pasirinkite vertę, tokią kaip *Padėklas*.</span><span class="sxs-lookup"><span data-stu-id="a62d9-599">On the **General** FastTab, in the **Wave label type** field, select a value, such as *Pallet*.</span></span>
1. <span data-ttu-id="a62d9-600">**Bangos žymos šablono informacijoje** „FastTab“, įtraukite eilutę turinčią šiuos nustatymus:</span><span class="sxs-lookup"><span data-stu-id="a62d9-600">On the **Wave label template details** FastTab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="a62d9-601">**Žymės maketo identifikavimo numeris:** *Padėklas*</span><span class="sxs-lookup"><span data-stu-id="a62d9-601">**Label layout ID:** *Pallet*</span></span>
    - <span data-ttu-id="a62d9-602">**Spausdintuvo pavadinimas:** Pasirinkite tinkamą ZPL spausdintuvą.</span><span class="sxs-lookup"><span data-stu-id="a62d9-602">**Printer name:** Select an appropriate ZPL printer.</span></span>
    - <span data-ttu-id="a62d9-603">**Vykdykite užklausą:** *Taip* (Šis pasirinkimas yra pasirenkamas, tačiau rekomenduojamas optimaliam veikimui.)</span><span class="sxs-lookup"><span data-stu-id="a62d9-603">**Run query:** *Yes* (This setting is optional, but it's recommended for optimal performance.)</span></span>

1. <span data-ttu-id="a62d9-604">Veiksmų srityje pasirinkite **Įrašyti**.</span><span class="sxs-lookup"><span data-stu-id="a62d9-604">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="a62d9-605">Pasirenkamas: Jei nustatote klientui konkretų žymos maketą, privalote sukurti užklausą tam, kad rastumėte kliento paskyrą.</span><span class="sxs-lookup"><span data-stu-id="a62d9-605">Optional: If you're setting up a customer-specific label design, you must create a query to find the customer's account.</span></span> <span data-ttu-id="a62d9-606">**bangos žymos šablono informacijoje** „FastTab“, pasirinkite **Redaguoti užklausą**.</span><span class="sxs-lookup"><span data-stu-id="a62d9-606">On the **Wave label template details** FastTab, select **Edit query**.</span></span> <span data-ttu-id="a62d9-607">Tuomet, užklausos tvarkyklės teksto laukelyje, **Intervalas** skirtuke įtraukite eilutę su šiais nustatymais:</span><span class="sxs-lookup"><span data-stu-id="a62d9-607">Then, in the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="a62d9-608">**Lentelė:** *Siuntos*</span><span class="sxs-lookup"><span data-stu-id="a62d9-608">**Table:** *Shipments*</span></span>
    - <span data-ttu-id="a62d9-609">**Išvestinė lentelė:** *Siuntos*</span><span class="sxs-lookup"><span data-stu-id="a62d9-609">**Derived table:** *Shipments*</span></span>
    - <span data-ttu-id="a62d9-610">**Laukelis:** *Paskyros numeris*</span><span class="sxs-lookup"><span data-stu-id="a62d9-610">**Field:** *Account number*</span></span>
    - <span data-ttu-id="a62d9-611">**Kriterijai:** Įveskite reikiamą kliento paskyros numerį.</span><span class="sxs-lookup"><span data-stu-id="a62d9-611">**Criteria:** Enter the relevant customer account number.</span></span>

    <span data-ttu-id="a62d9-612">Kai baigsite, pasirinkite **Gerai** užklausos tvarkyklės teksto langui uždaryti.</span><span class="sxs-lookup"><span data-stu-id="a62d9-612">When you've finished, select **OK** to close the query editor dialog box.</span></span> 

1. <span data-ttu-id="a62d9-613">Veiksmų juostoje pasirinkite **Redaguoti užklausą** tam, kad atvertumėte užklausos tvarkyklės teksto laukelį visam žymos šablonui.</span><span class="sxs-lookup"><span data-stu-id="a62d9-613">On the Action Pane, select **Edit query** to open the query editor dialog box for the whole label template.</span></span>
1. <span data-ttu-id="a62d9-614">Užklausos tvarkyklės teksto laukelyje, **Rūšiavimas** skirtuke įtraukite eilutę su šiais nustatymais:</span><span class="sxs-lookup"><span data-stu-id="a62d9-614">In the query editor dialog box, on the **Sorting** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="a62d9-615">**Lentelė:** *Darbo eilutės*</span><span class="sxs-lookup"><span data-stu-id="a62d9-615">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="a62d9-616">**Išvestinė lentelė:** *Darbo eilutės*</span><span class="sxs-lookup"><span data-stu-id="a62d9-616">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="a62d9-617">**Laukelis:** *Nuorodos krovimo linijos identifikavimo numeris (Record-ID)*</span><span class="sxs-lookup"><span data-stu-id="a62d9-617">**Field:** *Reference load line id (Record-ID)*</span></span>
    - <span data-ttu-id="a62d9-618">**Paieškos kryptis:** *Didėjanti*</span><span class="sxs-lookup"><span data-stu-id="a62d9-618">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="a62d9-619">Įtraukite antrą eilutę, kuri turi šiuos nustatymus:</span><span class="sxs-lookup"><span data-stu-id="a62d9-619">Add a second row that has the following settings:</span></span>

    - <span data-ttu-id="a62d9-620">**Lentelė:** *Darbo eilutės*</span><span class="sxs-lookup"><span data-stu-id="a62d9-620">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="a62d9-621">**Išvestinė lentelė:** *Darbo eilutės*</span><span class="sxs-lookup"><span data-stu-id="a62d9-621">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="a62d9-622">**Laukas:** *Siuntos ID*</span><span class="sxs-lookup"><span data-stu-id="a62d9-622">**Field:** *Shipment ID*</span></span>
    - <span data-ttu-id="a62d9-623">**Paieškos kryptis:** *Didėjanti*</span><span class="sxs-lookup"><span data-stu-id="a62d9-623">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="a62d9-624">Pasirinkite **Gerai** užklausos tvarkyklės teksto langui uždaryti.</span><span class="sxs-lookup"><span data-stu-id="a62d9-624">Select **OK** to close the query editor dialog box.</span></span>
1. <span data-ttu-id="a62d9-625">Pranešimo laukelis paskatins jus patvirtinti grupavimo perkrovimo veiksmą.</span><span class="sxs-lookup"><span data-stu-id="a62d9-625">A message box prompts you to confirm the grouping reset operation.</span></span> <span data-ttu-id="a62d9-626">Pasirinkite **taip** tam, kad tęstumėte.</span><span class="sxs-lookup"><span data-stu-id="a62d9-626">Select **Yes** to continue.</span></span>
1. <span data-ttu-id="a62d9-627">Veiksmų juostoje pasirinkite **bangos žymos šablono grupė**.</span><span class="sxs-lookup"><span data-stu-id="a62d9-627">On the Action Pane, select **Wave label template group**.</span></span>
1. <span data-ttu-id="a62d9-628">**Bangos žymos šablono grupės** teksto laukelyje, pasirinkite eilutę, kurioje **Nuorodos laukelio pavadinimas** laukelis nustatytas į *Siuntimo identifikavimo kodas*, nustatykite šias vertes:</span><span class="sxs-lookup"><span data-stu-id="a62d9-628">In the **Wave label template group** dialog box, for the row where the **Reference field name** field is set to *Shipment ID*, set the following values:</span></span>

    - <span data-ttu-id="a62d9-629">**Spausdinimo tarpo žymė:** Pasirinkite šį žymimą laukelį.</span><span class="sxs-lookup"><span data-stu-id="a62d9-629">**Print break label:** Select this check box.</span></span>
    - <span data-ttu-id="a62d9-630">**Žymos maketo identifikavimo kodas:** Pasirinkite tarpo žymę.</span><span class="sxs-lookup"><span data-stu-id="a62d9-630">**Label layout ID:** Select a break label.</span></span> <span data-ttu-id="a62d9-631">(Pavyzdžiui, pasirinkite *Tarpo* žymos maketą, kurį sukūrėte anksčiau šiame scenarijuje.)</span><span class="sxs-lookup"><span data-stu-id="a62d9-631">(For example, select the *Break* label layout that you created earlier in this scenario.)</span></span>
    - <span data-ttu-id="a62d9-632">**Spausdintuvo pavadinimas:** Pasirinkite spausdintuvą tarpo žymei.</span><span class="sxs-lookup"><span data-stu-id="a62d9-632">**Printer name:** Select the printer for the break label.</span></span> <span data-ttu-id="a62d9-633">(Dažniausiai, dėl žymių ritinių skaidymo tikslų, turite pasirinkti tą patį spausdintuvą, kuris pasirinktas **Bangos žymos šablono informacijos** „FastTab“.</span><span class="sxs-lookup"><span data-stu-id="a62d9-633">(Typically, for the purpose of splitting label rolls, you should select the same printer that is selected on the **Wave label template details** FastTab.</span></span> <span data-ttu-id="a62d9-634">Nepaisant to, kiti scenarijai yra galimi.)</span><span class="sxs-lookup"><span data-stu-id="a62d9-634">However, other scenarios are possible.)</span></span>

1. <span data-ttu-id="a62d9-635">Eilutėje, kurioje **Nuorodos žymos pavadinimas** laukelis nustatytas *Nuorodos krovimo linijos identifikavimo kodas*, pasirinkite **Žymos kūrėjo identifikavimo kodas** žymimą laukelį.</span><span class="sxs-lookup"><span data-stu-id="a62d9-635">For the row where the **Reference field name** field is set to *Reference load line id*, select the **Label build ID** check box.</span></span>

    > [!NOTE]
    > <span data-ttu-id="a62d9-636">Šie nustatymai sukurs vieną žymos seką („Dėžė 1 X“) vienai krovimo linijai bangoje nepriklausomai nuo darbo grupės nustatymų.</span><span class="sxs-lookup"><span data-stu-id="a62d9-636">This setup will create one label sequence ("Carton 1 of X") per load line throughout the wave, regardless of the work grouping setup.</span></span> <span data-ttu-id="a62d9-637">Ši žymos seka gali būti atspausdinta viename žymos makete.</span><span class="sxs-lookup"><span data-stu-id="a62d9-637">This label sequence can be printed on a label layout.</span></span> <span data-ttu-id="a62d9-638">Taip pat, žymos skirtingoms siuntoms bus atskirtos pasirinkta tarpo žyme.</span><span class="sxs-lookup"><span data-stu-id="a62d9-638">Additionally, labels for different shipments will be separated by the selected break label.</span></span>

### <a name="configure-number-sequence-extensions"></a><span data-ttu-id="a62d9-639">Konfigūruokite numerio sekos plėtinius</span><span class="sxs-lookup"><span data-stu-id="a62d9-639">Configure number sequence extensions</span></span>

<span data-ttu-id="a62d9-640">Numerio sekos plėtiniai valdo GS1 atitiktį su specifinėmis numerio sekomis.</span><span class="sxs-lookup"><span data-stu-id="a62d9-640">Number sequence extensions control the GS1 compliance of specific number sequences.</span></span> <span data-ttu-id="a62d9-641">Konfigūravimas yra pasirenkamas esamam scenarijui.</span><span class="sxs-lookup"><span data-stu-id="a62d9-641">This configuration is optional for the current scenario.</span></span> <span data-ttu-id="a62d9-642">Dėl platesnės informacijos ir konfigūravimo instrukcijų, žr. [Konfigūruoti numerio sekos plėtinius](../warehousing/configure-number-sequence-extensions.md).</span><span class="sxs-lookup"><span data-stu-id="a62d9-642">For more information and configuration instructions, see [Configure number sequence extensions](../warehousing/configure-number-sequence-extensions.md).</span></span>

### <a name="create-a-sales-order-and-release-it-to-the-warehouse"></a><span data-ttu-id="a62d9-643">Sukuria prekybos užsakymą ir išleidžia jį į sandėlį</span><span class="sxs-lookup"><span data-stu-id="a62d9-643">Create a sales order and release it to the warehouse</span></span>

1. <span data-ttu-id="a62d9-644">Eikite į **Prekyba ir komercija \> Prekybos užsakymas \> Visi prekybos užsakymai**.</span><span class="sxs-lookup"><span data-stu-id="a62d9-644">Go to **Sales and marketing \> Sales order \> All sales orders**.</span></span>
1. <span data-ttu-id="a62d9-645">Sukurkite pardavimo užsakymą, kuriam nustatyti tolesni parametrai.</span><span class="sxs-lookup"><span data-stu-id="a62d9-645">Create a sales order that has the following settings:</span></span>

    - <span data-ttu-id="a62d9-646">**Kliento sąskaita:** *US-001*</span><span class="sxs-lookup"><span data-stu-id="a62d9-646">**Customer account:** *US-001*</span></span>
    - <span data-ttu-id="a62d9-647">**Sandėlis:** *62*</span><span class="sxs-lookup"><span data-stu-id="a62d9-647">**Warehouse:** *62*</span></span>

1. <span data-ttu-id="a62d9-648">Įtraukite dvi prekybos užsakymo eilutes:</span><span class="sxs-lookup"><span data-stu-id="a62d9-648">Add two sales order lines:</span></span>

    - <span data-ttu-id="a62d9-649">Prekybos užsakymo linija 1:</span><span class="sxs-lookup"><span data-stu-id="a62d9-649">Sales order line 1:</span></span>

        - <span data-ttu-id="a62d9-650">**Prekės numeris:** *A0001*</span><span class="sxs-lookup"><span data-stu-id="a62d9-650">**Item number:** *A0001*</span></span>
        - <span data-ttu-id="a62d9-651">**Kiekis:** *9024*</span><span class="sxs-lookup"><span data-stu-id="a62d9-651">**Quantity:** *9024*</span></span>
        - <span data-ttu-id="a62d9-652">**Padalinys:** *ea* (9024 ea = 376 dėžė = 47 padėklai)</span><span class="sxs-lookup"><span data-stu-id="a62d9-652">**Unit:** *ea* (9024 ea = 376 Box = 47 PL)</span></span>

    - <span data-ttu-id="a62d9-653">Prekybos užsakymo linija 2:</span><span class="sxs-lookup"><span data-stu-id="a62d9-653">Sales order line 2:</span></span>

        - <span data-ttu-id="a62d9-654">**Prekės numeris:** *A0002*</span><span class="sxs-lookup"><span data-stu-id="a62d9-654">**Item number:** *A0002*</span></span>
        - <span data-ttu-id="a62d9-655">**Kiekis:** *9016*</span><span class="sxs-lookup"><span data-stu-id="a62d9-655">**Quantity:** *9016*</span></span>
        - <span data-ttu-id="a62d9-656">**Padalinys:** *ea* (9016 ea = 322 Box = 46 PL)</span><span class="sxs-lookup"><span data-stu-id="a62d9-656">**Unit:** *ea* (9016 ea = 322 Box = 46 PL)</span></span>

    > [!NOTE]
    > <span data-ttu-id="a62d9-657">Čia pateikiami objektai ir kiekiai yra tik pavyzdžiai.</span><span class="sxs-lookup"><span data-stu-id="a62d9-657">The items and quantities that are provided here are only examples.</span></span> <span data-ttu-id="a62d9-658">Jie privalo naudoti objekto sekos grupę, kurią nustatėte anksčiau, atitinkantys objekto pakeitimai iš *ea* į *Box* į *PL* turi būti jiems nustatyti ir jie privalo turėti prekių sandėlyje  *62*.</span><span class="sxs-lookup"><span data-stu-id="a62d9-658">They must use the unit sequence group that you defined earlier, appropriate unit conversions from *ea* to *Box* to *PL* must be defined for them, and they must have stock in warehouse *62*.</span></span> <span data-ttu-id="a62d9-659">Dėl platesnės informacijos, žr. [Matavimo vienetas ir sandėliavimo politika](unit-measure-stocking-policies.md).</span><span class="sxs-lookup"><span data-stu-id="a62d9-659">For more information, see [Unit of measure and stocking policies](unit-measure-stocking-policies.md).</span></span>

1. <span data-ttu-id="a62d9-660">Pasirinkite prekybos užsakymo liniją 1:</span><span class="sxs-lookup"><span data-stu-id="a62d9-660">Select sales order line 1.</span></span> <span data-ttu-id="a62d9-661">Vėliau **Prekybos užsakymo linijos** skyriuje, **Inventoriaus** meniu, pasirinkite **Rezervacijos**.</span><span class="sxs-lookup"><span data-stu-id="a62d9-661">Then, in the **Sales order line** section, on the **Inventory** menu, select **Reservations**.</span></span>
1. <span data-ttu-id="a62d9-662">**Rezervacijos** puslapyje, veiksmų juostoje pasirinkite **Rezervuoti vietą** ir tuomet uždarykite puslapį.</span><span class="sxs-lookup"><span data-stu-id="a62d9-662">On the **Reservation** page, on the Action Pane, select **Reserve lot**, and then close the page.</span></span>
1. <span data-ttu-id="a62d9-663">Pakartokite 4 ir 5 žingsnius kiekvienai prekybos užsakymo eilutei 2.</span><span class="sxs-lookup"><span data-stu-id="a62d9-663">Repeat steps 4 and 5 for sales order line 2.</span></span>
1. <span data-ttu-id="a62d9-664">Veiksmų srities skirtuke **Sandėlis** pasirinkite **Išleisti į sandėlį**.</span><span class="sxs-lookup"><span data-stu-id="a62d9-664">On the Action Pane, on the **Warehouse** tab, select **Release to warehouse**.</span></span>

    <span data-ttu-id="a62d9-665">Atsitinka šis įvykis:</span><span class="sxs-lookup"><span data-stu-id="a62d9-665">The following events occur:</span></span> 

    - <span data-ttu-id="a62d9-666">Sistema apdoroja sukurtą siuntimą naudodama šabloną apimantį žymos spausdinimo žingsnį.</span><span class="sxs-lookup"><span data-stu-id="a62d9-666">The system processes the created shipment by using the template that includes the label printing step.</span></span> <span data-ttu-id="a62d9-667">Žymos maketas bus naudojamas nustatant žymos formatą ir galutinis rezultatas bus žymė turinti penkias eilutes ir ji yra atspausdinta spausdintuve pasirinktame žymos šablone.</span><span class="sxs-lookup"><span data-stu-id="a62d9-667">The label layout will be used to define the format of the label, and the result will be a label that is printed on the printer that is selected in the label template.</span></span>
    - <span data-ttu-id="a62d9-668">Bangos žymės yra sukuriamos ir atspausdinamos.</span><span class="sxs-lookup"><span data-stu-id="a62d9-668">Wave labels are generated and printed.</span></span> <span data-ttu-id="a62d9-669">Žymių skaičius bus lygus dėžių skaičiui (pavyzdžiui, šiuo atveju 376 dėžės žymai eilutėje 1, 322 dėžės žymei linijoje 2, 47 padėklai žymos linijoje 1, 47 padėklai žymos linijoje 2 ir dvi tarpų žymos turinčios siuntimo identifikavimo kodą).</span><span class="sxs-lookup"><span data-stu-id="a62d9-669">The number of labels will equal the number of cartons (in this example, 376 Box labels for line 1, 322 Box labels for line 2, 47 PL labels for line 1, 47 PL labels for line 2, and two break labels that have the shipment ID).</span></span>
    - <span data-ttu-id="a62d9-670">Naujas važtaraščio identifikavimo kodas yra sukuriamas siuntoms.</span><span class="sxs-lookup"><span data-stu-id="a62d9-670">A new bill of lading ID is generated for the shipments.</span></span> <span data-ttu-id="a62d9-671">Jei sukonfigūravote numerio sekos plėtinius, bangos žymos identifikavimo kodas seks **SSCC-18** numerio formatą.</span><span class="sxs-lookup"><span data-stu-id="a62d9-671">If you configured the number sequence extensions, the wave label IDs will follow the **SSCC-18** number format.</span></span> 

<span data-ttu-id="a62d9-672">Galite peržiūrėti ir iš naujo atspausdinti bangos etiketes tolesniuose puslapiuose:</span><span class="sxs-lookup"><span data-stu-id="a62d9-672">You can view and reprint wave labels from the following pages:</span></span>

- <span data-ttu-id="a62d9-673">Visi siuntimai \> Siuntimo informacija</span><span class="sxs-lookup"><span data-stu-id="a62d9-673">All shipments \> Shipment details</span></span>
- <span data-ttu-id="a62d9-674">Visi krovimai \> Krovimo informacija</span><span class="sxs-lookup"><span data-stu-id="a62d9-674">All loads \> Load details</span></span>
- <span data-ttu-id="a62d9-675">Visos bangos</span><span class="sxs-lookup"><span data-stu-id="a62d9-675">All waves</span></span>
- <span data-ttu-id="a62d9-676">Bangos žymės</span><span class="sxs-lookup"><span data-stu-id="a62d9-676">Wave labels</span></span>
- <span data-ttu-id="a62d9-677">Bangos žymos retrospektyva</span><span class="sxs-lookup"><span data-stu-id="a62d9-677">Wave label history</span></span>

<span data-ttu-id="a62d9-678">Didžiojoje dalyje šių puslapių, galite rasti atitinkamą funkciją pasirinkę **Bangos žymės**  **Susijusi informacija** grupėje **Siuntimai** skirtuke veiksmų juostoje.</span><span class="sxs-lookup"><span data-stu-id="a62d9-678">For most of these pages, you can find the relevant function by selecting **Wave labels** in the **Related information** group on the **Shipments** tab of the Action Pane.</span></span>

## <a name="additional-resources"></a><span data-ttu-id="a62d9-679">Papildomi ištekliai</span><span class="sxs-lookup"><span data-stu-id="a62d9-679">Additional resources</span></span>

- [<span data-ttu-id="a62d9-680">Pakartotinis bangos žymų spausdinimas ir anuliavimas</span><span class="sxs-lookup"><span data-stu-id="a62d9-680">Reprint and void wave labels</span></span>](reprint-and-void-wave-labels.md)
