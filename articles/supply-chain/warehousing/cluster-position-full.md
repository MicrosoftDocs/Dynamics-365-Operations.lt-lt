...
description: Šiame straipsnyje pateikiama informacija apie visas klasterio pareigų pareigas. Ši funkcija suteikia alternatyvą griežtesniam darbo paskirstymo taisyklių vykdymui, kai naudojamas klasterio paėmimas, nes ji leidžia didesnę konteinerių ar krepšių tūrinių apribojimų paklaidos ribą.
author: Mirzaab
ms.date: 08/25/2020
ms.topic: article
ms.prod: ''
