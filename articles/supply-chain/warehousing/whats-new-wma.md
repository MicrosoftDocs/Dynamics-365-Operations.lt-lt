...
Šioje versijoje pristatomos toliau pateiktos naujos funkcijos, klaidų taisymai ir patobulinimai:
- Išsamskite problemą, Android dėl kurios programa sutrins, jei **būtų** atidarytas darbų sąrašo puslapis, kai nebus rodomos jokios kortelės.
...
- Fiksuotos kelios gedimo problemos.
- Išsami problema, kai darbų sąrašo puslapio kortelėse bus rodomos **neteisingos** vertės.
- Patobulinta slinkimo patirtis ir pašalintas slinkties jitter darbų **sąrašo ir** **prekės užklausos** puslapiuose, kurie yra Android.
- Prie prisijungimo puslapio, kuris išjungė programą, pridėtas išėjimo mygtukas.
