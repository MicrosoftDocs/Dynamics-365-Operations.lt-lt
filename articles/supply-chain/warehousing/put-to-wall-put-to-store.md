...
- <span data-ttu-id="65a7f-124">**Modulis:** *Sandėlio valdymas*</span><span class="sxs-lookup"><span data-stu-id="65a7f-124">**Module:** *Warehouse management*</span></span>
...
1. <span data-ttu-id="65a7f-141">Pasirinkite **Sandėlio valdymas \> Nustatymas \> Sandėlys \> Vietos profiliai**.</span><span class="sxs-lookup"><span data-stu-id="65a7f-141">Go to **Warehouse management \> Setup \> Warehouse \> Location profiles**.</span></span>
...
### <a name="packing-profiles"></a><span data-ttu-id="65a7f-161">Pakavimo šablonai</span><span class="sxs-lookup"><span data-stu-id="65a7f-161">Packing profiles</span></span>
...
### <a name="outbound-sorting-template"></a><span data-ttu-id="65a7f-179">Siuntimo rūšiavimo šablonas</span><span class="sxs-lookup"><span data-stu-id="65a7f-179">Outbound sorting template</span></span>
...
1. <span data-ttu-id="65a7f-196">„FastTab“ skirtuke **Bendra** nustatykite šias reikšmes:</span><span class="sxs-lookup"><span data-stu-id="65a7f-196">On the **General** FastTab, set the following values:</span></span>
    ...
    - <span data-ttu-id="65a7f-211">**Priskirti rūšiavimo vietos kriterijus:** *Naudoti tik tuščias padėtis*</span><span class="sxs-lookup"><span data-stu-id="65a7f-211">**Assign sort position criteria:** *Only use empty position*</span></span>
        ...
        - <span data-ttu-id="65a7f-214">**Naudoti tik tuščią padėtį** – Inventorių jau turinčios ir su juo susietos padėtys bus priimtos domėn</span><span class="sxs-lookup"><span data-stu-id="65a7f-214">**Only use empty position** – Positions that already have inventory associated with them will be taken into account</span></span>
...
1. <span data-ttu-id="65a7f-229">Veiksmų juostoje pasirinkite **Redaguoti užklausą** tam, kad nurodytumėte kriterijus naudojamus šiam rūšiavimo šablonui.</span><span class="sxs-lookup"><span data-stu-id="65a7f-229">On the Action Pane, select **Edit query** to specify the criteria that are used for this sorting template.</span></span>
...
### <a name="mobile-device-menu-items"></a><span data-ttu-id="65a7f-262">Mobiliojo įrenginio meniu elementai</span><span class="sxs-lookup"><span data-stu-id="65a7f-262">Mobile device menu items</span></span>
...
### <a name="location-directives"></a><span data-ttu-id="65a7f-283">Vietos nurodymai</span><span class="sxs-lookup"><span data-stu-id="65a7f-283">Location directives</span></span>
...
1. <span data-ttu-id="65a7f-303">Pasirinkite **Įrašyti,** kad būtų galima naudoti **Vietos nurodymų veiksmų** „FastTab“ skirtuką.</span><span class="sxs-lookup"><span data-stu-id="65a7f-303">Select **Save** to make the **Location Directive Actions** FastTab available.</span></span>
...
### <a name="work-templates"></a><span data-ttu-id="65a7f-321">Darbo šablonai</span><span class="sxs-lookup"><span data-stu-id="65a7f-321">Work templates</span></span>
...
1. <span data-ttu-id="65a7f-336">**Darbo šablono informacijos** skyriuje sukursti dvi eilutes.</span><span class="sxs-lookup"><span data-stu-id="65a7f-336">In the **Work Template Details** section, you will create two lines.</span></span> <span data-ttu-id="65a7f-337">Pasirinkite **Naujas** ir tuomet nustatykite tolesnes vertes eilutei 1:</span><span class="sxs-lookup"><span data-stu-id="65a7f-337">Select **New**, and then set the following values for line 1:</span></span>
    ...
    - <span data-ttu-id="65a7f-338">**Darbo tipas:** *Paėmimas*</span><span class="sxs-lookup"><span data-stu-id="65a7f-338">**Work type:** *Pick*</span></span>
...
### <a name="create-demand"></a><span data-ttu-id="65a7f-355">Kurti paklausą</span><span class="sxs-lookup"><span data-stu-id="65a7f-355">Create demand</span></span>
...
1. <span data-ttu-id="65a7f-373">Pasirinkite **Įtraukti eilutę** antrai eilutei įtraukti ir nustatykite šias reikšmes:</span><span class="sxs-lookup"><span data-stu-id="65a7f-373">Select **Add line** to add a second line, and set the following values:</span></span>
...
1. <span data-ttu-id="65a7f-392">Pakartokite tolesnius žingsnius kiekvienai prekybos eilutei užsakyme tam, kad rezervuotumėte jam inventorių:</span><span class="sxs-lookup"><span data-stu-id="65a7f-392">Repeat the following steps for each sales line on the order to reserve inventory for it:</span></span>
...
1. <span data-ttu-id="65a7f-412">Pasirinkite **Pardavimas ir rinkodara \> Pardavimo užsakymai \> Visi pardavimo užsakymai**.</span><span class="sxs-lookup"><span data-stu-id="65a7f-412">Go to **Sales and marketing \> Sales orders \> All sales orders**.</span></span>
...
1. <span data-ttu-id="65a7f-448">Patvirtinkite pirmą paėmimo darbą.</span><span class="sxs-lookup"><span data-stu-id="65a7f-448">Confirm the first pick work.</span></span>
...
1. <span data-ttu-id="65a7f-464">Sistema nusprendža, jurią rūšiavimo vietą reikia rodyti pirmiausiai.</span><span class="sxs-lookup"><span data-stu-id="65a7f-464">The system determines the first sort position that should be shown.</span></span> <span data-ttu-id="65a7f-465">Patvirtinkite rūšiavimo padėtį.</span><span class="sxs-lookup"><span data-stu-id="65a7f-465">Confirm the sort position.</span></span>
1. <span data-ttu-id="65a7f-466">Būsite paskatinti priskirti licencijos numerį rūšiavimo vietai.</span><span class="sxs-lookup"><span data-stu-id="65a7f-466">You're prompted to assign a license plate to the sort position.</span></span> <span data-ttu-id="65a7f-467">Pasirinkite **LP** laukelį ir įveskite licencijos numerį ir tuomet patvirtinkite savo įrašą.</span><span class="sxs-lookup"><span data-stu-id="65a7f-467">Select the **LP** field, enter a license plate number, and then confirm your entry.</span></span>

    <span data-ttu-id="65a7f-468">Kadangi rūšiavimo padėtis yra susieta su siuntimo identifikavimo kodu, jūs rūšiuosite paimtus objektus į licencijos numerį, nurodytą siunčiamame siuntime ir prekybos užsakyme.</span><span class="sxs-lookup"><span data-stu-id="65a7f-468">Because the sort position is related to the shipment ID, you will sort the picked items into a license plate that is specific to the outbound shipment and sales order.</span></span>

    <span data-ttu-id="65a7f-469">Kitas puslapis rodo objekto identifikavimo numerį, kokybę, rūšiavimo padėties identifikavimo numerį ir iš kur (paėmimas) į kur (rūšiavimas) licencijos numerio identifikavimo kodus.</span><span class="sxs-lookup"><span data-stu-id="65a7f-469">The next page shows the item ID, quantity, sort position ID, and the "from" (picking) and "to" (sorting) license plate IDs.</span></span> <span data-ttu-id="65a7f-470">Informacija šiame puslapyje aiškina jums, kaip rūšiuoti konkrečius objektus ir kiekius iš paėmimo licencijos numerio į rūšiavimo licencijos numerį.</span><span class="sxs-lookup"><span data-stu-id="65a7f-470">The information on this page instructs you to sort the specified item and quantities from the picking license plate into the sorting license plate.</span></span>

1. <span data-ttu-id="65a7f-471">Patvirtinkite rūšiavimo padėtį.</span><span class="sxs-lookup"><span data-stu-id="65a7f-471">Confirm the sort position.</span></span>
1. <span data-ttu-id="65a7f-472">Rūšiuokite objektus į pirmą rūšiavimo padėtį.</span><span class="sxs-lookup"><span data-stu-id="65a7f-472">Sort the items in the first sort position.</span></span> <span data-ttu-id="65a7f-473">Kai pabaigėte, sistema nukreips jus į kitą rūšiavimo padėtį.</span><span class="sxs-lookup"><span data-stu-id="65a7f-473">When you've finished, the system directs you to the next sort position.</span></span>
1. <span data-ttu-id="65a7f-474">Pakartokite šią procedūrą visoms paimtoms eilutėms darbo užsakyme.</span><span class="sxs-lookup"><span data-stu-id="65a7f-474">Repeat this process for all picked lines on the work order.</span></span> <span data-ttu-id="65a7f-475">Taip pat turėtumėte naudoti šį procesą, kai esama kelių paėmimo eilučių, kurios turi tą patį objekto numerį.</span><span class="sxs-lookup"><span data-stu-id="65a7f-475">You should also use this process when there are multiple pick lines that have the same item number.</span></span>

    <span data-ttu-id="65a7f-476">Kartojant šį procesą su visais objektais, sistema vertina kriterijus iš nuskaityto kito objekto (darbo linijos) ir nusprendžia, kuris rūšiavimo padėtis turi būti padėta.</span><span class="sxs-lookup"><span data-stu-id="65a7f-476">As you repeat this process for all items, the system evaluates the criteria from the next scanned item (work line) and determines which sorting position it should be put to.</span></span> <span data-ttu-id="65a7f-477">Jūs automatiškai nukreipiami tam, kad padėtumėte objektą į tinkamą rūšiavimo padėtį.</span><span class="sxs-lookup"><span data-stu-id="65a7f-477">You're automatically directed to put the item to the correct sort position.</span></span> <span data-ttu-id="65a7f-478">Priklausomai nuo patvirtinimo nustatymų, esate nukreiptas patvirtinti šį veiksmą įvedant padėties numerį ar licencijos numerio identifikavimo kodą.</span><span class="sxs-lookup"><span data-stu-id="65a7f-478">Depending on the confirmation setup, you're also directed to confirm this action by entering the position number or license plate ID.</span></span>

    > [!NOTE]
    > <span data-ttu-id="65a7f-479">Jei įjungtas automatinis rūšiavimas, rankinis pakeitimas nėra galimas.</span><span class="sxs-lookup"><span data-stu-id="65a7f-479">If automatic sorting is turned on, manual override isn't available.</span></span>

1. <span data-ttu-id="65a7f-480">Kai baigėte, „Microsoft Dynamics 365 Supply Chain Management“, atidarykite **Siuntimo rūšiavimo padėties priskyrimo** puslapį, kad peržiūrėtumėte padėčių būseną.</span><span class="sxs-lookup"><span data-stu-id="65a7f-480">When you've finished, in Microsoft Dynamics 365 Supply Chain Management, open the **Outbound sorting position assignments** page to review the status of the positions.</span></span>

    - <span data-ttu-id="65a7f-481">Jei padėtys yra uždaromos automatiškai, pasirinkite **Rodyti uždarytas** tam, kad rodytumėte uždarytas padėtis.</span><span class="sxs-lookup"><span data-stu-id="65a7f-481">If positions are closed automatically, select **Show closed** to show the closed positions.</span></span>
    - <span data-ttu-id="65a7f-482">Atkreipkite dėmesį, kad yra rodomi rūšiavimo padėties pervedimai.</span><span class="sxs-lookup"><span data-stu-id="65a7f-482">Notice that sort position transactions are shown.</span></span> <span data-ttu-id="65a7f-483">Apdorotas objektas ir kiekis yra apdorojami per rodomas padėtis.</span><span class="sxs-lookup"><span data-stu-id="65a7f-483">The item and quantity that were processed through the position are shown.</span></span>

    <span data-ttu-id="65a7f-484">Kai nustatote siunčiamo rūšiavimo šabloną, nustatote **Automatinio uždarymo rūšiavimo padėties** parinktį į *Taip*.</span><span class="sxs-lookup"><span data-stu-id="65a7f-484">When you set up the outbound sorting template, you set the **Auto close sort position** option to *Yes*.</span></span> <span data-ttu-id="65a7f-485">Dėl to, padėtis yra automatiškai uždaroma po to, kai paskutinis tikėtinas intventorius yra patalpintas.</span><span class="sxs-lookup"><span data-stu-id="65a7f-485">Therefore, the position is automatically closed after the last expected inventory is put to it.</span></span> <span data-ttu-id="65a7f-486">Rūšiavimo padėtyes yra **Uždarytos** būsenoje ir darbas buvo sukurtas tam, kad perkeltų rūšiuotą inventorių į *Baydoor* vietą.</span><span class="sxs-lookup"><span data-stu-id="65a7f-486">The sort positions are in **Closed** status, and work has been created to move the sorted inventory to *Baydoor* location.</span></span>

1. <span data-ttu-id="65a7f-487">Pabaikite rūšiuoto inventoriaus paėmimo darbą tam, kad perkeltumėte inventorių į siuntimo vietą.</span><span class="sxs-lookup"><span data-stu-id="65a7f-487">Complete the sorted inventory picking work to move the inventory to the shipping location.</span></span> <span data-ttu-id="65a7f-488">Kai inventorius yra paruoštas, patvirtinkite jo siuntimą.</span><span class="sxs-lookup"><span data-stu-id="65a7f-488">When the inventory is ready, ship-confirm it.</span></span>

> [!NOTE]
> <span data-ttu-id="65a7f-489">Rūšiuoto inventoriaus paėmimo darbo tinkamam apdorojimui, mobilaus prietaiso meniu objektas turi darbo klasės identifikavimo kodą, kuriame **Darbo tvarkos tipo** laukelis yra nustatytas *Rūšiuoto inventoriaus paėmimas* ir turi būti naudojamas judėjimo ir krovimo procedūroms.</span><span class="sxs-lookup"><span data-stu-id="65a7f-489">For sorted inventory picking work to be processed correctly, a mobile device menu item that has a work class ID where the **Work order type** field is set to *Sorted inventory picking* should be used for the movement and loading process.</span></span>

### <a name="manually-close-a-position-optional"></a><span data-ttu-id="65a7f-490">Rankiniu būdu uždarykite padėtį (pasirinktinai)</span><span class="sxs-lookup"><span data-stu-id="65a7f-490">Manually close a position (optional)</span></span>

<span data-ttu-id="65a7f-491">Jei rūšiavimo padėtys turi būti uždarytos rankiniu būdu, **Automatinio uždarymo rūšiavimo padėties** parinktis siunčiamo rūšiavimo šablonui turi būti nustatyta į *Ne* ir uždarymas turi būti atliktas prieš inventoriaus judėjimą į „bay door“ sritį.</span><span class="sxs-lookup"><span data-stu-id="65a7f-491">If sort positions should be closed manually, the **Auto close sort position** option for the outbound sorting template must be set to *No*, and closing must be done before inventory can be moved to the bay door area.</span></span> <span data-ttu-id="65a7f-492">Padėtys gali būti uždaromos įvariais būdais:</span><span class="sxs-lookup"><span data-stu-id="65a7f-492">Positions can be closed in various ways:</span></span>

- <span data-ttu-id="65a7f-493">Per sandėlio programą:</span><span class="sxs-lookup"><span data-stu-id="65a7f-493">Via the warehouse app:</span></span>

    - <span data-ttu-id="65a7f-494">Vartotojai gali nuskaityti vieną iš objektų, kurie jau yra padėtyje ir tuomet pasirinkti **Uždaryti** padėties uždarymui.</span><span class="sxs-lookup"><span data-stu-id="65a7f-494">The user can scan one of the items that are already on the position and then select **Close** to close the position.</span></span>
    - <span data-ttu-id="65a7f-495">Jei vartotojas nuskaito talpyklą, kuri jau buvo rūšiuota talpykloje, rodomas klaidos pranešimas.</span><span class="sxs-lookup"><span data-stu-id="65a7f-495">If the user scans a container that has already been sorted container, an error message is shown.</span></span> <span data-ttu-id="65a7f-496">Nepaisant to, vartotojas gali ir toliau tęsti padėties uždarymą.</span><span class="sxs-lookup"><span data-stu-id="65a7f-496">However, the user can still continue to close the position.</span></span>

- <span data-ttu-id="65a7f-497">„Microsoft Dynamics 365 Supply Chain Management“ **Siunčiamo rūšiavimo padėties priskyrimuose** puslapyje:</span><span class="sxs-lookup"><span data-stu-id="65a7f-497">From the Microsoft Dynamics 365 Supply Chain Management **Outbound sorting position assignments** page:</span></span>

    - <span data-ttu-id="65a7f-498">Vartotojai gali pasirinkti siunčiamo rūšiavimo padėties įrašą ir tuomet pasirinkti **Uždaryti padėtį** veiksmų juostoje.</span><span class="sxs-lookup"><span data-stu-id="65a7f-498">The user can select the outbound sorting position record and then select **Close position** on the Action Pane.</span></span>

## <a name="tips"></a><span data-ttu-id="65a7f-499">Patarimai</span><span class="sxs-lookup"><span data-stu-id="65a7f-499">Tips</span></span>

- <span data-ttu-id="65a7f-500">Objektus galima judinti tarp padėčių po to, kai jie buvo vienai priskirti.</span><span class="sxs-lookup"><span data-stu-id="65a7f-500">Items can't be moved between positions after they have been assigned to one.</span></span> <span data-ttu-id="65a7f-501">Sistema įvertina, kiek kiekvieno objekto vienetų turėtų eiti į konkrečią padėtį.</span><span class="sxs-lookup"><span data-stu-id="65a7f-501">The system evaluates how many of each item should go to a specific position.</span></span>
- <span data-ttu-id="65a7f-502">Rūšiavimo šablonas gali būti kofigūruojamas automatiškai sukurti talpyklas, kai padėtys yra uždarytos.</span><span class="sxs-lookup"><span data-stu-id="65a7f-502">Sorts template can be configured to automatically create containers when positions are closed.</span></span> <span data-ttu-id="65a7f-503">Šis požiūris sukurs standartinės talpyklos identifikavimo kodo strukūtrą, kuri paremta konkrečiu pakavim profiliu.</span><span class="sxs-lookup"><span data-stu-id="65a7f-503">This approach will create standard container ID structure that is based on the specified packing profile.</span></span>

> [!IMPORTANT]
> <span data-ttu-id="65a7f-504">Po to, kai judėjimo darbas yra sukurti pagal rūšiavimo vietą, privalote neatšaukti darbo.</span><span class="sxs-lookup"><span data-stu-id="65a7f-504">After movement work has been created from the sorting location, you must not cancel the work.</span></span> <span data-ttu-id="65a7f-505">Kitu atveju, pozicija ir talpyklos jame bus pašalintos iš sistemos ir neprieinamos tolesniam apdorojimui.</span><span class="sxs-lookup"><span data-stu-id="65a7f-505">Otherwise, the position and the containers in it will be deleted from the system and unavailable for further processing.</span></span> <span data-ttu-id="65a7f-506">Inventorius taip pat bus pašalintas.</span><span class="sxs-lookup"><span data-stu-id="65a7f-506">The inventory will also be removed.</span></span>
