...
description: Šiame straipsnyje pateikiama scenarijų, kai į sandėlį išleidžiami keli užsakymai, o tada konsoliduojami vėliau naudojant puslapį Konsoliduoti siuntas.
author: Mirzaab
ms.date: 05/12/2020
ms.topic: article
ms.prod: ''
...
Šiame straipsnyje pateikiama scenarijų, kai į sandėlį išleidžiami **keli užsakymai, o tada konsoliduojami vėliau naudojant puslapį Konsoliduoti siuntas**.
