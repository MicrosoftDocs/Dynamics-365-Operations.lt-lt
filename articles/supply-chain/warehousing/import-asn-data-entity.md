...
> [!IMPORTANT]
> *Gaunamas ASN importas* taikomas tik prekėms, kurios įgalintos sandėlio valdymo procesams (WMS). Prieš gaudami ASN, sistemoje turi būti užregistruotas pirkimo užsakymas pagal tiekėją, kuris siunčia tą ASN.
