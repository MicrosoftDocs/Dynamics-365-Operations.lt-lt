...
1. Eikite į **Aptarnavimo valdymas** \> **Sąranka** \> **Aptarnavimo sutartys** \> **Aptarnavimo sutarčių grupės**.
2. Paspaudę **Alt+N** sukursite naują aptarnavimo sutarčių grupę.
3. Lauke **Aptarnavimo sutarčių grupė** įveskite aptarnavimo sutarčių grupės ID.
4. Lauke **Aprašas** įveskite aptarnavimo sutarčių grupės aprašą.
5. Uždarę puslapį įrašysite savo pakeitimus.
