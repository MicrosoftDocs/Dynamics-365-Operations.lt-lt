...
## <a name="group-by-geographical-location"></a>Grupavimas pagal geografinę vietovę
...
Sukurkite grupes, kurioms galite priskirti aptarnavimo objektus. Aptarnavimo objektai – tai atsargų prekės ir kiti produktai, kuriems teikiamos aptarnavimo paslaugos. Grupuodami aptarnavimo objektus galite kurti panašių ir susijusių aptarnavimo objektų ataskaitas. Pavyzdžiui, aptarnavimo objektų grupę gali sudaryti du aptarnavimo objektai: vienas aptarnavimo objektas yra rinkinys, o kitas – rinkinio diegimo paslauga.

Norėdami kurti aptarnavimo objektų grupes, atlikite šiuos veiksmus:

1. Spustelėkite **Aptarnavimo valdymas > Sąranka > Aptarnavimo objektai > Aptarnavimo objektų grupės**.

2. Spustelėję **Nauja** sukurkite naują aptarnavimo objektų grupę.

3. Įveskite unikalų aptarnavimo objektų grupės pavadinimą ir, pasirinktinai, aprašą.

Naudodamiesi forma **Aptarnavimo objektai** galite priskirti aptarnavimo objektus grupei. 
