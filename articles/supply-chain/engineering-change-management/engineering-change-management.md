...
description: Šiame straipsnyje pateikiama informacija apie inžinerinių pakeitimų valdymą. Inžinerinių keitimų valdymas suteikia struktūruotus procesus inžinerinių produktų valdymo keitimams, nuo siūlymo, užklausų ir keitimų atlikimo iki peržiūros ir keitimų patvirtinimo, jų poveikio vertinimo esančioms perlaidoms ir jų sekimo.
author: t-benebo
ms.date: 09/28/2020
ms.topic: article
ms.prod: ''
