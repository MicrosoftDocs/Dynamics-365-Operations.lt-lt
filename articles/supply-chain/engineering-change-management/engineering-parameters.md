...
description: Šiame straipsnyje paaiškinama, kaip konfigūruoti "Microsoft" inžinerinių pakeitimų valdymo funkcijas Dynamics 365 Supply Chain Management.
author: t-benebo
ms.date: 09/28/2020
ms.topic: article
ms.prod: ''
...
Siekiant atverti **Inžinerijos keitimo valdymo parametrų** puslapį, eikite į **Inžinerijos keitimo valdymas \> Nustatymai \> Inžinerijos keitimo valdymo parametrai**. Tada galite nustatyti laukus, kaip aprašyta likusiuose šio straipsnio skyriuose.
