...
description: Šiame straipsnyje pateikta Integravimo su apžvalga Microsoft Dynamics 365 Field Service.
author: Henrikan
ms.date: 07/25/2019
ms.topic: overview
ms.prod: ''
...
![„Supply Chain Management“ ir „Field Service“ verslo procesų sinchronizavimas, įskaitant atsargų ir projekto informaciją.](./media/FSv2overview.png)
...
- "Dynamics 365 Finance and Operations" 8.1.2 versija (2018 m. gruodžio mėn.) buvo išleista 2018 m. gruodžio mėn. ir turi programos versijos numerį 8.1.195 Platform update 22 (7.0.5095). 
