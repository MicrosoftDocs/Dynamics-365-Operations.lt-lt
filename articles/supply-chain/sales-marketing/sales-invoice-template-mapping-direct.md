...
description: Šiame straipsnyje aptariamos šablonai ir susijusios Dynamics 365 Supply Chain Management užduotys, naudojamos pardavimo SF antraštėms ir eilutėms sinchronizuoti tiesiogiai iš "Dynamics 365" pardavimo.
author: Henrikan
ms.date: 10/26/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9103282"
---
# <a name="synchronize-sales-invoice-headers-and-lines-directly-from-finance-and-operations-to-sales"></a>Sinchronizuoti pardavimo SF antraštes ir eilutes tiesiogiai iš finansų ir operacijų į Pardavimą

[!include [banner](../includes/banner.md)]

Šiame straipsnyje aptariamos šablonai ir susijusios Dynamics 365 Supply Chain Management užduotys, naudojamos pardavimo SF antraštėms ir eilutėms sinchronizuoti tiesiogiai iš "Dynamics 365" pardavimo.
