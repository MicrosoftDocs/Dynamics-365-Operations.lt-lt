...
Šioje temoje pristatomos funkcijos, kurios yra naujos arba pakeistos „Microsoft Dynamics 365 Supply Chain Management“ 10.0.23 peržiūros versijoje. Šios versijos komponavimo numeris yra 10.0.1037 ir jis pasiekiamas tokius būdu:
...
| Pardavimas ir rinkodara | Valyti pardavimo užsakymo atnaujinimų istoriją | Ši funkcija leidžia išvalyti laikinus retrospektyvinius įrašus, susijusius su pardavimo užsakymo atnaujinimais. Ji įtraukia naują mygtuką, vadinamą **Valyti pardavimo atnaujinimo retrospektyvą** į pardavimo užsakymų išsamios informacijos ir sąrašo puslapių veiksmų sritį. |
...
| Bendrasis planavimas | [Saugos prekių atsargų įvykdymas](../master-planning/safety-stock-replenishment.md) dabar suteikia daugiau informacijos apie minimalų/maksimalų raktų naudojimą. |
| Bendrasis planavimas | [Atsargų prognozės](../master-planning/inventory-forecast.md) dabar pateikia daugiau informacijos apie prognozių paskirstymą. |
...
Norėdami gauti daugiau informacijos apie klaidų ištaisymus, įtrauktus į kiekvieną iš naujinimų, kurie yra 10.0.23 dalis, prisijunkite prie „Lifecycle Services“ (LCS) ir peržiūrėkite [KB straipsnį](https://fix.lcs.dynamics.com/Issue/Details?bugId=627874&dbType=3&qc=9b7e01944eb8b43f9c3aac4be26811c27be205847d6d2a240424f34f7e722910).
