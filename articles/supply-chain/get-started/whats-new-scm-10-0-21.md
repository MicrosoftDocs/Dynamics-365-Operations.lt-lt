...
**Perspėjimo pranešimas:** Scenarijaus [SetupDiagnostics] nepavyko įdiegti pagal VM

Diegimas veiks nepaisant įspėjimo, tačiau gali kilti tokių žinomų problemų Lifecycle Services (LCS):
...
| Atsargos&nbsp;ir&nbsp;logistika | [Nuskaityti brūkšninius kodus sandėlyje naudojant GS1 formato standartus](/dynamics365-release-plan/2021wave2/finance-operations/dynamics365-supply-chain-management/scan-barcodes-warehouse-using-gs1-format-standards) | *Jau greitai*<!-- KFM: Add doc link when ready. --> |
| Atsargos&nbsp;ir&nbsp;logistika | Užantspauduotas kainos pasiūlymas <!-- KFM: Add RP link when available --> | *Jau greitai*<!-- KFM: Add doc link when ready. --> |
...
| Atsargos&nbsp;ir&nbsp;logistika | [Sandėlio programos veiksmo instrukcijos](/dynamics365-release-plan/2021wave2/finance-operations/dynamics365-supply-chain-management/warehouse-management-mobile-app-step-instructions) | *Jau greitai*<!-- KFM: Add doc link when ready --> |
...
| Bendrasis planavimas | (Peržiūros versija) Prioritetu pagrįstas planavimo optimizavimo MRP palaikymas | Ši planavimo optimizavimo peržiūros funkcija įgalina pagrindinį planavimą, remiantis planavimo prioritetu, perdavimu. Paryškinti pakeitimai apima: **Planavimo prioriteto** laukas pardavimo užsakymo eilutes, pirkimo užsakymo eilutes, poreikio prognozes ir suplanuotus užsakymus; naują padengimo kodo pasirinktį; **Prekės padengimo** lauką, skirtas užsakymo taškui; Pagrindinio planavimo nustatymo formas, kurios kontroliuoja planavimo prioritetų nustatymą; ir Planavimo optimizavimo skaičiavimo logiką, nustatyti ir paisyti planavimo prioritetą. |
