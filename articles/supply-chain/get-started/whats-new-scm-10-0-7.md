...
---
# <a name="whats-new-and-changed-in-dynamics-365-supply-chain-management-1007-january-2020"></a>Kas nauja ir pasikeitė „Dynamics 365 Supply Chain Management” 10.0.7 (2020 m. sausio mėn.)

[!include [banner](../includes/banner.md)]


Šioje temoje aprašomos naujos ir pakeistos „Microsoft Dynamics 365 Supply Chain Management“ 10.0.7 funkcijos. Šios versijos komponavimo numeris yra 10.0.283 ir jis pasiekiamas tokius būdu:

- Peržiūros leidimo data yra 2019 m. spalio mėn.
- Bendro pasiekiamumo (automatinio naujinimo) data yra 2019 m. lapkričio mėn.
- Automatinio naujinimo data yra 2020 m. sausio mėn. 

Daugiau informacijos apie versiją 10.0.7 žr. [Papildomi ištekliai](whats-new-scm-10-0-7.md#additional-resources).
...
### <a name="platform-update-31"></a>Platformos „update 31“
„Microsoft Dynamics 365 Supply Chain Management“ 10.0.7 sudaro platformos 31 naujinimas. Norėdami daugiau sužinoti apie platformos 31 naujinimą, žr. [Kas nauja ir pakeista platformos 31 naujinime](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-update-31.md).
