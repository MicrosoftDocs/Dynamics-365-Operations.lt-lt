...
description: Šiame straipsnyje paaiškinami turto valdymo priežiūros planai.
...
- Naują priežiūros plano intervalo tipą, pavadintą *Pakartoti sukauptai vertei (tik skaitiklis)*. Šis tipas suaktyvina priežiūrą kiekvieną kartą, kai bendras skaitiklis pakartotinai pasiekia konkrečią vertę. Pavyzdžiui, priežiūra gali būti suaktyvinta kas 10 000 valandų. Norėdami gauti daugiau informacijos, žr. anksčiau [šiame straipsnyje skyriuje](#interval-types) Intervalo tipų peržiūra.
