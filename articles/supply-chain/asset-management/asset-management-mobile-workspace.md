...
description: Šiame straipsnyje pateikiama informacija apie turto valdymo mobiliąją darbo sritį.
...
Šiame straipsnyje pateikiama informacija apie turto valdymo **mobiliąją** darbo sritį. Ši darbo sritis leidžia vartotojams peržiūrėti ir kurti priežiūros užklausas bei darbo užsakymus. Be to, vartotojai gali peržiūrėti priskirtas darbo užsakymo užduotis kalendoriuje arba sąrašo rodinyje. Taip pat galima peržiūrėti ir ieškoti turto ir funkcinių vietų.

## <a name="overview"></a>Apžvalga

Turto valdymas yra išplėstinis modulis, skirtas turtui ir darbo užsakymų užduotims valdyti programoje „Dynamics 365 Supply Chain Management“. Mobilioji darbo sritis **Turto valdymas** leidžia vartotojams greitai peržiūrėti priskirtas darbo užsakymo užduotis savo pasirinktame mobiliajame įrenginyje. Vartotojai taip pat gali kurti ir valdyti priežiūros užklausas, atnaujinti ciklo būseną ir peržiūrėti turtą bei funkcinės vietos informaciją, naudodami mobilųjį įrenginį.

Tiksliau sakant, naudodami mobiliąją darbo sritį **Turto valdymas** vartotojai gali atlikti toliau nurodytas užduotis.

- Kurti, peržiūrėti ir redaguoti priežiūros užklausas, fotografuoti arba pridėti esamą atvaizdą į priežiūros užklausą, keisti priežiūros užklausos ciklo būseną. 
- Kurti, peržiūrėti ir redaguoti darbo užsakymus, fotografuoti arba pridėti esamą atvaizdą į darbo užsakymą, keisti darbo užsakymo ciklo būseną, peržiūrėti darbo užsakymo užduotis.
- Peržiūrėti priskirtas darbo užsakymo užduotis kalendoriaus rodinyje.
