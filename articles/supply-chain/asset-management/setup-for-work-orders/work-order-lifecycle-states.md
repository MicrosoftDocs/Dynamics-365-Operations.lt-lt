...
10. Skyriaus **Projektas** parinktį **Uždaryti veiklas** nustatykite kaip **Taip**, jei, darbo užsakymui esant šios ciklo būsenos, turi būti automatiškai uždaromos projekto veiklos, susijusios su kiekviena darbo užsakymo užduotimi.
    ...
    > [!NOTE]
    > Norėdami rasti projekto veiklos, susijusios su darbo užsakymo užduotimi, numerį, **·** \> **pasirinkite Turto valdymo darbo užsakymai** \> **Visi** darbo užsakymai, **Aktyvūs** **darbo užsakymai arba Mano aktyvūs darbo užsakymai.** Atidarykite darbo užsakymą ir pasirinkite darbo užsakymo užduotį. Veiklos numeris rodomas „FastTab“ konteinerio **Eilutės informacija** skirtuko **Bendra** skyriaus **Projektas** lauke **Veiklos numeris**.
...
>
> Tačiau, jei patys nustatote, kad darbo užsakymas būtų neaktyvus, su darbo užsakymu susiję, tačiau dar neužregistruoti žurnalai **nėra** automatiškai panaikinami. (Norėdami rankiniu būdu išjungti darbo užsakymą, pasirinkite **Turto valdymo darbo** \> **užsakymai Visi** \> **darbo užsakymai arba** Aktyvūs **darbo užsakymai.** Atidarykite darbo užsakymą ir rodinį perjunkite į **Antraštė**. „FastTab“ konteineryje **Bendra** pasirinkite **Redaguoti**, tada parinktį **Aktyvus** nustatykite kaip **Ne**.)
