...
2. Spustelėkite **Mažmeninė prekyba** &gt; **Kanalų sąranka** &gt; **Kanalų profiliai**.
    ...
    [![1 kanalo šablonas](./media/channel-profile1.png)](./media/channel-profile1.png)
...
3. Jūsų parduotuvės naudojamame MPOS skirtame kanalo šablone atnaujinkite lauką **Medijos pagrindinis URL**, įvesdami savo medijos serverio arba CDN pagrindinį URL. Pagrindas URL yra pirmoji URL dalis, kurią bendrai naudoja visi skirtingų objektų vaizdų aplankai.
    ...
    [![2 kanalo šablonas](./media/channel-profile2.png)](./media/channel-profile2.png)
...
3. „FasTab“ **Medijos kelias** įveskite likusį vaizdo vietos kelią. Medijos kelias palaiko **LanguageID** kaip kintamąjį. Pvz., demonstraciniams duomenims galite sukurti visų jūsų medijos serverio medijos pagrindinio URL katalogo vaizdų aplanką **Katalogas** (`https://testax3ret.cloud.test.dynamics.com/RetailServer/MediaServer`). Tada galite sukurti aplanką kiekvienai kalbai, pvz., en-US arba fr FR, ir į kiekvieną aplanką nukopijuoti atitinkamus vaizdus. Jei neturite skirtingų įvairių kalbų vaizdų, galite neįtraukti kintamojo **LanguageID** į aplanko struktūrą ir tiesiogiai nurodyti katalogų aplanką, kuriame yra katalogo vaizdai.
    ...
    > [!NOTE]
    > Dabartinė „Dynamics 365 for Retail“ versija palaiko objektų Katalogas, Produktas ir Kategorija atpažinimo ženklą **{LanguageId}**. (Nepalaikomas objektų Klientas ir Darbuotojas atpažinimo ženklas **{LanguageID}**, atsižvelgiant į esamą standartą, kuris galioja nuo „Microsoft Dynamics AX“ 6.x.)
...
9. Norint, kad katalogo vaizdų medijos šabloną atnaujintų kanalas, reikia paleisti užduotį **1150 katalogo užduotis** pasirinkus **Mažmeninės prekybos IT** &gt; **Paskirstymo grafikas**.
    ...
    [![1 katalogas](./media/catalog1.png)](./media/catalog1.png)
...
4. Peržiūrėję vaizdą ir atlikę reikiamus keitimus, paleiskite atitinkamos parduotuvės MPOS egzempliorių ir patikrinkite, ar rodomi katalogo vaizdai.
    ...
    [![4 katalogas](./media/catalog4.png)](./media/catalog4.png)
...
>
> [![prod.](./media/prods.png)](./media/prods.png)
...
4. „FastTab“ **Generuoti vaizdų URL. skirtus „Excel“** spustelėkite **Generuoti**.
    ...
    [![1 „Excel“](./media/excel1.jpg)](./media/excel1.jpg)
...
5. Spustelėkite **GERAI**. Dabar galite pamatyti naujo vaizdo rodinį ir nustatyti jį kaip numatytąjį vaizdą.
    ...
    [![3 kat.](./media/cat3.png)](./media/cat3.png)
...
7. Perjunkite MPOS į atjungties režimą. Turėtumėte matyti nusiųstą konkretaus produkto vaizdą HQ.
    ...
    [![1 neprisijungus](./media/offline1.png)](./media/offline1.png)
