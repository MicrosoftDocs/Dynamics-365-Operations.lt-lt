...
- Gaunant internetinės mažmeninės prekybos operacijų duomenis iš buveinės.
- Sinchronizuojant užsakymus, siekiant sukurti pardavimo užsakymus buveinėje.

Internetinės mažmeninės prekybos operacijų duomenų gavimas gali būti atliekamas rankiniu būdu paleidus gavimo užduotį arba sukuriant pasikartojančią paketinę užduotį.

### <a name="manually-running-the-p-job"></a>Gavimo užduoties vykdymas rankiniu būdu

1. Eikite į Visos darbo sritys > Mažmeninės prekybos IT.
...
3. Lauke Organizacijos hierarchija pasirinkite „Mažmeninės prekybos parduotuvės pagal regioną“.
