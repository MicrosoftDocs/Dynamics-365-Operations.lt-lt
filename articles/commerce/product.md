...
Produktų rekomendacijos yra transformuojanti verslo programa, apimanti visas prekybos rūšis ir sukurianti įdomų, patrauklų ir produktams pritaikytą apsipirkimą. Norėdami įdiegti šią funkciją EKA, atlikite veiksmus, atliktinus norint [įtraukti rekomendacijas į EKA įrenginius.](add-recommendations-control-pos-screen.md) 
