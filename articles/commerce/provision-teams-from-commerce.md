...
1. Įdiekite „Microsoft Teams PowerShell” modulį atlikdami skyriuje [„Microsoft Teams PowerShell” diegimas](https://docs.microsoft.com/microsoftteams/teams-powershell-install) nurodytus veiksmus.
...
1. Atlikite skyriuje [Jūsų komandos tikslinės hierarchijos nustatymas](https://docs.microsoft.com/microsoftteams/set-up-your-team-hierarchy) nurodytus veiksmus, kad įkeltumėte tikslinės hierarchijos CSV failą.
