...
description: Šiame straipsnyje aprašomi interaktyvių funkcijų moduliai ir aprašoma, kaip įtraukti juos į svetainės puslapius Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 05/18/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9284720"
---
# <a name="interactive-feature-module"></a>Interaktyvus funkcijos modulis

[!include [banner](includes/banner.md)]

Šiame straipsnyje aprašomi interaktyvių funkcijų moduliai ir aprašoma, kaip įtraukti juos į svetainės puslapius Microsoft Dynamics 365 Commerce.
