...
1. Dialogo lange **Naujas puslapio fragmentas** pasirinkite modulį **Reklaminė juosta**, tada dalyje **Puslapio fragmento pavadinimas** įveskite pavadinimą (pavyzdžiui, **Kelių kanalų juosta**). Tada pasirinkite **Gerai**.
...
1. Naujo puslapio vietoje **Pagrindinis** pasirinkite daugtaškį (**...**) ir **Įtraukti fragmentą**.
