...
1. Dialogo lange **Įtraukti modulį** pasirinkite modulį **Plytelių sąrašas**, o tada pasirinkite **Gerai**.
...
1. Vietoje **Plytelių sąrašas** pasirinkite daugtaškio mygtuką (**...**), o tada – **Įtraukti modulį**.
1. Dialogo lange **Įtraukti modulį** pasirinkite modulį **Plytelės modulis**, o tada pasirinkite **Gerai**.
