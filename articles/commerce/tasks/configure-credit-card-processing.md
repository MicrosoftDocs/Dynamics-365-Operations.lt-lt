...
## <a name="view-a-list-of-payment-providers"></a>Mokėjimo paslaugų teikėjų sąrašo peržiūra
1. Pasirinkite Gautinos sumos > Mokėjimų sąranka > Mokėjimo tarnybos.
2. Spustelėkite Peržiūrėti galimus teikėjus.

## <a name="configure-payment-account"></a>Sukonfigūruoti mokėjimo sąskaitas
1. Spustelėkite Naujas.
2. Lauke Mokėjimo tarnyba įveskite reikšmę.
3. Lauke Mokėjimo jungtis pasirinkite parinktį.
4. Perjunkite sekcijos Mokėjimo sąskaitos suma išplėtimą.
5. Lauke Aplinka: įveskite „PROD“.
6. Spustelėkite Kredito kortelių tipai.
7. Lauke Mokėjimo žurnalas spustelėkite išplečiamąjį mygtuką, kad atidarytumėte peržvalgą.
8. Sąraše spustelėkite saitą pasirinktoje eilutėje.
9. Spustelėkite Pridėti.
10. Lauke Valiuta surinkite reikšmę.
11. Sąraše raskite ir pasirinkite norimą įrašą.
12. Lauke Mokėjimo žurnalas spustelėkite išplečiamąjį mygtuką, kad atidarytumėte peržvalgą.
13. Sąraše spustelėkite saitą pasirinktoje eilutėje.
14. Spustelėkite Pridėti.
15. Lauke Valiuta surinkite reikšmę.
16. Sąraše raskite ir pasirinkite norimą įrašą.
    * Galite pakartotinai taikyti šiuos veiksmus visų kitų tipų kortelėms.  
17. Lauke Mokėjimo žurnalas spustelėkite išplečiamąjį mygtuką, kad atidarytumėte peržvalgą.
18. Sąraše spustelėkite saitą pasirinktoje eilutėje.
19. Spustelėkite Pridėti.
20. Lauke Valiuta surinkite reikšmę.
21. Spustelėkite Įrašyti.
22. Uždarykite puslapį.
23. Spustelėkite Tikrinti.
