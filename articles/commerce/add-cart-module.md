...
1. Sukurkite fragmentą pavadinimu **Krepšelio fragmentas** ir į naują fragmentą įtraukite krepšelio modulį.
1. Į krepšelio modulį įtraukite antraštę.
1. Įtraukite parduotuvės parinkiklio modulį į krepšelio modulį.
1. Įrašykite fragmentą, baikite redagavimą, tada publikuokite fragmentą.
1. Sukurkite šabloną pavadinimu **Krepšelio šablonas** ir įtraukite ką tik sukurtą krepšelio fragmentą.
1. Įrašykite šabloną, baikite redagavimą, tada publikuokite šabloną.
1. Sukurkite puslapį, kuriame naudojamas naujasis šablonas.
1. Puslapį įrašykite ir peržiūrėkite.
1. Baikite redaguoti puslapį, tada jį paskelbkite.
