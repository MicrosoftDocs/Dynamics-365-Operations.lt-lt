...
description: Šiame straipsnyje aprašomas kategorijos puslapių papildymas Dynamics 365 Commerce.
author: v-chgri
ms.date: 04/14/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8856969"
---
# <a name="enrich-a-category-landing-page"></a>Papildyti kategorijos nukreipimo puslapį

[!include [banner](includes/banner.md)]

Šiame straipsnyje aprašomas kategorijos puslapių papildymas Dynamics 365 Commerce.
...
1. Puslapyje **Produktai** pasirinkite kategorijos, kurios kategorijos puslapį norite papildyti, pavadinimą. Pasirinktos kategorijos numatytasis kategorijos puslapis atidaromas puslapio rengyklėje.
2. Pasirinkite **Papildyti kategorijos puslapį**.
