...
description: Šiame straipsnyje aprašomi pirkimo dėžės moduliai ir aprašoma, kaip įtraukti juos į svetainės puslapius Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 05/18/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8863558"
---
# <a name="buy-box-module"></a>Pirkimo langelio modulis

[!include [banner](includes/banner.md)]

Šiame straipsnyje aprašomi pirkimo dėžės moduliai ir aprašoma, kaip įtraukti juos į svetainės puslapius Microsoft Dynamics 365 Commerce.
...
1. Pirkimo dėžės **media galerijai** parinkite elipsę (**...**), tada pasirinkite Pridėti **modulį**.
1. Dialogo lange **Pasirinkti modulius** pasirinkite medijų galerija **modulį**, tada pasirinkite **Gerai**.
1. Pirkimo dėžės **modulio parduotuvės** išrinkiklis pažymėkite elipsę (**...**), tada pasirinkite Įtraukti **modulį**.
...
1. Naujo šablono **dialogo** lange prie šablono **pavadinimo** įveskite **PDP šabloną** ir pasirinkite **Gerai**.
...
1. Dialogo lange **Pasirinkti fragmentą** pasirinkite sukurtą pirkimo lauko **fragmento fragmentą**, tada pasirinkite **Gerai**.
1. Pasirinkite **Išsaugoti**, tada – **Baigti redagavimą**, kad užregistruotumėte šabloną, o tada pasirinkite **Publikuoti**, kad publikuotumėte jį.
1. Eikite į **Puslapiai** ir pasirinkite **Naujas**, kad sukurtumėte naują puslapį.
1. Dialogo lange **Kurti naują puslapį** po Puslapio pavadinimas **įveskite** **PDP puslapį** ir pasirinkite **Pirmyn**.
1. Dalyje **Pasirinkti šabloną** pasirinkite **PDP šabloną**, tada pasirinkite **Pirmyn**.
