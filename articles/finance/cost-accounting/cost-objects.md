...
description: Analizuodami išlaidas ir norėdami nustatyti, kur nukreiptas išlaidų srautas, naudojate išlaidų elemento dimensijas. Išlaidų objekto dimensijas naudojate tada, kai norite nustatyti, kur reikia priskirti išlaidas. Šiame straipsnyje pateikiama informacija apie išlaidų objekto dimensijas.
author: AndersGirke
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
Analizuodami išlaidas ir norėdami nustatyti, kur nukreiptas išlaidų srautas, naudojate išlaidų elemento dimensijas. Išlaidų objekto dimensijas naudojate tada, kai norite nustatyti, kur reikia priskirti išlaidas. Šiame straipsnyje pateikiama informacija apie išlaidų objekto dimensijas.
