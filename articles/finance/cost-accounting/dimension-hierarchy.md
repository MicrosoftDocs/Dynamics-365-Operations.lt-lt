...
description: Šiame straipsnyje pateikiama informacija apie dimensijų hierarchijas. Dimensijų hierarchija naudojama kaštų apskaitoje norint nurodyti ataskaitų struktūrą, išlaidų strategijas ir saugos nustatymus.
author: AndersGirke
ms.date: 06/16/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8848641"
---
# <a name="dimension-hierarchy"></a>Dimensijų hierarchija

[!include [banner](../includes/banner.md)]

Šiame straipsnyje pateikiama informacija apie dimensijų hierarchijas. Dimensijų hierarchija naudojama kaštų apskaitoje norint nurodyti ataskaitų struktūrą, išlaidų strategijas ir saugos nustatymus.  
