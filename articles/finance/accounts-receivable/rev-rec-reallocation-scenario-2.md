...
Tada pasirinkite **Numatytas kvitas**, kad būtų galima peržiūrėti apskaitos įrašus, kurie bus registruojami tik didžiojoje knygoje. Puslapyje **Didžiosios knygos parametrai** parinktis **Registruoti SF taisymus į Gautinas sumas** nustatyta į **Ne**, todėl apdorojant perskirstymą gautinos sumos nepasikeičia.
