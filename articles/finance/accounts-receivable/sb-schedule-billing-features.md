...
description: Šioje temoje paaiškinamos atsiskaitymo grafikų funkcijos, pvz., kainų metodai, perskyrimai ir nuolaidos, lygiavimo datos, paskaita, atvirkštinis atsiskaitymas ir išskaidytos prekių grupės.
...
ms.locfileid: "8696649"
---
# <a name="billing-schedule-features"></a>Atsiskaitymo grafikų funkcijos

[!include [banner](../includes/banner.md)]

Šioje temoje paaiškinamos atsiskaitymo grafikų ir atsiskaitymo grafiko eilučių funkcijos. Aprašomi įvairūs kainodaros metodai, kaip naudoti perskyrimus ir nuolaidas, ir kaip atšaukti atsiskaitymo laikotarpį. Joje taip pat pateikiami ir paprastų skaičiavimų ir prekių grupių skaidymo pavyzdžiai.
...
- **Kasdienis**
    ...
    - *Dienų skaičiaus data* = *–* pradžios *data* + 1 = 133 dienos
...
- **Kasdienis**
    ...
    - *Dienų skaičiaus data* = *–* pradžios *data* + 1 = 153 dienos
