...
Tada pasirinkite **Numatomas kvitas**, kad būtų galima peržiūrėti apskaitos įrašus. Parinktis **Registruoti SF taisymus į Gautinas sumas** yra nustatyta į **Taip** puslapyje **DK parametrai**, todėl šie apskaitos įrašai bus registruojami DK naudojant kredito dokumentą, o gautinose sumose bus sukurta nauja SF.
