...
description: Šiame straipsnyje aprašomos įplaukų pripažinimo nustatymų parinktys ir jų reikšmės.
author: bking
ms.date: 04/28/2022
ms.topic: index-page
ms.prod: ''
...
ms.locfileid: "9348417"
---
# <a name="revenue-recognition-setup"></a>Įplaukų pripažinimo nustatymai
[!include [banner](../includes/banner.md)]

Įtrauktas naujas modulis **Įplaukų pripažinimas**, kuriame yra meniu elementai visiems reikalingiems nustatymams. Šiame straipsnyje aprašomos sąrankos parinktys ir jų reikšmės.
