...
Planuoti ir tvarkyti projekto grafiką gali būti sudėtinga, todėl projektų vadovai turi naudoti įrankius, padedančius šią užduotį valdyti. Atlikus integravimą su „Microsoft Project“ klientu, galima atidaryti ir valdyti projekto darbo paskirstymo struktūrą. Projekto vadovas bet kokius keitimus gali vėl skelbti „Dynamics 365 Finance“ projekto darbo paskirstymo struktūroje.

> [!NOTE]
> Jei naudojate liepos mėn. naujinimą (10.0.4 versiją), turite įdiegti KB 4054797 ir 4055884.
...
Prieš failą redaguodami „Microsoft Project“ kliente, jį turite paimti ir užrakinti. Skirtuke **Microsoft Dynamics 365** spustelėkite **Paimti ir užrakinti**. Tai neleis kitiems vartotojams tuo pačiu metu darbo paskirstymo struktūros redaguoti naudojant „Finance“. Jei, baigę redaguoti darbo paskirstymo struktūrą, norite ją publikuoti, skirtuke **Microsoft Dynamics 365** spustelėkite **Įrašyti ir atrakinti**.

Jei į „Finance“ projektą jau įtraukta projekto komanda, išteklių sąrašas bus automatiškai užpildytas komandos nariais. Jei projekto komanda į projektą dar neįtraukta, galite pasirinkti išteklių ir komandą sukurti „Microsoft Project“ kliente – skirtuke **Microsoft Dynamics 365** spustelėkite mygtuką **Ištekliai**. 

Įrašymo ir atrakinimo proceso metu su „Finance“ vėl bus sinchronizuojami toliau pateikiami duomenys.
...
6.  Kai būsite pasirengę ją publikuoti sprendime „Finance“, skirtuke **Microsoft Dynamics 365** spustelėkite **Įrašyti ir atrakinti**.
