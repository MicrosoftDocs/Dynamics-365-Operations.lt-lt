---
title: Darbo paskirstymo struktūrų apžvalga
...
ms.locfileid: "2174402"
---
# <a name="work-breakdown-structures-overview"></a>Darbo paskirstymo struktūrų apžvalga
...
WBS kūrimas yra intensyvus procesas, paprastai atliekamas per ilgą laikotarpį ir kurį atliekant reikia itin įvairių žmonių bendradarbiavimo ir informacijos. Šioje temoje aprašoma, kaip naudojant WBS patobulinimus galima patenkinti įvertinimų ir sekimo reikalavimus.
...
Grafiko įvertinimas paprastai yra antrasis veiksmas kuriant WBS. Geriausia grafiko įvertinimą atlikti sukūrus užduotis. „Finance“ puslapį **Darbo paskirstymo struktūra** sudaro dvi dalys. Viršutinioji sritis skirta įvertinti grafikui, o apatinėje srityje yra **Įvertintų išlaidų ir įplaukų** skirtukas, kurį galite naudoti įvertinti išlaidoms. 
...
**Užduočių planavimas** Lapo mazgų užduočių planavimas nustatomas pagal toliau pateikiamus veiksnius.
...
**Ištaisyti visas planavimo klaidas** Jei norite, kad „Finance“ ištaisytų visas WBS planavimo klaidas, Veiksmų srityje spustelėkite **Ištaisyti visus planavimo neatitikimus**. 
...
„Finance“ yra trys projekto WBS rodiniai: Planavimo rodinys, Pastangų sekimo rodinys ir Išlaidų sekimo rodinys.
...
Nustatant planuojamą reikšmę, „Finance“ naudojama 0:100 pajamų taisyklė. Pagal šią taisyklę užduoties vertė užduotyje registruojama iki jos pabaigos datos. Kol užduotis neatlikta 100 procentų, vertė neregistruojama. 
...
Nustatant uždirbtą reikšmę, „Finance“ naudojama 0:100 pajamų taisyklė. Pagal šią taisyklę užduoties vertė užduotyje registruojama iki jos pabaigos datos. Kol užduotis neatlikta 100 procentų, vertė neregistruojama. 
