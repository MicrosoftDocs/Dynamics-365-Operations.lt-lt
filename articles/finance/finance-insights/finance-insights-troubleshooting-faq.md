...
Aplinkoje pasiektas maksimalus duomenų Paslaugų lentelės limitas. Norėdami gauti daugiau informacijos apie limitą, žr. temos **skyriuje** Įgalinti beveik realiuoju laiku atliktus duomenų keitimus, [Eksportuokite į "Azure Data Azure" duomenų apžvalga](../../fin-ops-core/dev-itpro/data-entities/Azure-Data-Lake-GA-version-overview.md).
