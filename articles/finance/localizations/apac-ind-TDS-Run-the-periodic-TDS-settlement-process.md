...
description: Šiame straipsnyje paaiškinama, kaip sudengti periodinius mokesčius, išskaičius iš šaltinio (TDS).
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8864248"
---
# <a name="run-the-periodic-tds-settlement-process"></a>Vykdyti periodinį TDS sudengimo procesą

[!include [banner](../includes/banner.md)]

Šiame straipsnyje paaiškinama, kaip sudengti periodinius mokesčius, išskaičius iš šaltinio (TDS).
