...
description: Šiame straipsnyje paaiškinama, kaip sudengti iš šaltinio (TDS) atskaityto mokesčio mokėjimus TDS institucijos tiekėjams.
author: kailiang
ms.date: 03/12/2021
ms.topic: article
ms.prod: ''
...
Šiame straipsnyje paaiškinama, kaip sudengti iš šaltinio (TDS) atskaityto mokesčio mokėjimus TDS institucijos tiekėjams.
