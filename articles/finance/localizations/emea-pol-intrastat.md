...
3. Dialogo lange **„Intrastat” ataskaita** nustatykite toliau nurodytus laukus.
    ...
    | Laukas | Aprašymas |
    |-------------------------|-------------------------|
    | Data nuo | Pasirinkite ataskaitos pradžios datą. |
...
2. Veiksmų srities skirtuko **Numeracija** grupėje Nauja pasirinkite **·** **·** Numeracija.
...
6. Segmentų **·** "FastTab", **·** raidinio-skaitinio segmento ilgio **·** lauke, įveskite **·** 4.
...
9. Agento skirtuko Agento "FastTab" PVM skyriaus PVM lauke **·** ĮVESKITE **·** **·** **·** **420 000.**
10. Skirtuko **·** Kontaktas lauke Pavadinimas **įveskite** **Nebaigta** Kūrėjas.
...
4. Pasirinkti numatytąjį tiekėjo pristatymo būdą.
    ...
    1. Eiti į **Mokėtinų** > **sumų tiekėjus** > **Visi** tiekėjai.
...
1. Pasirinkite **Gautinos sumos** > **Klientai** > **Visi klientai**.
2. Tinklelyje pasirinkite **DE-016.**
3. SF ir pristatymo "FastTab" PVM skyriuje patikrinkite, ar PVM mokėtojo kodo laukas **·** nustatytas kaip **·** **·** **DE9012.**
...
6. Skirtuke Adresas patikrinkite, ar laukas Adresas nustatytas į **·** **·** **Terastos 12, Kkie, 24103, DEU, nes klientas yra** iš Vokietijos.
7. Pasirinkite **Gerai**.
...
10. Skirtuke Eilutės informacija FastTab, užsienio prekybos skirtuke, patikrinkite, ar operacijos kodo laukas nustatytas kaip **·** **·** **·** **11,** **·** **·** **·** **prekės laukas nustatytas kaip 100 200 30,** o kilmės šalies / regiono laukas nustatytas kaip POL.
...
5. Dialogo lango Intrastat filtras skirtuke Diapazonas pasirinkite pirmą eilutę ir **·** **·** patikrinkite, ar **lauko laukas nustatytas** kaip **·** Data.
...
16. Į dokumentų **kūrimo miestą** įveskite **Ind.**
...
5. Lauke **Sandėlis** pasirinkite **11.**
6. Pasirinkite **Gerai**.
7. Skirtuko Antraštėje skirtuke Pristatymo "FastTab" patikrinkite, ar pristatymo būdo lauke nustatyta **·** **·** **·** **10, o** **·** **·** lauke Pristatymo sąlygos nustatyta kaip CIF.
...
12. Į dokumentų **kūrimo miestą** įveskite **Ind.**
...
16. Pasirinkite **Gerai** ir peržiūrėkite sugeneruotą XML formato ataskaitą. Toliau pateikiamoje lentelėje nurodomos pavyzdžio ataskaitos vertės.
    ...
    <tr>
    <td colspan="3">
    <p style="text-align: center;"><strong>Informacija apie dokumentą</strong></p>
    </td>
    </tr>
    <tr>
    <td>
    ...
    <tr>
    <td colspan="3">
    <p style="text-align: center;"><strong>Informacija apie įmonę</strong></p>
    </td>
    </tr>
    <tr>
    <td width="191">
    ...
    <tr>
    <td colspan="3">
    <p style="text-align: center;"><strong>Informacija apie tinkamas</strong></p>
    </td>
    </tr>
    <tr>
    <td>
    ...
    <tr>
    <td colspan="3">
    <p style="text-align: center;"><strong>Kontaktinė informacija</strong></p>
    </td>
    </tr>
    <tr>
    <td>
