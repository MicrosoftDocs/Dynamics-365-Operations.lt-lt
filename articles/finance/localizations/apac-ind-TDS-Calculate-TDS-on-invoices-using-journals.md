...
description: Šiame straipsnyje pateikiami žurnaluose atlikti veiksmai, kaip apskaičiuoti iš šaltinio (TDS) išskaityą mokestį.
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8863039"
---
# <a name="calculate-tds-on-invoices-using-journals"></a>Skaičiuoti SF TDS naudojant žurnalus

[!include [banner](../includes/banner.md)]

Šiame straipsnyje pateikiami žurnaluose atlikti veiksmai, kaip apskaičiuoti iš šaltinio (TDS) išskaityą mokestį.
