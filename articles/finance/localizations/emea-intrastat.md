...
Šiame straipsnyje pateikta informacija apie Intrastat ataskaitas už prekybą prekėmis ir, kai kuriais atvejais, paslaugomis Europos Sąjungos (ES) šalyse / regionuose. Šiame straipsnyje taip pat pateikiama ataskaitų proceso apžvalga ir aprašomi reikiami parametrai ir būtinosios sąlygos.
...
### <a name="enter-a-transaction-that-crosses-the-border-of-another-eu-countryregion"></a>Įvesti operaciją, kuri kerta kitos ES šalies / regiono sieną
...
### <a name="use-the-intrastat-journal-to-generate-information-about-trade-among-eu-countriesregions"></a>Naudoti Intrastat žurnalą, norint generuoti informaciją apie prekybą tarp ES šalių / regionų
...
### <a name="use-the-intrastat-journal-to-report-information-about-trade-among-eu-countriesregions"></a>Naudoti Intrastat žurnalą, norint pranešti informaciją apie prekybą tarp ES šalių / regionų
...
1. Eikite į **mokėtinų** > **sumų mokesčių nustatymo** > **mokesčių kodą**.
...
6. Eiti į Mokėtinų **sumų** > **tiekėjai** > **Visi tiekėjai**.
