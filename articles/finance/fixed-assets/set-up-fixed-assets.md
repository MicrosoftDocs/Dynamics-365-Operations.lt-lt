...
description: Šiame straipsnyje pateikta ilgalaikio turto modulio sąrankos apžvalga.
author: moaamer
ms.date: 06/08/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8910148"
---
# <a name="set-up-fixed-assets"></a>Ilgalaikio turto nustatymas

[!include [banner](../includes/banner.md)]

Šiame straipsnyje pateikta Ilgalaikio turto modulio **nustatymo** apžvalga. 
