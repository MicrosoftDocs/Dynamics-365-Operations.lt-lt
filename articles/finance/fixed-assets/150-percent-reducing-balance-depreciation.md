...
description: Šiame straipsnyje pateikiama 150 procentų mažėjančios vertės nusidėvėjimo metodo peržiūra.
author: moaamer
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8870226"
---
# <a name="150-percent-reducing-balance-depreciation"></a>150 procentų mažėjančios vertės metodas

[!include [banner](../includes/banner.md)]

Šiame straipsnyje pateikiama 150 procentų mažėjančios vertės nusidėvėjimo metodo peržiūra.
