...
3. Lauke Nusidėvėjimo knyga surinkite reikšmę.
4. Lauke Aprašas įveskite reikšmę.
5. Pažymėkite arba atžymėkite žymės langelį Skaičiuoti nusidėvėjimą.
6. Lauke Nusidėvėjimo šablonas spustelėkite išplečiamąjį mygtuką, kad atidarytumėte peržvalgą.
7. Sąraše raskite ir pasirinkite norimą nusidėvėjimo šabloną.
8. Sąraše spustelėkite saitą pasirinktoje eilutėje.
9. Lauke Alternatyvus nusidėvėjimo šablonas spustelėkite išplečiamąjį mygtuką, kad atidarytumėte peržvalgą.
10. Sąraše pasirinkite norimą nusidėvėjimo šabloną.
...
12. Pažymėkite arba atžymėkite žymės langelį Kurti nusidėvėjimo koregavimus su pagrindo koregavimais.
13. Lauke Kalendorius spustelėkite išplečiamąjį mygtuką, kad atidarytumėte peržvalgą.
14. Sąraše spustelėkite saitą pasirinktoje eilutėje.

## <a name="associate-the-depreciation-book-with-a-fixed-asset-group"></a>Susieti nusidėvėjimo knygą su ilgalaikio turto grupe
1. Spustelėkite Ilgalaikio turto grupės.
2. Lauke Ilgalaikio turto grupė spustelėkite išplečiamąjį mygtuką, kad atidarytumėte peržvalgą.
