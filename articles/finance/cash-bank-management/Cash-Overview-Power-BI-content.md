...
description: Šiame straipsnyje aprašomas grynųjų pinigų peržiūros Power BI turinys. Joje paaiškinama, kaip pasiekti į turinį įtrauktas ataskaitas, ir pateikiama informacija apie duomenų modelį ir objektus, naudotus turiniui kurti.
author: angelad116
ms.date: 07/16/2020
ms.topic: overview
ms.prod: ''
...
ms.locfileid: "9152006"
---
# <a name="cash-overview-power-bi-content"></a>„Power BI“ turinys Grynųjų pinigų apžvalga

[!include [banner](../includes/banner.md)]

Šiame straipsnyje aprašomas grynųjų **pinigų peržiūros** Microsoft Power BI turinys. Joje paaiškinama, kaip pasiekti į turinį įtrauktas ataskaitas, ir pateikiama informacija apie duomenų modelį ir objektus, naudotus turiniui kurti.
