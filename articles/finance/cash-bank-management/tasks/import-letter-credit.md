...
1. Eikite į **pirkimo > sumų > visus pirkimo užsakymus**.
...
>[!Note] 
>Banko **dokumento tipo laukas** turi būti **akredityvo**.  
...
45. Spustelėkite **Patvirtinti**.
    * Pakeiskite akredityvo sumą dėl vieneto kainos pakeitimo.  
...
3.  **Į PurchParmTable_Num** įveskite vertę.
    * Pasirinkite siuntos **numerį,** sukurtą su nuoroda į akredityvo.  
...
1. Pasirinkite grynųjų **pinigų ir banko valdymo > akredityvo > importo akredityvo ir importo rinkinį**.
...
3. Sąraše spustelėkite saitą pasirinktoje eilutėje.
    ...
    * Tikrinti: siuntos  **būsenos SF** = **banko**  priemonės informacija  
...
9. Išplėskite **skyrių Bendrosios** sumos.
