...
description: Šiame straipsnyje paaiškinama, kaip kurti mėnesio nuomos SF. Galite kurti atskiros nuomos SF arba galite naudoti paketinį procesą, kad sukurtumėte kelių nuomų SF.
author: moaamer
ms.date: 04/12/2021
ms.topic: article
ms.prod: ''
