...
1. Nueikite į **Turto nuoma \> Periodinė \> Paketinis patvirtinimas**.
2. Puslapyje **Paketinis patvirtinimas** pasirinkite **Paketinis patvirtinimas**.
3. Pasirodžiusiame dialogo lange filtruokite knygas, kurias norite patvirtinti.

    - Norėdami patvirtinti visas tam tikros nuomos grupės knygas, pasirinkite grupę lauke **Nuomos grupė**.
    - Norėdami patvirtinti konkrečias knygas, pasirinkite knygas lauke **Knygos ID**.
