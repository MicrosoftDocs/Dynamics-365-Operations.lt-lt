...
description: Šiame straipsnyje aprašomi registravimo tipai, naudojami turto operacijose.
author: moaamer
ms.date: 04/12/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8889068"
---
# <a name="lease-posting-types"></a>Nuomos registravimo tipai

[!include [banner](../includes/banner.md)]

Šiame straipsnyje aprašomi registravimo tipai, naudojami turto operacijose.
