...
description: Šiame straipsnyje pateikiama išsami informacija apie importavimo formatą, naudojamą konsoliduojant finansinius duomenis iš kelių juridinių subjektų.
author: jinniew
ms.date: 10/09/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8871310"
---
# <a name="import-format-for-consolidation"></a>Importuoti formatą konsolidavimui

[!include [banner](../includes/banner.md)]

Šiame straipsnyje pateikiama išsami informacija apie importavimo formatą, naudojamą konsoliduojant finansinius duomenis iš kelių juridinių subjektų. Importavimo formatas turi būti įrašomas kaip tekstas (.txt) failas.
