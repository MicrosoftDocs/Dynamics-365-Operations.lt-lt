...
description: Šioje temoje paaiškinami įvairūs būdai, kaip galite peržiūrėti žurnalo įrašus ir operacijas.
author: aprilolson
ms.date: 08/01/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8717564"
---
# <a name="view-journal-entries-and-transactions"></a>Žurnalo įrašų ir operacijų peržiūra

[!include [banner](../includes/banner.md)]

Šioje temoje paaiškinami įvairūs būdai, kaip galite peržiūrėti žurnalo įrašus ir operacijas. 
...
- [Žurnalų įrašų ar operacijų peržiūra](tasks/view-journal-entries-or-transactions.md)
