...
ms.locfileid: "7727069"
---
# <a name="financial-period-close-workspace"></a>Finansinio laikotarpio uždarymo darbo sritis

[!include [banner](../includes/banner.md)]

Šioje temoje straipsnyje pateikta **Finansinio laikotarpio uždarymo** darbo sritis ir susijusi konfigūracija.
...
Prieš naudodami darbo sritį **Finansinio laikotarpio uždarymas**, turite sukonfigūruoti procesą, naudodami puslapį **Finansinio laikotarpio uždarymo konfigūracija**. (Spustelėkite **Didžioji knyga** &gt; **Laikotarpio uždarymas** &gt; **Finansinio laikotarpio uždarymo konfigūracija.**)
...
Meniu elementas **Užduoties saitas** susietas su užduoties darbo pastanga ir gali būti naudojamas norint pereiti iš darbo srities užduoties saito tiesiogiai į susietą puslapį. Pvz., uždarymo užduotis, skirta vykdyti mokėtinų sumų valiutos perkainojimo procesą, gali būti susijusi su susietu puslapiu **Užsienio valiutos kurso pasikeitimas**. Taip pat galite susieti su išoriniu URL. 
