...
description: Šioje temoje aprašoma, kaip įvesti sąskaitų ir dimensijų kombinacijas arba DK sąskaitas. Įvedimo patirtis dažnai vadinama segmentuotu įrašų valdikliu.
author: aprilolson
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
Šioje temoje aprašoma, kaip įvesti sąskaitų ir dimensijų kombinacijas arba DK sąskaitas. Įvedimo patirtis dažnai vadinama segmentuotu įrašų valdikliu.
