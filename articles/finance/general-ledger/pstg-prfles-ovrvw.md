---
title: Registravimo šablonų peržiūra
description: Šioje temoje paaiškinama, kaip registravimo profiliai naudojami visose Microsoft Dynamics 365 programėlėse.
...
ms.locfileid: "8018384"
---
# <a name="posting-profiles-overview"></a>Registravimo šablonų peržiūra
...
| Klientų grupė | Pavadinimas | Aprašymas |
|----------------|------|-------------|
...
Jei registravimo šablone, kuriame sąskaitos kodo laukas nustatytas kaip Visi, nesukursite registravimo tipo įrašo, o sistema neranda atitinkančio registravimo šablono įrašo, esančio grupės arba **lentelės** **·** **·** **vertei**, **sistema** randa numatytąją vertę, kurią galima nurodyti automatinės operacijos puslapio sąskaitose. Daugiau informacijos ieškokite [Automatinių operacijų](accounts-for-auto-transactions.md) sąskaitose.
...
Daugelis modulių yra, ir turėti registravimo šabloną arba Dynamics 365 Finance Dynamics 365 Supply Chain Management papildomas Dynamics 365 Commerce Dynamics 365 Project Operations konfigūracijas, kurios kontroliuoja, kaip veikia registravimas į DK. Norėdami daugiau sužinoti apie registravimo šablonus ir registravimo kiekviename modulyje nustatymus, naudokite šias temas:
...
- [Turto registravimus](../asset-leasing/set-up-lease-posting-accts.md)
