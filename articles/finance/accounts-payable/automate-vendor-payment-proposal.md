...
description: Šiame straipsnyje paaiškinama, kaip organizacijos, mokančios tiekėjus pagal pasikartojantį grafiką, gali automatizuoti tiekėjo mokėjimo pasiūlymų generavimo procesą.
author: kweekley
ms.date: 04/08/2020
ms.topic: article
ms.prod: ''
...
> [!NOTE]
> Norint **naudoti šią funkciją,** funkcijų valdymas turi būti įgalinta tiekėjo mokėjimo pasiūlymo automatizavimo funkcija. 
