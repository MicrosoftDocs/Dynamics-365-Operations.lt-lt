...
description: Šiame straipsnyje aprašomos išplėstinio formatavimo funkcijos, įskaitant filtrus, apribojimus, nespausdinimo eilutes ir sąlyginius sakinius skaičiavimuose.
author: panolte
ms.date: 04/26/2019
ms.topic: article
ms.prod: ''
...
- Vertėms perkelti iš „Microsoft Excel“ į konkrečius langelius.
...
> [!NOTE]
> Daugeliu atvejų turite sukonfigūruoti savo ataskaitos aprašą, kad stulpelio skaičiavimai būtų atliekami prieš eilučių skaičiavimus. Norėdami užbaigti šią konfigūraciją, atlikite šiuos veiksmus.
>
...
Kurdami ataskaitą turite pirmiausia sukurti visas informacijos eilutes, kad užtikrintumėte, kad šios reikšmės bus įtrauktos, kaip yra numatyta. Tada pridėkite **NP** (nespausdinama) formato nepaisymus, kad informacija, kurioje yra galutinės reikšmės, nebūtų rodoma.

> [!IMPORTANT]
> Kai eilučių apraše naudojate **CAL** formato kodą, negalite detalizuoti operacijos duomenų.

Priverčiant formulės naudoja šį formatą: &lt;paskirties stulpelis&gt;=&lt;kilmės stulpelis&gt;&lt;eilutės kodas&gt; Atskirkite visas papildomas padėtis eilutėje kableliu ir tarpu. Štai pavyzdys: D=C.190,E=C.100
...
|           Formatuoti             | A   | Mlrd.    | K        | D      | E      | Pn.    |
|------------------------------|-----|------|----------|--------|--------|------|
| 1 antraštė                     |     |      |          |        |        |      |
| 2 antraštė                     | A   | Mlrd.    | K        | D      | E      | Pn.    |
| 3 antraštė                     |     |      |          |        |        |      |
| Stulpelio tipas                  | ROW | APRAŠ. | FD       | FD     | FD     | SKAIČ. |
...
| 2 antraštė                     | -   | -    | Nuo metų pradžios    | Metų pardavimas | Personalas | $ vienam asmeniui |
| 3 antraštė                     |     |      |        |              |       |              |
...
|----------|-----------------------------|-------------|----------------------------|---------------|--------------|------------------------------|
| 340      | Pinigai laikotarpio pradžioje |             |                            | NP            | BB           | +Sąskaita=\[1100:1110\]       |
| 370      | Pinigai metų pradžioje   | KPL         | @100 + @330                  | NP            |              |                              |
| 400      | Pinigai laikotarpio pradžioje | IŠ VISO         | 340 + 370                    |               |              |                              |
...
Šiame pavyzdyje skaičiavimo formulė **E=C.340** reiškia, kad langelio C stulpelyje ir 340 eilutėje skaičiavimas atliekamas tik stulpelyje E.

> [!NOTE]
> Kai nurodote stulpelį skaičiavimo formulėje, ženklas eta (@) nebūtinas.
...
> [!NOTE]
> Norėdami rasti visą hierarchijos kodą, spustelėkite dešiniuoju pelės mygtuku ataskaitų medžio apraše, tada pasirinkite **Kopijuoti ataskaitinio vieneto identifikatorių (H kodą)**.
