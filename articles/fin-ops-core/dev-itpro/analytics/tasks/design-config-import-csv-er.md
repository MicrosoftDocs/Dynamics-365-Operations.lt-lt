...
Taip pat turite atsisiųsti ir įrašyti į savo kompiuterį šiuos failus: [„Dynamics 365 Finance“ elektroninių ataskaitų pavyzdžius](https://go.microsoft.com/fwlink/?linkid=862266)(1099model.xml, 1099formatcsv.xml, 1099entriescsv.csv).
...
5. Medyje pasirinkite `Incoming: File\Root: Sequence\Line: Sequence 1..*`.
...
6. Medyje pasirinkite `Incoming: File\Root: Sequence\Line: Sequence 1..* \Types: Case`.
...
7. Medyje pasirinkite `Incoming: File\Root: Sequence\Line: Sequence 1..* \Types: Case\Header: Sequence 1..1`.
...
8. Medyje pasirinkite `Incoming: File\Root: Sequence\Line: Sequence 1..* \Types: Case\Record: Sequence 1..1 (,)`.
...
9. Medyje pasirinkite `Incoming: File\Root: Sequence\Line: Sequence 1..* \Types: Case\Record: Sequence 1..1 (,)\TransactionDate: DateTime`.
...
10. Medyje pasirinkite `Incoming: File\Root: Sequence\Line: Sequence 1..* \Types: Case\Record: Sequence 1..1 (,)\CountryCode: String 0..1`.
...
11. Medyje pasirinkite `Incoming: File\Root: Sequence\Line: Sequence 1..* \Types: Case\Record: Sequence 1..1 (,)\Remark: Sequence 1..1 (,)`.
...
12. Medyje pasirinkite `Incoming: File\Root: Sequence\Line: Sequence 1..* \Types: Case\Unparsed: Sequence 1..1`.
...
6. Medyje išplėskite `format\Incoming: File(Incoming)\Root: Sequence(Root)\Line: Sequence 1..* (Line)`.
7. Medyje išplėskite `format\Incoming: File(Incoming)\Root: Sequence(Root)\Line: Sequence 1..* (Line)\Types: Case(Types)`.
8. Medyje išplėskite `format\Incoming: File(Incoming)\Root: Sequence(Root)\Line: Sequence 1..* (Line)\Types: Case(Types)\Record: Sequence 1..1 (,)(Record)`.
9. Medyje išplėskite `format\Incoming: File(Incoming)\Root: Sequence(Root)\Line: Sequence 1..* (Line)\Types: Case(Types)\Record: Sequence 1..1 (,)(Record)\Data`.
10. Medyje išplėskite `format\Incoming: File(Incoming)\Root: Sequence(Root)\Line: Sequence 1..* (Line)\Types: Case(Types)\Record: Sequence 1..1 (,)(Record)\Data\CountryCode: String 0..1 (CountryCode)`.
11. Medyje pasirinkite `format\Incoming: File(Incoming)\Root: Sequence(Root)\Line: Sequence 1..* (Line)\Types: Case(Types)\Record: Sequence 1..1 (,)(Record)\Data\TransactionDate: DateTime(TransactionDate)`.
