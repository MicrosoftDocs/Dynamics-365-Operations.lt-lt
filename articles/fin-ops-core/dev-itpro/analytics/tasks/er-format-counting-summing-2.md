...
description: Šiame straipsnyje aprašoma, kaip konfigūruoti elektroninės ataskaitos formatą, kad būtų galima atlikti skaičiavimą ir sumuoti remiantis jau sugeneruotos teksto išvesties duomenimis. (2 dalis)
author: kfend
ms.date: 08/29/2018
