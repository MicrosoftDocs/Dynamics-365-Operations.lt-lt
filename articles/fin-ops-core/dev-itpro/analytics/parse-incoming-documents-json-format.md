...
description: Šiame straipsnyje paaiškinama, kaip nustatyti elektroninių ataskaitų (ER) formatus, norint išanalizuoti gaunamus dokumentus "JavaScript" objektų notacijos (JSON) formatu.
author: kfend
ms.date: 05/20/2019
ms.topic: article
ms.prod: ''
