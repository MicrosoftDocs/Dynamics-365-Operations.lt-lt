...
description: Šiame straipsnyje paaiškinama, kaip konfigūruoti elektroninės ataskaitos (ER) formatą ataskaitoms generuoti kaip Microsoft Word failams, kuriuose sulaikyti turinio valdikliai.
author: kfend
ms.date: 02/11/2021
...
- Darbalapio ataskaitos **ER formato, kuris** pažymėtas kaip Vykdytinas, juodraščio **versija**
