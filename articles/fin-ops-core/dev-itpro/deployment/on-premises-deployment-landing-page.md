...
- [Vietinio diegimo parinktis](on-premises-overview.md)
- [Visuotinių vietinių diegimų planavimas ir rengimas](plan-onprem-deployment.md)
- [Vietinėms įdiegtims taikomi sistemos reikalavimai](../../fin-ops/get-started/system-requirements-on-prem.md)
- [Aparatūros dydžio nustatymas vietinėse aplinkose](../../fin-ops/get-started/hardware-sizing-on-premises-environments.md)
- [„Finance + Operations“ (vietinė versija) pirkimas](../../fin-ops/get-started/purchase-on-premises.md)
...
- [Vietinių aplinkų atvirkštinių tarpinių serverių konfigūravimas](onprem-reverseproxy.md)
- [Techninio palaikymo nustatymas](../lifecycle-services/support-experience.md)
...
- [Mažmeninės prekybos galimybės, pasiekiamos vietinėse visuotinėse įdiegtyse](../../../retail/retail-onprem.md)
- [„Retail“ kanalų komponentų vietinėje aplinkoje diegimo veiksmai](deploy-retail-onprem.md)
- [„Retail Modern POS“ (MPOS) konfigūravimas, diegimas ir aktyvinimas](../../../retail/retail-modern-pos-device-activation.md)
- [„Retail Store Scale Unit“ konfigūravimas ir diegimas](../../../retail/dev-itpro/retail-store-scale-unit-configuration-installation.md)
...
- [Vietinių visuotinių diegimų trikčių diagnostika](troubleshoot-on-prem.md)
- [Sertifikato kaita](certificate-rotation-on-prem.md)
- [Vietinė diagnostika](on-premises-diagnostics.md)
- [Funkcijos, kurios dar neįdiegtos vietinėse visuotinėse įdiegtyse](../../fin-ops/get-started/features-not-implemented-on-prem.md)
- [Pašalintos arba nebenaudojamos funkcijos](../migration-upgrade/deprecated-features.md)
