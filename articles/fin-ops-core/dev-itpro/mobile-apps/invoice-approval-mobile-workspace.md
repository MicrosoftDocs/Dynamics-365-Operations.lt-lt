...
description: Šiame straipsnyje pateikiama informacija apie SF patvirtinimų mobiliąją darbo sritį.
author: abruer
ms.date: 05/24/2022
ms.topic: article
ms.prod: ''
...
Šiame straipsnyje pateikiama informacija apie SF **patvirtinimų mobiliąją** darbo sritį. Šioje darbo srityje pateikiamas sąskaitų faktūrų, kurios buvo jums priskirtos tiekėjo SF antraštės darbo eigos procese, sąrašas. 
...
<tr class="even">
<td>Mobilioji darbo sritis <strong>Sąskaitos faktūros tvirtinimas</strong> turi būti paskelbta.</td>
<td>Sistemos administratorius</td>
...
2.  Pasirinkite sąskaitą faktūrą, kuri jums buvo priskirta tiekėjo SF antraštės darbo eigos proceso.
3.  Puslapyje **Sąskaitos faktūros informacija** peržiūrėkite sąskaitos faktūros antraštės informaciją, pvz., tiekėjo ir datos informaciją.
4.  Pasirinkite sąskaitos faktūros eilutę, kad peržiūrėtumėte išsamią informaciją apie ją rodinyje **Sąskaitos faktūros eilutės informacija**.
5.  Rodinyje **Sąskaitos faktūros eilutės informacija** pasirinkite **Paskirstymai**, kad būtų parodyti eilutės paskirstymai. Čia galite peržiūrėti sąskaitos faktūros eilutės apskaitą. Rodoma informacija apima finansinių dimensijų ir pagrindinės sąskaitos informaciją.
6.  Puslapyje **Sąskaitos faktūros informacija** pasirinkite **Paskirstymai**, kad būtų parodyti visi paskirstymai. Čia galite peržiūrėti visos sąskaitos faktūros apskaitą. Rodoma informacija apima finansinių dimensijų ir pagrindinių sąskaitų informaciją. 
