...
Naudokite šiame **puslapyje skirtuką** Fono procesai, norėdami administruoti visus jūsų aplinkoje vykstaius fono procesus. Pasirinkite **Redaguoti,** norėdami atlikti bet kurio fono proceso tvarkaraščio pakeitimus. Šie pakeitimai gali apimti galiojimo laikotarpį, dėl kurių procesas bus "stabtelėjimo" arba kiekvienos dienos truks tam tikrą laikotarpį. Norėdami **peržiūrėti kiekvieno fono proceso** vykdymo rezultatus, pasirinkite Peržiūrėti naujausius rezultatus.
