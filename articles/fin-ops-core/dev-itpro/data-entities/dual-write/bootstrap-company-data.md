...
---
# <a name="bootstrap-with-company-data-faq"></a><span data-ttu-id="538e3-103">DUK apie perkrovimą naudojant įmonės duomenis</span><span class="sxs-lookup"><span data-stu-id="538e3-103">Bootstrap with company data FAQ</span></span>
 
[!include [banner](../../includes/banner.md)]


## <a name="why-do-i-need-bootstrapping"></a><span data-ttu-id="538e3-104">Kodėl man reikalinga perkrovimo funkcija?</span><span class="sxs-lookup"><span data-stu-id="538e3-104">Why do I need bootstrapping?</span></span> 
<span data-ttu-id="538e3-105">Galbūt turite „Common Data Service“ ar kitos „Dynamics 365“ programos egzempliorių su verslo duomenimis ir norite įjungti dvigubo rašymo ryšį su jais.</span><span class="sxs-lookup"><span data-stu-id="538e3-105">You might have an existing Common Data Service or other Dynamics 365 app instance with business data, and you want to enable dual-write connection against it.</span></span> <span data-ttu-id="538e3-106">Tokiu atveju prieš įjungdami dvigubo rašymo ryšį turite perkrauti „Common Data Service“ ar kitų „Dynamics 365“ programų duomenis su įmonės informacija.</span><span class="sxs-lookup"><span data-stu-id="538e3-106">In this case, you need to bootstrap Common Data Service or other Dynamics 365 app data with company information before enabling dual-write connection.</span></span>  
 
## <a name="when-should-i-use-bootstrapping"></a><span data-ttu-id="538e3-107">Kada reikėtų naudoti perkrovimo funkciją?</span><span class="sxs-lookup"><span data-stu-id="538e3-107">When should I use bootstrapping?</span></span> 
<span data-ttu-id="538e3-108">Įjungti dvigubo rašymo funkciją reikėtų prieš įjungiant objektų schemas (atliekant 5-ąjį veiksmą).</span><span class="sxs-lookup"><span data-stu-id="538e3-108">You should use bootstrapping before enabling dual-write entity maps (during step #5).</span></span>  
1. <span data-ttu-id="538e3-109">Norėdami nustatyti dvigubo rašymo ryšį tarp savo „Finance and Operations“ programos ir „ Common Data Service“ ar kitos „Dynamics 365“ programos egzempliorių, kaip administratorius prisijunkite prie „Finance and Operations“ programos.</span><span class="sxs-lookup"><span data-stu-id="538e3-109">To setup the dual-write connection between instances of your Finance and Operations app and the Common Data Service or other Dynamics 365 app, log in to the Finance and Operations app as an administrator.</span></span> 
2. <span data-ttu-id="538e3-110">Nueikite į modulį **Duomenų valdymas** ir spustelėkite mygtuką **Dvigubas rašymas**.</span><span class="sxs-lookup"><span data-stu-id="538e3-110">Go to the **Data Management** module and click the **Dual-Write** button.</span></span> <span data-ttu-id="538e3-111">Taip paleidžiamas **duomenų integratorius**.</span><span class="sxs-lookup"><span data-stu-id="538e3-111">This launches the **Data Integrator**.</span></span> 
3. <span data-ttu-id="538e3-112">Sukurkite dvigubo rašymo ryšį vienai ar kelioms įmonėms.</span><span class="sxs-lookup"><span data-stu-id="538e3-112">Create the dual-write connection for one or more companies.</span></span>  
    > [!div class="mx-imgBorder"]
    > <span data-ttu-id="538e3-113">![Dvigubo rašymo ryšio kūrimas](media/dual-write-boot-1.png)</span><span class="sxs-lookup"><span data-stu-id="538e3-113">![Create dual-write connection](media/dual-write-boot-1.png)</span></span>
4. <span data-ttu-id="538e3-114">Įjunkite objekto schemą **Cdm_companies**.</span><span class="sxs-lookup"><span data-stu-id="538e3-114">Enable the **Cdm_companies** entity map.</span></span> <span data-ttu-id="538e3-115">Tai sinchronizuoja įmones iš „Finance and Operations“ programos į „Common Data Service“.</span><span class="sxs-lookup"><span data-stu-id="538e3-115">This synchronizes companies from the Finance and Operations app to Common Data Service.</span></span>  
    > [!div class="mx-imgBorder"]
    > <span data-ttu-id="538e3-116">![Objekto schemos įjungimas](media/dual-write-boot-2.png)</span><span class="sxs-lookup"><span data-stu-id="538e3-116">![Enable the entity map](media/dual-write-boot-2.png)</span></span>
5. <span data-ttu-id="538e3-117">„Common Data Service“ ar kitos „Dynamics 365“ programos egzemplioriuje vykdykite perkrovimo kodo pavyzdį.</span><span class="sxs-lookup"><span data-stu-id="538e3-117">Run the sample bootstrapping code on the Common Data Service or other Dynamics 365 app instance.</span></span>  
6. <span data-ttu-id="538e3-118">Kai baigiama perkrauti ir sistema parengta tiesiogiai sinchronizuoti, įjunkite objektų schemas.</span><span class="sxs-lookup"><span data-stu-id="538e3-118">When the bootstrapping is done and the system is ready for the live sync, enable the entity maps.</span></span>  

    <span data-ttu-id="538e3-119">Įjungus objektų schemas, suaktyvinamas pradinis įjungtų objektų schemų duomenų sinchronizavimas.</span><span class="sxs-lookup"><span data-stu-id="538e3-119">Enabling the entity maps triggers the initial data sync for the enabled entity maps.</span></span> <span data-ttu-id="538e3-120">Tarp „Finance and Operations“ programos ir „Common Data Service“ sinchronizuojami atitinkami įmonių, kurioms parinktas dvigubo rašymo ryšys, duomenys.</span><span class="sxs-lookup"><span data-stu-id="538e3-120">The data corresponding to the companies chosen on the dual-write connection is synchronized between the Finance and Operations app and Common Data Service.</span></span> 
 
## <a name="how-to-i-use-the-code-sample"></a><span data-ttu-id="538e3-121">Kaip naudoti kodo pavyzdį?</span><span class="sxs-lookup"><span data-stu-id="538e3-121">How to I use the code sample?</span></span>
<span data-ttu-id="538e3-122">Pavyzdžio kodas yra C# programa, kurią galite įkelti į „Visual Studio“.</span><span class="sxs-lookup"><span data-stu-id="538e3-122">The sample code is a C# application that you can load in Visual Studio.</span></span> <span data-ttu-id="538e3-123">Pasitelkiamos „NuGet“ paketo „Common Data Service“ SDK priklausomybės, kurias galite atnaujinti naudodami standartinius „Visual Studio“ įrankius.</span><span class="sxs-lookup"><span data-stu-id="538e3-123">It takes NuGet package dependencies on the Common Data Service SDK, that you can refresh through standard Visual Studio tooling.</span></span> 

<span data-ttu-id="538e3-124">Sprendimą išskleidę ir atidarę „Visual Studio“ aplinkoje bei atkūrę „NuGet“ paketus, kode ieškokite **TODO**.</span><span class="sxs-lookup"><span data-stu-id="538e3-124">After unzipping and opening the solution in Visual Studio and restoring the NuGet packages, search for **TODO** in the code.</span></span> <span data-ttu-id="538e3-125">Kiekvienas turimas priimti sprendimas dėl įmonės informacijos perkrovimo būdo pažymėtas fraze **TODO** ; taip pat pateiktas kodo pavyzdys, skirtas įdiegti kanoniškai.</span><span class="sxs-lookup"><span data-stu-id="538e3-125">Each decision you need to make about how you want to bootstrap company information is noted by a **TODO** , with sample code for a canonical implementation.</span></span> 

<span data-ttu-id="538e3-126">Kodo pavyzdžiu parodytas tik vienas iš daugybės būdų, kuriuos naudodami objektų įrašus galite suskirstyti pagal įmonę.</span><span class="sxs-lookup"><span data-stu-id="538e3-126">The sample code shows only one of many ways you might categorize entity records by company.</span></span> <span data-ttu-id="538e3-127">Keisdami skyriuose **TODO** pateiktą logiką, galite sukurti savo pasirinktinį suskirstymą.</span><span class="sxs-lookup"><span data-stu-id="538e3-127">By changing the logic in the **TODO** sections, you can create your custom categorization.</span></span> 
 
## <a name="what-should-i-expect"></a><span data-ttu-id="538e3-128">Ko reikėtų tikėtis?</span><span class="sxs-lookup"><span data-stu-id="538e3-128">What should I expect?</span></span>
<span data-ttu-id="538e3-129">Pagal numatytuosius parametrus pavyzdžio programoje galite pateikti verslo struktūros vienetų ir įmonės kodo sąsajų žodyną.</span><span class="sxs-lookup"><span data-stu-id="538e3-129">By default, the sample application lets you provide a dictionary of business unit-to-company code mappings.</span></span> <span data-ttu-id="538e3-130">Bet kuris objektas, kurį perkraunate naudodami lauką **OwningBusinessUnit** , automatiškai nustatomas naudoti nurodytą įmonę.</span><span class="sxs-lookup"><span data-stu-id="538e3-130">Any entity you bootstrap with an **OwningBusinessUnit** field is automatically set to use the specified company.</span></span> <span data-ttu-id="538e3-131">Objektui be lauko **OwningBusinessUnit** , pvz., produktui, įmonė bus nustatoma pagal sąsają su tuščia verslo struktūros vieneto reikšme.</span><span class="sxs-lookup"><span data-stu-id="538e3-131">Any entity without an **OwningBusinessUnit** field, such as product, will set the company based on the mapping with an empty business unit value.</span></span>

<span data-ttu-id="538e3-132">Konsolės programa tikisi vieno parametro – **–simulate** arba **–apply**.</span><span class="sxs-lookup"><span data-stu-id="538e3-132">The console application expects one parameter, either **–simulate** or **–apply**.</span></span> <span data-ttu-id="538e3-133">Jei naudojate komandų eilutės parametrą **–simulate** , neatnaujinami jokie duomenys.</span><span class="sxs-lookup"><span data-stu-id="538e3-133">If you use the **–simulate** command line parameter, then no data is updated.</span></span> <span data-ttu-id="538e3-134">Tame pačiame kataloge, kaip įrankis, generuojami tik **simulation_<entityname>.csv** failai, po vieną kiekvienam objektui, kuris būtų buvęs atnaujintas.</span><span class="sxs-lookup"><span data-stu-id="538e3-134">Only **simulation_<entityname>.csv** files are generated in the same directory as the tool, one for each entity that would have been updated.</span></span> <span data-ttu-id="538e3-135">Dirbdami šiuos failus galite pakartotinai peržiūrėti, kad užtikrintumėte, jog kodas įmonės reikšmes atnaujina taip, kaip tikimasi.</span><span class="sxs-lookup"><span data-stu-id="538e3-135">You can iteratively review these files while working to ensure the code updates company values as expected.</span></span> 

<span data-ttu-id="538e3-136">Baigę dirbti su modeliuojamais naujinimais, naudokite parametrą **–apply**.</span><span class="sxs-lookup"><span data-stu-id="538e3-136">When you finish with the simulated updates, then use the **–apply** parameter.</span></span> <span data-ttu-id="538e3-137">Taip atnaujinami visi įrašai, kuriuose šiuo metu yra neteisinga įmonės reikšmė – paketais po 1000 įrašų vienu metu (pagal numatytuosius parametrus).</span><span class="sxs-lookup"><span data-stu-id="538e3-137">This updates all records that currently have an incorrect company value, in batches of 1000 records at a time (by default).</span></span> <span data-ttu-id="538e3-138">Kodas pateikiamas su unikalumo patikrinimo funkcija – tai reiškia, kad galite jį vykdyti pakartotinai ir bus atnaujintos tik neteisingai priskirtos įmonės.</span><span class="sxs-lookup"><span data-stu-id="538e3-138">The code is idempotent as provided, meaning you can re-run it and only the incorrectly assigned companies will be updated.</span></span> <span data-ttu-id="538e3-139">Vykdomas su **–apply** , kodas generuoja atliktų pakeitimų CSV failus, kurie pavadinti **applied_<entityname>.csv** ,</span><span class="sxs-lookup"><span data-stu-id="538e3-139">When running with **–apply** , the code outputs CSV files of the changes made, which are named **applied_<entityname>.csv**.</span></span> 
