...
Toliau nurodytose lentelėse objektai išvardyti tokia tvarka, kokia juos turite įjungti. Įjungus pradinio sinchronizavimo schemą, dvigubo rašymo programa automatiškai aptinka kitas schemas, kurias reikia įjungti. Galite naudoti puslapį **Dvigubas rašymas**, esantį „Finance and Operations” programose, kad pasirinktumėte arba atšauktumėte objektų žymėjimą pradinio sinchronizavimo metu.

Naujausioje dvigubo rašymo versijoje galite įgalinti tik kai kuriuos objektus, o priklausomybės yra tvarkomos automatiškai.
