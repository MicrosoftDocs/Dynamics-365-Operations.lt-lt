...
Kai nauja neesminė funkcija įdiegiama, ji bus pasirinktina 12 mėnesių laikotarpiu. Tai suteikia laiko jums ir jūsų organizacijai planuoti iš anksto, kada įsisavinti funkciją ir išbandyti ją su kasdieninėmis operacijomis. Norėdami sužinoti daugiau, žr. [DUK apie „One Version” paslaugos naujinimus](../one-version.md#what-about-new-features).
