...
description: Šiame straipsnyje pateikiami užduočių vedliai, paleisti į "Microsoft BPM" bibliotekas nuo 2016 m. vasario mėn.
author: josaw1
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8861740"
---
# <a name="new-task-guides-february-2016"></a>Nauji užduočių vedliai (2016 m. vasario mėn.)

[!include [banner](../includes/banner.md)]

Šiame straipsnyje pateikiami užduočių vedliai, paleisti į "Microsoft BPM" bibliotekas nuo 2016 m. vasario mėn. Publikuotos bibliotekos apima APQC bendrąją biblioteką (2016 m. vasario mėn.), skirtą „Microsoft Dynamics AX“, ir biblioteką Darbo pradžia (2016 m. vasario mėn.).
...
| Registruoti laisvos formos SF su mokėjimo kvitu                                                           | Danija                         |
| Registruoti projekto SF su mokėjimo kvitu                                                             | Danija                         |
| Registruoti pardavimo SF su mokėjimo kvitu                                                               | Danija                         |
| Nustatyti klientų sąskaitas, susijusias su OIOUBL elektroninių SF išrašymu                                               | Danija                         |
| Nustatyti mokėjimo kvito formatą                                                                             | Danija                         |
| Nustatyti projekto SF mokėjimo kvito formatą                                                         | Danija                         |
| Kurti ir eksportuoti tiekėjo mokėjimus naudojant SEPA mokėjimo formatą                                          | Europa                          |
...
| Importuoti SEPA kredito pervedimo konfigūraciją                                                              | Europa                          |
| Importuoti SEPA tiesioginio debeto konfigūraciją                                                                 | Europa                          |
| Nustatyti SEPA kredito pervedimų įmonės banko sąskaitas                                                 | Europa                          |
| Nustatyti SEPA tiesioginio debeto įmonės banko sąskaitas                                                    | Europa                          |
| Nustatyti SEPA tiesioginio debeto klientus ir klientų banko sąskaitas                                     | Europa                          |
| Nustatyti SEPA kredito pervedimo mokėjimo būdą                                                      | Europa                          |
| Nustatyti SEPA tiesioginio debeto mokėjimo būdą                                                         | Europa                          |
| Nustatyti SEPA kredito pervedimų tiekėjus ir tiekėjų banko sąskaitas                                      | Europa                          |
| FR-00002, kliento ir tiekėjo sąskaitų išrašai                                                        | Prancūzija                          |
...
| Kurti tiekėjo sąskaitą ir pridėti SF deklaraciją                                             | Islandija                         |
| IS-00005 PVM derinimo ataskaita                                                                     | Islandija                         |
| Nustatyti tiekėjų SF deklaraciją                                                              | Islandija                         |
| Nustatyti privalomas mokėjimo nuorodas                                                                    | Islandija                         |
| Atnaujinti tiekėjų SF deklaracijas ir generuoti ataskaitą                                             | Islandija                         |
| Įsigyti ilgalaikį turtą su turto grąžinimo įsipareigojimais                                                | Japonija                           |
| Įsigyti ilgalaikį turtą, pateikti paraišką vyriausybės subsidijai gauti ir taikyti mažinimo įrašą                         | Japonija                           |
...
| Keisti vertinimo modelio nusidėvėjimo metodą per turto naudojimo laikotarpį                                   | Japonija                           |
...
| Kurti pagreitinto nusidėvėjimo šabloną ir jį priskirti vertinimo modeliui                                   | Japonija                           |
...
| Kurti ir patvirtinti konsoliduotąją kliento SF                                                     | Japonija                           |
...
| Atskaitomų išlaidų ilgalaikio turto bendrųjų duomenų failų tvarkymas                                         | Japonija                           |
...
| Sudengti kliento konsoliduotąsias SF sudengiant operacijas                                     | Japonija                           |
...
| NL-00003 „Semansys XBRL“ integravimas                                                                     | Nyderlandai                     |
| NL-00010, elektroninės mokesčių deklaracijos (EVAT)                                                            | Nyderlandai                     |
...
| GB-00002 Pirkimo užsakymo, apimančio prekes, kurioms taikomas atvirkštinis PVM, kūrimas                     | Jungtinė Karalystė                  |
| GB-00002, pardavimo užsakymo, apimančio prekes, kurioms taikomas atvirkštinis PVM, kūrimas                        | Jungtinė Karalystė                  |
| GB-00002, prekės PVM grupių nustatymas atvirkštinio mokesčio PVM                                           | Jungtinė Karalystė                  |
| GB-00002, atvirkštinio mokesčio PVM prekių grupių, taisyklių ir parametrų nustatymas                                  | Jungtinė Karalystė                  |
| GB-00002, PVM grupių nustatymas atvirkštiniam PVM                                                | Jungtinė Karalystė                  |
