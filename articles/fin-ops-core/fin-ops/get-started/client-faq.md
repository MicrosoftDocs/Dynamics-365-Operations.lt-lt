---
title: Kliento DUK
description: Šiame straipsnyje pateikiami atsakymai į dažnai užduodamus klausimus apie finansų ir operacijų klientą.
author: jasongre
ms.date: 09/11/2019
ms.topic: article
ms.prod: ''
...
Šiame straipsnyje pateikiami atsakymai į dažnai užduodamus klausimus apie finansų ir operacijų klientą.

## <a name="why-arent-symbols-loaded"></a>Kodėl neįkeliami simboliai?
...
- Kitu atveju gali tekti programos svetainę pridėti į patikimų svetainių sąrašą.
...
Jei dešiniuoju pelės mygtuku spustelite redaguotiname lauke (arba jei pažymėtas tekstas), rodomas spartusis naršyklės meniu. Šiame meniu galite pasiekti komandas **Iškirpti**, **Kopijuoti** ir **Įklijuoti**. Šių komandų negalime įdėti į sparčiuosius meniu, nes saugumo sumetimais naršyklės mums neleidžia programiškai pasiekti sistemos mainų srities.

Jei dešiniuoju pelės mygtuku spustelėsite lauko žymę ar tik skaityti galimo valdiklio reikšmę, matysite spartųjį meniu.

Kad jį būtų lengviau pasiekti klaviatūra, ateityje planuojame įdiegti klaviatūros kombinaciją, kuria būtų atidaromas spartusis meniu.

## <a name="where-is-the-view-details-functionality"></a>Kur yra funkcija Peržiūrėti išsamią informaciją?
