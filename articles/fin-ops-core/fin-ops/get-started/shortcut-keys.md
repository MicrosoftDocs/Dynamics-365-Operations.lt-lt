...
| Parinkti šiandienos datą                     | T                                         |
| Išvalyti pasirinktą datą               | M                                         |
...
| Perjungti į antraščių rodinį                               | Ctrl + Shift + H                                 |
...
| Ieškoti puslapio                                                             | Ctrl + / arba Alt + G            |
...
| Perjungti, ar dabartinis valdiklis yra tabuliavimo sekoje (naudojant įrankį Praleisti)                                   | Tarpo klavišas arba „Enter“ klavišas                      |
| Naudoti įrankį Redaguoti (kai įjungtas personalizavimo režimas)                                                                       | E                                   |
| Perjungti, ar dabartinį valdiklį galima redaguoti, ar tik skaityti (naudojant įrankį Redaguoti)                                 | Tarpo klavišas arba „Enter“ klavišas                      |
| Naudoti įrankį Suvestinė (kai įjungtas personalizavimo režimas)                                                                    | V                                   |
| Perjungti, ar dabartinis valdiklis dabartiniame „FastTab“ skirtuke yra suvestinės laukas (naudojant įrankį Suvestinė)            | Tarpo klavišas arba „Enter“ klavišas                      |
| Naudoti įrankį Įtraukti (kai įjungtas personalizavimo režimas)                                                                        | A                                   |
| Pasirinkti valdiklį, kurio konteineris bus naudojamas naujiems laukams įterpti (naudojant įrankį Įtraukti)                     | Tarpo klavišas arba „Enter“ klavišas                      |
| Importuoti personalizavimą (kai įjungtas personalizavimo režimas)                                                                | I                                   |
| Eksportuoti personalizavimą (kai įjungtas personalizavimo režimas)                                                                | X                                   |
| Išvalyti šio puslapio personalizavimus (kai įjungtas personalizavimo režimas)                                                      | „Ctrl“ + C                              |
| Įvesties vietą perkėlinėti tarp personalizavimo įrankių juostos ir puslapio (kai įjungtas personalizavimo režimas)                             | T                                   |
...
- [Ataskaitų dizaino įrankio spartieji klavišai](../../../finance/general-ledger/financial-reporting-keyboard-shortcuts.md)
