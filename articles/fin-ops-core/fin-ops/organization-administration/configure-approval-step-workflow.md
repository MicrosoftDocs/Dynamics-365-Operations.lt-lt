...
description: Šiame straipsnyje paaiškinama, kaip konfigūruoti patvirtinimo veiksmo ypatybes.
author: ChrisGarty
ms.date: 08/23/2017
ms.topic: article
ms.prod: ''
...
Šiame straipsnyje paaiškinama, kaip konfigūruoti patvirtinimo veiksmo ypatybes.
...
2. Skirtuke **Priskyrimo tipas** pasirinkite vieną iš tolesnės lentelės parinkčių ir tada, prieš vykdydami 3 veiksmą, atlikite papildomus tos parinkties veiksmus.
    ...
    <li>Sąrašas <strong>Galimi vartotojai</strong> apima visus sistemos vartotojus. Pasirinkite, kuriems vartotojams norite priskirti veiksmą, o tada tuos vartotojus perkelkite į sąrašą <strong>Pasirinkti vartotojai</strong>.</li>
    </ol>
    </td>
    </tr>
    </tbody>
...
3. Norėdami vartotoją įtraukti į perskyrimo maršrutą, spustelėkite **Įtraukti perskyrimą**. Skirtuke **Priskyrimo tipas** pasirinkite vieną iš tolesnės lentelės parinkčių ir tada, prieš vykdydami 4 veiksmą, atlikite papildomus tos parinkties veiksmus.
    ...
    <ol>
    <li>Pasirinkę <strong>Vartotojas</strong>, spustelėkite skirtuką <strong>Vartotojas</strong>.</li>
    <li>Sąrašas <strong>Galimi vartotojai</strong> apima visus vartotojus. Pasirinkite, kuriems vartotojams norite perskirti dokumentą, o tada tuos vartotojus perkelkite į sąrašą <strong>Pasirinkti vartotojai</strong>.</li>
    </ol>
    </td>
    </tr>
    </tbody>
