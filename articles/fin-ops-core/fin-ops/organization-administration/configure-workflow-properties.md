...
description: Šiame straipsnyje paaiškinama, kaip konfigūruoti įvairias darbo eigos ypatybes.
author: ChrisGarty
ms.date: 07/07/2020
ms.topic: article
ms.prod: ''
...
Šiame straipsnyje paaiškinama, kaip konfigūruoti įvairias darbo eigos ypatybes.
