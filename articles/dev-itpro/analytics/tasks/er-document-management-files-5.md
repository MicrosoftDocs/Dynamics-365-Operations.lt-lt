...
---
# <a name="modify-and-run-format-to-use-document-management-files-in-format-outputs"></a>Dokumentų valdymo failų, naudojamų formato išvestyse, formato modifikavimas ir paleidimas
