...
---
# <a name="create-electronic-reporting-er-formats-to-do-counting-and-summing"></a>Elektroninių ataskaitų (ER) formato, skirto skaičiavimo ir sumavimo veiksmams atlikti, kūrimas
...
## <a name="get-the-intrastat-configurations-provided-by-microsoft"></a>Gaukite „Microsoft“ teikiamas „Intrastat“ konfigūracijas
1. Spustelėkite Atidaryti.
2. Medyje pasirinkite Intrastat model\Intrastat (DE).
3. Spustelėkite Importuoti.
    * Spustelėkite Importuoti 1.1 pasirinktos konfigūracijos versiją.  
4. Spustelėkite Taip.
5. Uždarykite puslapį.
6. Uždarykite puslapį.
7. Spustelėkite Ataskaitų konfigūracijos.
