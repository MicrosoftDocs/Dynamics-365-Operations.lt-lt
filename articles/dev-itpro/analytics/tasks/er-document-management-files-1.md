...
---
# <a name="prepare-data-model-to-use-document-management-files-in-format-outputs"></a>Duomenų modelio, kuris bus naudojamas dokumentų valdymo failuose naudojant formato išvestis, paruošimas
