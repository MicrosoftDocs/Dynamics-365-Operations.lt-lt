...
---
# <a name="prepare-data-models-to-use-document-management-files-in-er-output"></a>Duomenų modelio, skirto dokumentų valdymo failams naudoti ER išvestyje, ruošimas
