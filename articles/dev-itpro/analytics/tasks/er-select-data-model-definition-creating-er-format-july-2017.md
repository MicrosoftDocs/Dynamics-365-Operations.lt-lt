...
---
# <a name="select-data-model-definition-while-creating-format-for-electronic-reporting-er"></a>Modelio susiejimo apibrėžimas ir duomenų šaltinių pasirinkimas elektroninėse ataskaitose (ER)
