...
Kurdami elektroninių ataskaitų (ER) konfigūracijas, kuriomis naudojantis generuojami elektroniniai dokumentai, nurodote būdą, kuriuo naudodamiesi gaunate duomenis iš „Microsoft Dynamics 365 for Finance and Operations“, ir įvedate jį į sugeneruotą išvestį. Naudojantis ER našumo sekimo funkcija gali pastebimai sutrumpėti laikas, per kurį renkama informacija apie ER formato vykdymą, panaudojant ją našumo problemoms spręsti, ir gali būti patiriama mažiau išlaidų. Šioje mokymo programoje pateikiama rekomendacijų apie tai, kaip atsižvelgti į įvykdytų „Finance and Operations“ ER formatų našumo sekimus ir kaip panaudoti šiuos sekimus siekiant pagerinti našumą.
...
- Prieiga prie „Regulatory Configuration Services“ (RCS) egzemplioriaus, kuris sukurtas tam pačiam nuomininkui, kaip „Finance and Operations“, vienam iš toliau nurodytų vaidmenų atlikti.
...
Kiekvienas „Finance and Operations“ sugeneruotas ER našumo sekimas saugomas kaip vykdymo žurnalo įrašo priedas. Šiems priedams tvarkyti naudojama „Finance and Operations“ dokumentų tvarkymo (DM) sistema. Norėdami nurodyti DM dokumento tipą, kuris turėtų būti naudojamas našumo sekimams pridėti, turite iš anksto sukonfigūruoti ER parametrus. „Finance and Operation“ darbo srityje **Elektroninės ataskaitos** pasirinkite **Elektroninių ataskaitų parametrai**. Tada puslapyje **Elektroninių ataskaitų parametrai** esančio skirtuko **Priedai** lauke **Kiti** pasirinkite DM dokumento tipą, kuris bus naudojamas našumo sekimui.
...
Tarkime, kad baigėte kurti pirmąją ER sprendimo versiją. Dabar norite ją patikrinti naudodami savo „Finance and Operations“ egzempliorių ir išanalizuoti vykdymo našumą.
...
1. „Finance and Operations“ eikite į **Organizacijos administravimas \> Elektroninės ataskaitos \> Konfigūracijos**.
...
1. „Finance and Operations“ pasirinkite įmonę **DEMF**.
...
### <a id='export-trace'></a>Sugeneruoto sekimo eksportavimas iš „Finance and Operations“

Našumo sekimai atsiejami nuo šaltinio ER formato ir gali būti išdėstyti eilutėmis išoriniame ZIP faile.

1. „Finance and Operations“ eikite į **Organizacijos administravimas \> Elektroninės ataskaitos \> Konfigūracijos derinimo žurnalai**.
...
6. Paspaudę **Naršyti** pasirinkite anksčiau iš „Finance and Operations“ eksportuotą ZIP failą.
7. Pasirinkite **Gerai**.
...
### <a name="import-the-modified-er-model-mapping-configuration-from-rcs-into-finance-and-operations"></a>Modifikuotos ER modelio susiejimo konfigūracijos importavimas iš RCS į „Finance and Operations“

Pakartokite veiksmus, aprašytus ankstesniame šios temos skyriuje [ER konfigūracijos importavimas iš RCS į „Finance and Operations“](#import-configuration) ir importuokite konfigūracijos **Našumo sekimo susiejimas** versiją 1.2 į „Finance and Operations“.
...
### <a name="export-the-generated-trace-from-finance-and-operations"></a>Sugeneruoto sekimo eksportavimas iš „Finance and Operations“

Pakartoję ankstesniame šios temos skyriuje [Sugeneruoto sekimo eksportavimas iš „Finance and Operations“](#export-trace) nurodytus veiksmus vietiniame tinkle įrašykite naują našumo sekimą.
...
## <a name="review-the-execution-trace-in-finance-and-operations"></a>Vykdymo sekimo peržiūra naudojant „Finance and Operations“

Galimybė naudotis ER sistemos dizaino įrankiu gali būti siūloma ne tik RCS, bet ir kai kuriose „Finance and Operations“ versijose. Šiose „Finance and Operations“ versijose galima įjungti parinktį **Kūrimo režimo įjungimas**. Šią pasirinktį galite rasti puslapio **Elektroninių ataskaitų parametrai**, kurį galite atidaryti darbo srityje **Elektroninės ataskaitos**, skirtuke **Bendra**.
...
Jei naudojatės viena iš šių „Finance and Operations“ versijų, sugeneruotų našumo sekimų informaciją galite analizuoti tiesiogiai naudodamiesi „Finance and Operations“. Nereikia eksportuoti informacijos iš „Finance and Operation“ ir importuoti ją į RCS.
