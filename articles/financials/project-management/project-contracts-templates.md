---
title: "Tiesioginis „Project Service Automation“ projekto sutarčių sinchronizavimas su „Finance and Operations“ projekto sutartimis"
description: "Šioje temoje aprašomas šablonas ir pagrindinės užduotys, naudojamos tiesiogiai sinchronizuojant „Microsoft Dynamics 365 for Project Service Automation“ projekto sutartis ir projektus su „Dynamics 365 for Finance and Operations“."
author: KimANelson
manager: AnnBe
ms.date: 12/13/2017
ms.topic: article
...
# <a name="synchronize-project-contracts-and-projects-from-project-service-automation-directly-to-project-contracts-and-projects-in-finance-and-operations"></a>Tiesioginis „Project Service Automation“ projekto sutarčių ir projektų sinchronizavimas su „Finance and Operations“ projekto sutartimis ir projektais
...
> [!NOTE] 
> Jei naudojate „Microsoft Dynamics 365 for Finance and Operations“, „Enterprise“ leidimą 7.3.0, turite įdiegti KB 4074835.
...
Grafiko ir medžiagos ir fiksuotos kainos projektai tvarkomi naudojantis „Project Service Automation“ ir yra sinchronizuojami su „Finance and Operations“ kaip projektai. Atlikdami šablono integravimą galite nustatyti projekto integavimo į „Finance and Operations“ šaltinį.
...
- Norint sinchronizuoti projekto sutartis ir projektus, būtina sinchronizuoti sąskaitas.
- Savo ryšio rinkinyje įtraukite integravimo rakto lauko **msdyn\_organizationalunits** susiejimą su lauku **msdyn\_name \[Name\]**. Pirmiausia į ryšių rinkinį gali tekti įtraukti projektą. Daugiau informacijos apie integravimo raktus ieškokite „Dynamics 365“ skyriuje Duomenų integravimas.
- Savo ryšio rinkinyje įtraukite integravimo rakto lauko **msdyn\_projects** susiejimą su lauku **msdynce\_projectnumber \[Project Number\]**. Pirmiausia į ryšių rinkinį gali tekti įtraukti projektą. Daugiau informacijos apie integravimo raktus ieškokite „Dynamics 365“ skyriuje Duomenų integravimas.
...
- Projekto sutarčių (iš PSA į „Fin and Ops“) šablonas turi numatytąjį filtrą, kuris apima tik tuos pardavimo užsakymus, kurių tipas **Darbo elementas (msdyn\_ordertype = 192350001)**. Šis filtras užtikrina, kad naudojant „Finance and Operations“ pardavimo užsakymų projekto sutartys nekuriamos. Norint sukurti savo šabloną būtina įtraukti šį filtrą.
