...
---
# <a name="receive-items-on-purchase-order-from-item-requirement"></a>Gauti pirkimo užsakyme pateiktas prekes pagal prekės poreikį

[!include [task guide banner](../../includes/task-guide-banner.md)]

Šioje procedūroje nurodoma, kaip gauti pirkimo užsakyme pateiktas prekes pagal prekės poreikį.
...
Šioje užduotyje naudojamas USSI duomenų rinkinys.

1. Eikite į Projektų valdymas ir apskaita > Projektai > Visi projektai.
2. Sąraše spustelėkite saitą pasirinktoje eilutėje.
3. Veiksmų srityje spustelėkite Planuoti.
4. Spustelėkite Prekių poreikis.
...
10. Veiksmų srityje spustelėkite Valdyti.
11. Spustelėkite Funkcijos.
12. Spustelėkite Kurti pirkimo užsakymą.
13. Pažymėkite žymės langelį Įtraukti.
14. Lauke Tiekėjo sąskaita įveskite arba pasirinkite vertę.
15. Spustelėkite GERAI.
16. Eikite į Mokėtinos sumos > Pirkimo užsakymai > Visi pirkimo užsakymai.
17. Sąraše spustelėkite saitą pasirinktoje eilutėje.
18. Veiksmų srityje spustelėkite Pirkti.
19. Spustelėkite Patvirtinti.
20. Veiksmų srityje spustelėkite Gauti.
21. Spustelėkite Produkto gavimo kvitas.
22. Sąraše pažymėkite pasirinktą eilutę.
23. Lauke Produkto gavimo kvitas surinkite reikšmę.
