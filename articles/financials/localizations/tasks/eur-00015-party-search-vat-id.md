...
---
# <a name="party-search-using-vat-id"></a>Šalies ieška naudojant PVM ID
...
4. Lauke Registracijos tipas įveskite arba pasirinkite reikšmę.
    * Pavyzdžiui, jei norite ieškoti šalių, kurių registracijos ID tipas yra PVM ID, pasirinkite PVM ID.  
5. Lauke Šalis / regionas įveskite arba pasirinkite reikšmę.
    * Pavyzdžiui, įveskite DEU.  
