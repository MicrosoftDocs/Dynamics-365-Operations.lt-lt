...
**Man priskirti darbo elementai** rodomi visi patvirtinimai ir darbo eigos elementai, priskirti darbuotojui. Galite konfigūruoti darbo eigos elementus, kad galėtumėte siųsti el. laiškus vartotojui.

**Man priskirti klausimynai** rodomi visi suplanuoti klausimynai, priskirti tiesiogiai darbuotojui arba grupei.

**Įmonės katalogas** leidžia darbuotojams ieškoti informacijos, susijusios su asmenimis organizacijoje. Vieša kontaktinė informacija yra prieinama visiems darbuotojams. Įmonės katalogas taikomas tik įmonei, prie kurios prisijungęs darbuotojas.

**Komandos kalendorius** rodoma jūsų komandos kalendoriaus informacija. Daugiau informacijos žr. [Komandos ir įmonės kalendorių peržiūra](hr-employee-self-service-calendar.md).
...
Galite peržiūrėti užduoties informaciją dalyje **Organizacija**. Išsamią užduoties informaciją sudaro įgūdžiai, sertifikatai ir jūsų pagrindinių pareigų atsakomybės sritis. Taip pat galite peržiūrėti visą jums užregistruotą paskolintą įrangą. Atsižvelgiant į jūsų organizacijos parametrus, paskolintos įrangos pakeitimai gali vykti per patvirtinimo procesą.
...
Personalo veiksmų rodymas yra pagrįstas parinktimis **„Human Resources“ bendrinami parametrai** ir **„Human Resources“ parametrai**. Kai jie įjungti parinkčiai **Darbuotojai**, personalo veiksmai suaktyvina naujas meniu pasirinktis, įskaitant:

- **Pateikti užklausą dėl naujo darbuotojo**
- **Pateikti užklausą dėl naujo rangovo**
- **Pateikti užklausą dėl darbininko priskyrimo iš naujo**
- **Pateikti užklausą dėl atleidimo**
- **Pateikti užklausą dėl kompensacijos keitimo**

Galite konfigūruoti šias pasirinktis norėdami peržiūrėti pasirinktinę peržiūrą ir patvirtinimo darbo eigą.

Suaktyvinus **Pareigų veiksmai**, suaktyvinamos tolesnės parinktys.

- **Pateikti užklausą dėl naujų pareigų**
- **Pateikti užklausą dėl pareigų informacijos keitimo**

Taip pat galite konfigūruoti šias pasirinktis norėdami peržiūrėti pasirinktinę peržiūrą ir patvirtinimo darbo eigą.
...
- **Mano komandos sertifikatai, kurių galiojimas baigiasi**
- **Baigia galioti mano komandos identifikavimo numeris**
- **Mano komandos bandomieji terminai, kurių galiojimas baigiasi**
- **Mano komandos patikrinimai, kurių galiojimas baigiasi**
- **Mano komandos testai, kurių galiojimas baigiasi**
- **Atidaryti pareigas tiesioginėms ir (arba) išplėstinėms ataskaitoms**
- **Laukiami mano komandos atostogų prašymai**
- **Komandos įgūdžių įvertinimas**
- **Įgūdžių trūkumo analizė**
- **Komandos našumo žurnalai**
- **Komandos našumo tikslai**
- **Komandos efektyvumo peržiūros**
- **Išeinantys darbininkai**

Galite konfigūruoti tolesnes vadovams skirtas parinktis, kad atliktumėte pakeitimų arba įtrauktumėte atostogų prašymus į jų tiesiogines ataskaitas.

- Sertifikatai
- Kursai
- Panaudos objektai
- Įgūdžiai
- Prašymai dėl atostogų ir leidimo neatvykti
...
Skirtuke **Suvestinė** pateikiama greita tiesioginių ataskaitų peržiūra. Jeigu tiesioginėje ataskaitoje taip pat gali pranešti darbuotojai, kortelėje rodomas tiesioginių ataskaitų skaičius viršutinėje dalyje kartu su mygtuku **Peržiūrėti komandą**. Pasirinktys, virš kiekvienos kortelės, taikomos pasirinktam darbuotojui. Pavyzdžiui, jei norite įvesti atostogų prašymą darbuotojo vardu, pasirinkite darbuotoją, tada virš kortelių pasirinkite **Prašyti atostogų**. 

Jei, pasirinkę darbuotoją, paspausite mygtuką **Išsami informacija**, bus rodomos tolesnės parinktys.
...
- **Panaudos prekės**
- **Efektyvumo tikslai**
- **Užregistruoti kursai**
- **Įgūdžiai**
- **Siųsti atsiliepimą**

Atsižvelgdami į jūsų organizacijos parametrus, galite atlikti keitimus arba tik peržiūrėti.
...
Skirtuke **Atlyginimas** rodomas darbuotojo metinis atlyginimas. Įmonės identifikatorius rodomas po atlyginimo suma. Jei darbuotojas dirba daugiau nei vienoje vietoje ir jam atlyginimą moka keli juridiniai subjektai, darbuotojas turės kelias atlyginimo korteles. Paskutinė didinimo suma ir procentai rodomi pagal įdarbinusią įmonę.

Norėdami peržiūrėti atlyginimo istoriją, pasirinkite atlyginimo sumą ir atidarykite formą**Išsami informacija**. Formoje **Atlyginimas** rodomi tik dabartiniai ir istoriniai pastoviosios ir kintamosios atlyginimo dalies įrašai. Jei darbuotojas dirba daugiau nei vienoje vietoje, galite perjungti įmones, kad peržiūrėtumėte atlyginimo istoriją kiekvienoje įmonėje.
...
Skirtuke **Našumo tikslai** apibendrinami našumo tikslai pagal būseną. Pasirinkti būsenos numerį arba pasirinkti našumo tikslus skirtuke **Išsami informacija**, kad peržiūrėtumėte visus darbuotojo tikslus. Vadovai ir darbuotojai gali naujinti tikslus, jei reikia, visą tikslo įgyvendinimo periodą.

Vadovai gali matyti visus savo komandos tikslus **Mano komanda** skyriaus **Suvestinė** plytelėje **Komandos našumo tikslai**.

#### <a name="reviews-tab"></a>Peržiūrų skirtukas
