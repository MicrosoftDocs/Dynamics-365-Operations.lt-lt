...
Platformos pakeitimai yra įtraukti į šios savaitės leidimą. Daugiau informacijos rasite finansų ir [operacijų programėlių 10.0.10 versijos platformos atnaujinimų (2020 m. gegužės mėnesį)](../fin-ops-core/dev-itpro/get-started/whats-new-platform-update-34.md). Šiame leidime yra įrašytų rodinių klaidų pataisymų ir pakeitimų.
