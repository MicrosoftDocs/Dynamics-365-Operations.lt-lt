...
description: Šiame straipsnyje aprašoma, kaip pareigos yra svarbus organizacijos hierarchijos žemesnio lygio elementas.
author: twheeloc
ms.date: 10/28/2021
...
5. Pasirinkite **Kurti pareigas**.
6. **Įveskite arba pasirinkite** vertę Padalinio lauke.
7. **Lauke Pareigų tipas** įveskite arba pasirinkite vertę.
8. Lauke Kompensacijos **sritis** įveskite arba pasirinkite vertę.
...
9. Lauke Galima **priskirti įveskite** datą ir laiką.
10. Išplėskite pareigų **trukmės** skyrių.

    Pareigų trukmė įvedama pagal numatytuosius nustatymus, atsižvelgiant į anksčiau įvestas aktyvinimo ir pabaigos datas.

11. Išplėskite **skyrių Ataskaitos pagal** pareigas.
...
12. Išplečiamajame **dialogo** lange atidaryti pasirinkite Naujas.
13. **Lauke Ataskaitos iki** įveskite arba pasirinkite vertę.
14. Pasirinkite **Kurti**.
15. Išplėskite skyrių **Darbuotojo priskyrimas**.
16. Išplėskite **skyrių** Ryšiai.
...
17. Pasirinkite **Įtraukti**.
18. Sąraše pažymėkite pasirinktą eilutę.
19. Lauke Hierarchijos **pavadinimas** įveskite arba pasirinkite vertę.
20. Į pareigų **ataskaitų lauką** įveskite arba pasirinkite vertę.
21. Išplėskite skyrių **Algalapis**.
22. Lauke Mokėjimo **ciklas** įveskite arba pasirinkite vertę.
23. **Lauke Apmokėta įveskite** arba pasirinkite vertę.
24. Lauke Metinės **įprastos** valandos įveskite skaičių.

    Jūsų įvedama vertė yra reguliariai mokamų valandų, kurias darbuotojas eka šias pareigas, skaičius kiekvienais metais.

25. Išplėskite skyrių **Darbo** sąjunga.
26. Sutraukti profesinės **sąjungos** skyrių.
27. Išplėskite finansinių **dimensijų** skyrių.
28. **Lauke Paskirstymo šablonas** įveskite arba pasirinkite vertę.
29. **Įveskite arba pasirinkite** vertę Padalinio lauke.
30. Pasirinkite **Įrašyti**.
