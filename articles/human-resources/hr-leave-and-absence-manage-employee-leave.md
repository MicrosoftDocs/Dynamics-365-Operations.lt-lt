...
## <a name="adjust-leave-balances"></a>Atostogų balansų koregavimas

1. Darbuotojo įraše pasirinkite **Atostogos**.

2. Pasirinkite **Atostogų ir neatvykimų nustatymas**.

3. Pasirinkite **Koreguoti balansą**.

4. Pasirinkite **atostogų tipą**.

5. Įveskite **koregavimo sumą**. 
