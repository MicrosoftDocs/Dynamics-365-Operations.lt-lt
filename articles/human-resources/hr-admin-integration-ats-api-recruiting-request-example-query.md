...
description: Šiame straipsnyje pateikiama įdarbinimo užklausos objekto, kuris yra įdarbinimo užklausos objektas, pavyzdys Dynamics 365 Human Resources.
author: jaredha
ms.date: 02/05/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8858220"
---
# <a name="example-query-for-recruiting-request"></a>Pavyzdinė užklausa Samdymo prašymui
...
Šiame straipsnyje pateikiama įdarbinimo užklausos objekto, kuris yra įdarbinimo užklausos objektas, pavyzdys Dynamics 365 Human Resources.

Tolesnė užklausa rodo, kaip galite naudoti $išplėtimo užklausos parinktį GET operacijoje tam, kad gautumėte konkretų samdymo užklausos įrašą ir vsas susietas pareigas, būtinus įgūdžius ir išsilavinimo reikalavimus konkrečiai užklausai. Pavyzdžio atsakymas rodo samdymo užklausą dviems pareigoms ir būtinus įgūdžius bei išsilavinimą prašymo pareigoms.
