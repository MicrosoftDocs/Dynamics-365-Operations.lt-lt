...
description: Šiame straipsnyje paaiškinama, kaip optimizuoti našumą, kai naudojate "Microsoft" savo duomenų bazės (BYOD) funkciją Dynamics 365 Human Resources.
author: twheeloc
ms.date: 08/17/2020
ms.topic: article
ms.prod: ''
...
Šiame straipsnyje paaiškinama, kaip optimizuoti našumą, kai naudojate funkciją Atvesti savo duomenų bazės (BYOD). Norėdami gauti daugiau informacijos apie BYOD, žr. [Savo duomenų bazės naudojimas (BYOD)](../fin-ops-core/dev-itpro/analytics/export-entities-to-your-own-database.md?toc=%2fdynamics365%2fhuman-resources%2ftoc.json).
