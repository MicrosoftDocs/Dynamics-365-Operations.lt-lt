...
[Nustatyti mobiliojo įrenginio meniu elementą pirkimo užsakymo tipo darbui atlikti (užduočių vedlys)](/dynamics365/unified-operations/supply-chain/warehousing/tasks/set-up-mobile-device-menu)

[Mobiliojo įrenginio meniu elemento nustatymas registruoti gautas prekes (užduočių vedlys)](/dynamics365/unified-operations/supply-chain/warehousing/tasks/set-up-mobile-device-menu-item-register-received-items)
