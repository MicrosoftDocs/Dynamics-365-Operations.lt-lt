---
title: "Nustatyti produktų, kurie gali būti pagamintas ar įsigytas"
description: "Produktai gali būti gaunami įvairiais būdais - galima pagaminti (pagamintos) ar perkamas (įsigytas). Šiame straipsnyje aprašomi keli dažni punktai, kuriuos reikėtų apsvarstyti konfigūruojant kelių produktų šaltinių naudojimą."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="set-up-products-that-can-be-produced-or-procured"></a>Nustatyti produktų, kurie gali būti pagamintas ar įsigytas

Produktai gali būti gaunami įvairiais būdais - galima pagaminti (pagamintos) ar perkamas (įsigytas). Šiame straipsnyje aprašomi keli dažni punktai, kuriuos reikėtų apsvarstyti konfigūruojant kelių produktų šaltinių naudojimą. 
