...
## <a name="2-review-and-change-the-new-costing-version-for-the-conversion-record"></a>2. peržiūrėti ir pakeisti nauja įkainojimo versijos keitimo įrašo
...
## <a name="3-identify-the-items-to-convert-to-standard-cost"></a>3. Nurodykite konvertuoti į standartines išlaidas
...
## <a name="4-enter-or-calculate-the-pending-standard-cost-for-each-item-that-is-being-converted"></a>4. įveskite arba apskaičiuoti laukiama standartinių išlaidų kiekvienai prekei, kuri yra konvertuojamos
...
## <a name="5-check-and-resolve-any-issues-for-the-items-that-are-being-converted"></a>5. patikrinti ir išspręsti visus klausimus, prekių, kurios paverčiamos
...
## <a name="6-change-the-status-of-the-conversion-record-to-ready"></a>6. perskaičiavimo įrašų būseną pakeisti į paruoštas
...
## <a name="7-back-up-the-database-before-conversion"></a>7. atsarginę duomenų bazės iki pertvarkymo
Atsarginė kopija leidžia atkurti duomenų bazę, jei konvertavimo metu įvyktų klaidų.

## <a name="8-perform-the-conversion-when-the-conversion-record-has-a-ready-status"></a>8. atlikti konversiją, kai konvertavimo įrašas turi pasiruošę būsena
...
## <a name="9-validate-and-reconcile-the-inventory-values-for-the-converted-items"></a>9. Patikrinkite ir nurodytas atsargų vertes konvertuotiems elementams
