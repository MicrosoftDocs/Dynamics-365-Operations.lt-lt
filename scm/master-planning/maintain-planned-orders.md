...
-   Jei norite patvirtinti suplanuotą užsakymą, galite jam nustatyti būseną **Patvirtinta**. Būsena nurodo, kad pritariate suplanuoto užsakymo patvirtinimui, bet jis dar nėra patvirtintas.

**Pastaba:** esamos būsenos patvirtintas suplanuotas užsakymas perkeliamas į kitą pagrindinio planavimo skaičiavimą. Galite tvirtinti suplanuotus užsakymus spustelėdami **Patvirtinti**. Galite tvirtinti šiuos suplanuotus užsakymus:

-   Pasirinktas suplanuotas užsakymas.
