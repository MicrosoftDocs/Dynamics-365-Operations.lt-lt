...
description: "Šioje temoje aprašomas pagrindinių sąvokų ir terminų, kad jums reikia suprasti, konfigūruoti ir naudoti gamybos vykdymo."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
Šioje temoje aprašomas pagrindinių sąvokų ir terminų, kad jums reikia suprasti, konfigūruoti ir naudoti gamybos vykdymo. 

Gamybos vykdymas visų pirma yra skirtas naudoti gamyboms įmonėse. Darbuotojai gali registruoti gamybos užduotims atlikti sugaištamą laiką ir prekių suvartojimą naudodami puslapį **Užduoties registravimas**. Visos registracijos yra patvirtintos ir vėliau perkeliami į atitinkamų modulių. Nuolatinis registracijų patvirtinimas ir perkėlimas vadovams leidžia lengvai sekti faktines gamybos užsakymų išlaidas.
...
| Semestras                          | aprašymas                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|-------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Gamybos vykdymas       | Funkcija, naudojama užsiregistruoti laiko, medžiagų sunaudojimas, išlaidos gamybos užduotis, projektus ir netiesiogines veiklas. Registravimas atliekamas gamybos vykdymo registracijos kliente.                                                                                                                                                                                                                                                                                                                                                                                                   |
...
-   **Užregistruoti projektą mokesčių ir projekto elementai** (galima su laiką ir lankomumą) – darbuotojai gali registruotis mokesčiai (išlaidas), susijusias su projekto projekto mokestis žurnale, pvz., rida ir tilto rinkliavos. Darbuotojai taip pat galite užregistruoti prekės suvartojimo projektus. Tai atliekama projekto prekių žurnale.
