...
<li>Kada principas yra lygi <strong>pasirinktos/aktyvios arba pasirinkta</strong>, galite pasirinkti KS versiją arba maršruto versiją spustelėdami <strong>KS</strong>&gt;<strong>KS versijos</strong> ar <strong>maršruto</strong>&gt;<strong>maršruto versijas</strong>.</li>
</ul></td>
</tr>
<tr class="even">
<td>Versijos data</td>
...
Naudojant KS konstruktorių KS, kurias sudaro vieno ar kelių lygių fiktyvios eilutės, peržiūrėti arba redaguoti, maršrutas, susietas su aukšto lygio preke, paprastai apima visą KS hierarchiją. Supaprastinti apžvalga, galite užrakinti aukščiausio lygio maršruto ekrane paspaudę **Peržiūrėti**&gt;**užrakto maršrutą**. Norėdami atrakinti maršrutą, spustelėkite **Peržiūrėti**&gt;**atrakinti maršrutą**.

## <a name="adding-and-editing-boms-and-bom-lines"></a>KS ir KS eilučių pridėjimas ir redagavimas
Naudoti su ** KS eilučių ** ar **KS** funkcijas keisti KS eilutes arba KS. Pasirinkus medžio mazgą, mazgo tipas nustato galimas funkcijas.
...
| KS eilutės &gt;naikinimas               | Panaikinkite pasirinktos KS eilutę.                                                                  | Šią funkciją galima naudoti, kai KS eilutės mazgas pažymėtas ir KS nėra užblokuota redaguoti.                                                                                                                                                                                             |
| KS eilutės &gt;pridėti prieš eilutę      | Atidarykite dialogo langą, kuriame galite pasirinkti produkto variantą įtraukti prieš pasirinktą KS eilutę.         | Šią funkciją galima naudoti, kai KS eilutės mazgas pažymėtas.                                                                                                                                                                                                                                   |
| KS eilutės &gt;įtraukti į KS komponentas | Atidarykite dialogo langą, kuriame galite pasirinkti produkto variantą įtraukti pasirinktos KS pabaigoje.       | Šią funkciją galima naudoti, kai pažymėtame mazge yra pasirinkta KS eilutė. Jei šios funkcijos nėra, galbūt nėra pasirinkto prekės varianto KS versijos. Šiuo atveju, jūs galite spustelėti **BOM**&gt;**sukurti versija** sukurti trūkstamus versiją, pažymėtą mazgą. |
| KS eilutės &gt;pridėti po eilutės       | Atidarykite dialogo langą, kuriame galite pasirinkti produkto variantą įtraukti po pasirinkta KS eilute.          | Šią funkciją galima naudoti, kai KS eilutės mazgas pažymėtas.                                                                                                                                                                                                                                   |
| KS &gt;sukurti versija             | Sukurkite naują pažymėto mazgo produkto varianto KS versiją arba KS.                             | Šią funkciją galima naudoti, jei KS eilutės mazgas, kuris yra pažymėtas, yra susietas su preke, kurios gamybos tipas yra **KS** arba **Formulė**.                                                                                                                                                  |
| KS &gt;skaičiavimo                | Atidarykite dialogo langą, kuriame galėsite vykdyti pasirinkto produkto varianto savikainos arba pardavimo kainos skaičiavimą. | Šią funkciją galima naudoti, kai pažymėtas mazgas yra susijęs su KS versija.                                                                                                                                                                                                         |
| KS &gt;patikrinkite                      | Patvirtinkite ir patikrinkite pasirinktą KS.                                                                      | Šią funkciją galima naudoti, kai pažymėtas mazgas yra susijęs su KS versija.                                                                                                                                                                                                         |
